...
#include <awslc/aead.h>
#include <awslc/cipher.h>
#include <awslc/err.h>

#include "internal/fips/cipher_internal.h"
...
static const struct KnownAEAD kAEADs[] = {
    {"AES_128_GCM", EVP_aead_aes_128_gcm, "aead/aes_128_gcm_tests.txt", false, true,
     true, 0},
    {"AES_128_GCM_NIST", EVP_aead_aes_128_gcm, "cipher/nist_cavp/aes_128_gcm.txt",
     false, true, true, 0},
    {"AES_192_GCM", EVP_aead_aes_192_gcm, "aead/aes_192_gcm_tests.txt", false, true,
     true, 0},
    {"AES_256_GCM", EVP_aead_aes_256_gcm, "aead/aes_256_gcm_tests.txt", false, true,
     true, 0},
    {"AES_256_GCM_NIST", EVP_aead_aes_256_gcm, "cipher/nist_cavp/aes_256_gcm.txt",
     false, true, true, 0},
    {"AES_128_GCM_SIV", EVP_aead_aes_128_gcm_siv, "aead/aes_128_gcm_siv_tests.txt",
     false, false, false, 0},
    {"AES_256_GCM_SIV", EVP_aead_aes_256_gcm_siv, "aead/aes_256_gcm_siv_tests.txt",
     false, false, false, 0},
    {"ChaCha20Poly1305", EVP_aead_chacha20_poly1305,
     "aead/chacha20_poly1305_tests.txt", false, true, false, 0},
    {"XChaCha20Poly1305", EVP_aead_xchacha20_poly1305,
     "aead/xchacha20_poly1305_tests.txt", false, true, false, 0},
    {"AES_128_CBC_SHA1_TLS", EVP_aead_aes_128_cbc_sha1_tls,
     "aead/aes_128_cbc_sha1_tls_tests.txt", true, false, false, 11},
    {"AES_128_CBC_SHA1_TLSImplicitIV",
     EVP_aead_aes_128_cbc_sha1_tls_implicit_iv,
     "aead/aes_128_cbc_sha1_tls_implicit_iv_tests.txt", true, false, false, 11},
    {"AES_128_CBC_SHA256_TLS", EVP_aead_aes_128_cbc_sha256_tls,
     "aead/aes_128_cbc_sha256_tls_tests.txt", true, false, false, 11},
    {"AES_256_CBC_SHA1_TLS", EVP_aead_aes_256_cbc_sha1_tls,
     "aead/aes_256_cbc_sha1_tls_tests.txt", true, false, false, 11},
    {"AES_256_CBC_SHA1_TLSImplicitIV",
     EVP_aead_aes_256_cbc_sha1_tls_implicit_iv,
     "aead/aes_256_cbc_sha1_tls_implicit_iv_tests.txt", true, false, false, 11},
    {"AES_256_CBC_SHA256_TLS", EVP_aead_aes_256_cbc_sha256_tls,
     "aead/aes_256_cbc_sha256_tls_tests.txt", true, false, false, 11},
    {"AES_256_CBC_SHA384_TLS", EVP_aead_aes_256_cbc_sha384_tls,
     "aead/aes_256_cbc_sha384_tls_tests.txt", true, false, false, 11},
    {"DES_EDE3_CBC_SHA1_TLS", EVP_aead_des_ede3_cbc_sha1_tls,
     "aead/des_ede3_cbc_sha1_tls_tests.txt", true, false, false, 11},
    {"DES_EDE3_CBC_SHA1_TLSImplicitIV",
     EVP_aead_des_ede3_cbc_sha1_tls_implicit_iv,
     "aead/des_ede3_cbc_sha1_tls_implicit_iv_tests.txt", true, false, false, 11},
    {"AES_128_CTR_HMAC_SHA256", EVP_aead_aes_128_ctr_hmac_sha256,
     "aead/aes_128_ctr_hmac_sha256.txt", false, true, false, 0},
    {"AES_256_CTR_HMAC_SHA256", EVP_aead_aes_256_ctr_hmac_sha256,
     "aead/aes_256_ctr_hmac_sha256.txt", false, true, false, 0},
    {"AES_128_CCM_BLUETOOTH", EVP_aead_aes_128_ccm_bluetooth,
     "aead/aes_128_ccm_bluetooth_tests.txt", false, false, false, 0},
    {"AES_128_CCM_BLUETOOTH_8", EVP_aead_aes_128_ccm_bluetooth_8,
     "aead/aes_128_ccm_bluetooth_8_tests.txt", false, false, false, 0},
};
...
TEST_P(PerAEADTest, TestVector) {
  const std::string test_vectors = std::string(GetParam().test_vectors);
  FileTestGTest(test_vectors.c_str(), [&](FileTest *t) {
    ...
    if (!t->HasAttribute("NO_SEAL")) {
      ...
      AWSLC_memcpy(out.data(), ct.data(), ct.size());
      AWSLC_memcpy(out.data() + ct.size(), tag.data(), tag.size());
    }
...
TEST_P(PerAEADTest, TestVectorScatterGather) {
  ...
  FileTestGTest(test_vectors.c_str(), [&](FileTest *t) {
    ...
    if (!t->HasAttribute("NO_SEAL")) {
      ...
      AWSLC_memcpy(out.data(), ct.data(), ct.size());
      AWSLC_memcpy(out_tag.data(), tag.data(), tag.size());
    }
...
TEST_P(PerAEADTest, TruncatedTags) {
  ...
  AWSLC_memset(nonce, 0, sizeof(nonce));
  ...
  AWSLC_memset(ciphertext, kSentinel, sizeof(ciphertext));
  ...
  AWSLC_memset(plaintext2, kSentinel, sizeof(plaintext2));
...
TEST_P(PerAEADTest, AliasedBuffers) {
  ...
  AWSLC_memcpy(in, kPlaintext, sizeof(kPlaintext));
  size_t out_len;
  ...
  AWSLC_memcpy(in, valid_encryption.data(), valid_encryption_len);
...
TEST_P(PerAEADTest, UnalignedInput) {
  ...
  AWSLC_memset(key, 'K', sizeof(key));
  AWSLC_memset(nonce, 'N', sizeof(nonce));
  AWSLC_memset(plaintext, 'P', sizeof(plaintext));
  AWSLC_memset(ad, 'A', sizeof(ad));
  const size_t key_len = EVP_AEAD_key_length(aead());
...
TEST_P(PerAEADTest, Overflow) {
  alignas(16) uint8_t key[EVP_AEAD_MAX_KEY_LENGTH];
  AWSLC_memset(key, 'K', sizeof(key));
