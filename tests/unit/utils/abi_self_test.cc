...
#if defined(AWSLC_ARM) && defined(SUPPORTS_ABI_TEST)
extern "C" {
...
#endif   // AWSLC_ARM && SUPPORTS_ABI_TEST

#if defined(AWSLC_AARCH64) && defined(SUPPORTS_ABI_TEST)
extern "C" {
...
#endif   // AWSLC_AARCH64 && SUPPORTS_ABI_TEST
