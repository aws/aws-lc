...
static void TestDecrypt(const uint8_t *der, size_t der_len,
  ...
  awslc::UniquePtr<X509_SIG> sig(d2i_X509_SIG(NULL, &data, der_len));
  ASSERT_TRUE(sig.get());
  ASSERT_EQ(der + der_len, data);

  awslc::UniquePtr<PKCS8_PRIV_KEY_INFO> keypair(
