...
// that of OpenSSL upstream's evp_test, BoringSSL's aead_test and AWS-LC aead_test. 
// NIST CAVP test vector files are also supported. Each input file is a sequence 
// of attributes, instructions and blank lines.
//
...
class FileTest {
 public:
  ...
  // a trailing newline.
  void PrintLine(const char *format, ...) AWSLC_PRINTF_FORMAT_FUNC(2, 3);
