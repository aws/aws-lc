...
class AwsLcGitHubOidcStack(Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # the same way autofix's is above. The Bedrock role below is the shared one and
        # this is what chains into it. Keeping the entry role per-workflow is what stops
        # sharing Bedrock from also sharing everything else an entry role can reach
