...
from util.metadata import WINDOWS_X86_ECR_REPO, AWS_ACCOUNT, AWS_REGION, WIN_EC2_TAG_KEY, WIN_EC2_TAG_VALUE, \
    SSM_DOCUMENT_NAME
    ...
    def add_stage_to_wave(
        ...
        docker_build_step = CodeBuildStep(
            ...
            commands=[
                ...
                "trigger_conditions=$(./trigger_condition_check.sh --build-type docker --platform windows --stacks \"${STACKS}\")",
            ...
            env={
                **env,
                ...
                # "WIN_DOCKER_BUILD_SSM_DOCUMENT": self.windows_docker_build_stack.s3_bucket_name.value,
                # "S3_FOR_WIN_DOCKER_IMG_BUILD": self.windows_docker_build_stack.ssm_document_name.value
                # "WIN_DOCKER_BUILD_SSM_DOCUMENT": Fn.import_value("SsmDocumentName"),
                # "S3_FOR_WIN_DOCKER_IMG_BUILD": Fn.import_value("S3BucketName"),
