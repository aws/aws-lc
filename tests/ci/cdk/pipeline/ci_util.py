...
from cdk.aws_lc_ai_pr_review_stack import AwsLcAiPrReviewStack
...
def add_ci_stacks(
    ...
    ai_pr_review_spec_file = "cdk/codebuild/ai_pr_review_omnibus.yaml"
    AwsLcAiPrReviewStack(
        scope,
        "aws-lc-ai-pr-review",
        ai_pr_review_spec_file,
        env=env,
        ignore_failure=False,
        stack_name="aws-lc-ai-pr-review"
    )
