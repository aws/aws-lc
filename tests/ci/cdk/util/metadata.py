...
AWS_ACCOUNT = EnvUtil.get("CDK_DEPLOY_ACCOUNT", PROD_ACCOUNT)
...
CAN_AUTOLOAD = (AWS_ACCOUNT == PROD_ACCOUNT) and (AWS_REGION == DEFAULT_REGION)
...
SSM_DOCUMENT_NAME = EnvUtil.get("WIN_DOCKER_BUILD_SSM_DOCUMENT", f"AWSLC-BuildWindowsDockerImages-{timestamp}")
