...
2. Read the pre-fetched logs in LOGS_DIR_PLACEHOLDER to see the exact failure (rejected hunks, build errors, etc.). Then search the downstream repo's recent commits and issues on GitHub for context on what changed.
