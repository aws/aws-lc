...
docker build -t amazonlinux-2:clang-7x_sanitizer amazonlinux-2_clang-7x_sanitizer
...
docker build -t ubuntu-20.04:clang-7x_sanitizer ubuntu-20.04_clang-7x_sanitizer
docker build -t ubuntu-20.04:clang-8x ubuntu-20.04_clang-8x
docker build -t ubuntu-20.04:clang-9x ubuntu-20.04_clang-9x
docker build -t ubuntu-20.04:clang-9x_sanitizer ubuntu-20.04_clang-9x_sanitizer
