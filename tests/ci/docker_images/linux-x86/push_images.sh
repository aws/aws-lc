...
#  ECS_REPO="620771051181.dkr.ecr.us-west-2.amazonaws.com/aws-lc-docker-images-linux-x86"
  ECS_REPO="091083236541.dkr.ecr.us-west-2.amazonaws.com/aws-lc-docker-images-linux-x86"
else
  ECS_REPO=$1
fi
...
tag_and_push_img 'ubuntu-20.04:bm-framework' "${ECS_REPO}:ubuntu-20.04_bm-framework"
