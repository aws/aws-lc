...
# if [ -z ${1+x} ]; then
#   ECS_REPO="620771051181.dkr.ecr.us-west-2.amazonaws.com/linux-docker-images"
# else
#   ECS_REPO=$1
# fi

ECS_REPO="654358955777.dkr.ecr.us-west-2.amazonaws.com/aws-lc-test-docker-images-linux-x86"
