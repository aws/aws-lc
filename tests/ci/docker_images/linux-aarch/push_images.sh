...
tag_and_push_img 'amazonlinux-2-aarch:clang-7x_sanitizer' "${ECS_REPO}:amazonlinux-2_clang-7x_sanitizer"
...
tag_and_push_img 'ubuntu-20.04-aarch:clang-7x_sanitizer' "${ECS_REPO}:ubuntu-20.04_clang-7x_sanitizer"
...
tag_and_push_img 'ubuntu-20.04-aarch:clang-9x_sanitizer' "${ECS_REPO}:ubuntu-20.04_clang-9x_sanitizer"
