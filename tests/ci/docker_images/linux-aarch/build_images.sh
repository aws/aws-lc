...
docker build -t amazonlinux-2-aarch:clang-7x_sanitizer amazonlinux-2_clang-7x_sanitizer
...
docker build -t ubuntu-20.04-aarch:clang-7x_sanitizer ubuntu-20.04_clang-7x_sanitizer
...
docker build -t ubuntu-20.04-aarch:clang-9x_sanitizer ubuntu-20.04_clang-9x_sanitizer
