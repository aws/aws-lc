...
(**** print_literal_from_elf "X86/bignum_ge.o";;
 ****)

let bignum_ge_mc =
  define_assert_from_elf "bignum_ge_mc" "X86/bignum_ge.o"
[
...
let BIGNUM_GE_EXEC = X86_MK_EXEC_RULE bignum_ge_mc;;
    ...
    CONJ_TAC THENL
     [ASM_CASES_TAC `n = 0` THENL
       [UNDISCH_THEN `n = 0` SUBST_ALL_TAC THEN
        ...
        ENSURES_INIT_TAC "s0" THEN X86_STEPS_TAC BIGNUM_GE_EXEC (1--6) THEN
      ...
      ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
       [REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES; SUB_0] THEN
        ...
        ENSURES_INIT_TAC "s0" THEN X86_STEPS_TAC BIGNUM_GE_EXEC [1] THEN
        ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[];
        REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
        X86_STEPS_TAC BIGNUM_GE_EXEC (1--2) THEN
      ...
      ASSUME_TAC THENL
       [MAP_EVERY EXPAND_TAC ["x"; "y"] THEN
        ...
        ALL_TAC] THEN
      X86_STEPS_TAC BIGNUM_GE_EXEC (1--4) THEN
      ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
      ...
      ASM_CASES_TAC `m:num = n` THENL
       [UNDISCH_THEN `m:num = n` SUBST_ALL_TAC THEN
        ...
        ENSURES_INIT_TAC "s0" THEN X86_STEPS_TAC BIGNUM_GE_EXEC (1--4) THEN
      ...
      ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
       [SIMPLE_ARITH_TAC;
        ASM_REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN
        ENSURES_INIT_TAC "s0" THEN X86_STEPS_TAC BIGNUM_GE_EXEC (1--2) THEN
        ...
        ENSURES_INIT_TAC "s0" THEN X86_STEPS_TAC BIGNUM_GE_EXEC [1] THEN
        ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[];
        X86_SIM_TAC BIGNUM_GE_EXEC (1--3) THEN
    ...
    CONJ_TAC THENL
     [ASM_CASES_TAC `m = 0` THENL
       [UNDISCH_THEN `m = 0` SUBST_ALL_TAC THEN
        ASM_REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES; SUB_0] THEN
        ENSURES_INIT_TAC "s0" THEN X86_STEPS_TAC BIGNUM_GE_EXEC (1--7) THEN
        ENSURES_FINAL_STATE_TAC THEN
      ...
      ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
       [REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES; SUB_0] THEN
        ...
        ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[];
        REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
        X86_STEPS_TAC BIGNUM_GE_EXEC [1] THEN
        ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[]] THEN
      X_GEN_TAC `i:num` THEN STRIP_TAC THEN
