...
(**** print_literal_from_elf "X86/bignum_mod_p384_6.o";;
 ****)

let bignum_mod_p384_6_mc =
  define_assert_from_elf "bignum_mod_p384_6_mc" "X86/bignum_mod_p384_6.o"
[
...
let BIGNUM_MOD_P384_6_EXEC = X86_MK_EXEC_RULE bignum_mod_p384_6_mc;;
 ...
 (`!z x n pc stackpointer returnaddress.
      ...
      ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RSI; RAX; RDX; RCX; R8; R9; R10; R11] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,6)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_MOD_P384_6_EXEC BIGNUM_MOD_P384_6_CORRECT);;
