...
(**** print_literal_from_elf "X86/bignum_madd.o";;
 ****)

let bignum_madd_mc =
  define_assert_from_elf "bignum_madd_mc" "X86/bignum_madd.o"
[
  0x53;                    (* PUSH (% rbx) *)
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_MADD_EXEC = X86_MK_EXEC_RULE bignum_madd_mc;;
...
let BIGNUM_MADD_SUBROUTINE_CORRECT = prove
 (`!p m n z x y a b c pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC BIGNUM_MADD_EXEC BIGNUM_MADD_CORRECT
