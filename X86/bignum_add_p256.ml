...
(**** print_literal_from_elf "X86/bignum_add_p256.o";;
 ****)

let bignum_add_p256_mc = define_assert_from_elf "bignum_add_p256_mc" "X86/bignum_add_p256.o"
[
...
let BIGNUM_ADD_P256_EXEC = X86_MK_EXEC_RULE bignum_add_p256_mc;;
 ...
 (`!z x y m n pc stackpointer returnaddress.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RDX; RCX; R8; R9; R10; R11] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,4)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_ADD_P256_EXEC BIGNUM_ADD_P256_CORRECT);;
