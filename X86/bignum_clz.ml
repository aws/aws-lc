...
(**** print_literal_from_elf "X86/bignum_clz.o";;
 ****)

let bignum_clz_mc = define_assert_from_elf "bignum_clz_mc" "X86/bignum_clz.o"
[
...
let BIGNUM_CLZ_EXEC = X86_MK_EXEC_RULE bignum_clz_mc;;
  ...
  ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
   [REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN
    ...
    SIMP_TAC[WORD_XOR_MASK_WORD; VAL_WORD_LT;
             ARITH_RULE `64 - 1 - n < 2 EXP 6`] THEN
 ...
 (`!k a x pc stackpointer returnaddress.
        ensures x86
         ...
         (MAYCHANGE [RIP; RSP; RDI; RDX; RCX; RAX; R8] ,,
          MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_CLZ_EXEC BIGNUM_CLZ_CORRECT);;
