...
(**** print_literal_from_elf "X86/bignum_sqr_8_16.o";;
 ****)

let bignum_sqr_8_16_mc =
  define_assert_from_elf "bignum_sqr_8_16_mc" "X86/bignum_sqr_8_16.o"
[
  0x55;                    (* PUSH (% rbp) *)
  0x53;                    (* PUSH (% rbx) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_SQR_8_16_EXEC = X86_MK_EXEC_RULE bignum_sqr_8_16_mc;;
...
let BIGNUM_SQR_8_16_CORRECT = time prove
 (`!z x a pc.
     nonoverlapping (word pc,0x3b1) (z,8 * 16) /\
  ...
  X86_ACCSTEPS_TAC BIGNUM_SQR_8_16_EXEC (1--178) (1--178) THEN
 ...
 (`!z x a pc stackpointer returnaddress.
     ...
     ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RCX; RDX; R8; R9; R10; R11] ,,
           ...
           MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_STACK_TAC BIGNUM_SQR_8_16_EXEC BIGNUM_SQR_8_16_CORRECT
