...
(**** print_literal_from_elf "X86/word_ctz.o";;
 ****)

let word_ctz_mc = define_assert_from_elf "word_ctz_mc" "X86/word_ctz.o"
[
...
let WORD_CTZ_EXEC = X86_MK_EXEC_RULE word_ctz_mc;;
 ...
 (`!a pc stackpointer returnaddress.
        ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RDX] ,,
           MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_NOSTACK_TAC WORD_CTZ_EXEC WORD_CTZ_CORRECT);;
