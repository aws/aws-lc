...
(**** print_literal_from_elf "X86/bignum_amontsqr.o";;
 ****)

let bignum_amontsqr_mc =
  define_assert_from_elf "bignum_amontsqr_mc" "X86/bignum_amontsqr.o"
[
  0x53;                    (* PUSH (% rbx) *)
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_AMONTSQR_EXEC = X86_MK_EXEC_RULE bignum_amontsqr_mc;;
 ...
 (`!k z x m a n pc stackpointer returnaddress.
      ...
      ==> ensures x86
           ...
           (MAYCHANGE [RIP; RSP; RAX; RDX; R8; R9; R10; R11] ,,
            ...
            MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_STACK_TAC BIGNUM_AMONTSQR_EXEC BIGNUM_AMONTSQR_CORRECT
