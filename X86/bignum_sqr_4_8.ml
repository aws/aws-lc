...
(**** print_literal_from_elf "X86/bignum_sqr_4_8.o";;
 ****)

let bignum_sqr_4_8_mc =
  define_assert_from_elf "bignum_sqr_4_8_mc" "X86/bignum_sqr_4_8.o"
[
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
  0x41; 0x55;              (* PUSH (% r13) *)
...
let BIGNUM_SQR_4_8_EXEC = X86_MK_EXEC_RULE bignum_sqr_4_8_mc;;
 ...
 (`!z x a pc stackpointer returnaddress.
     ...
     ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RCX; RDX; R8; R9; R10; R11] ,,
           ...
           MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_STACK_TAC BIGNUM_SQR_4_8_EXEC BIGNUM_SQR_4_8_CORRECT
   `[RBP; R12; R13]` 24);;
