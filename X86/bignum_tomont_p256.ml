...
(**** print_literal_from_elf "X86/bignum_tomont_p256.o";;
 ****)

let bignum_tomont_p256_mc =
  define_assert_from_elf "bignum_tomont_p256_mc" "X86/bignum_tomont_p256.o"
[
  0x41; 0x54;              (* PUSH (% r12) *)
  0x41; 0x55;              (* PUSH (% r13) *)
  0x41; 0x56;              (* PUSH (% r14) *)
...
let BIGNUM_TOMONT_P256_EXEC = X86_MK_EXEC_RULE bignum_tomont_p256_mc;;
...
let BIGNUM_TOMONT_P256_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC
    BIGNUM_TOMONT_P256_EXEC BIGNUM_TOMONT_P256_CORRECT
    `[R12; R13; R14; R15]` 32);;
