...
%define mat_mm     QWORD[rsp+8*0]
%define mat_mn     QWORD[rsp+8*1]
%define mat_nm     QWORD[rsp+8*2]
%define mat_nn     QWORD[rsp+8*3]
%define t          QWORD[rsp+8*4]
%define v          QWORD[rsp+8*5]       ; Modular inverse
%define m          QWORD[rsp+8*6]       ; We reconstruct n as m + 8*k as needed
%define w          QWORD[rsp+8*7]
%define z          QWORD[rsp+8*8]
%define bm         QWORD[rsp+8*9]      ; Original b pointer, not b the temp

%define STACKVARSIZE (8*10)
