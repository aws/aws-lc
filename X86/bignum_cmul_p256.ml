...
(**** print_literal_from_elf "X86/bignum_cmul_p256.o";;
 ****)

let bignum_cmul_p256_mc =
  define_assert_from_elf "bignum_cmul_p256_mc" "X86/bignum_cmul_p256.o"
[
...
let BIGNUM_CMUL_P256_EXEC = X86_MK_EXEC_RULE bignum_cmul_p256_mc;;
 ...
 (`!z c x a pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RIP; RSP; RSI; RAX; RCX; RDX; R8; R9; R10; R11] ,,
              MAYCHANGE [memory :> bytes(z,8 * 4)] ,,
              MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_CMUL_P256_EXEC BIGNUM_CMUL_P256_CORRECT);;
