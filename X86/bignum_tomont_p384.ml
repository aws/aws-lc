...
(**** print_literal_from_elf "X86/bignum_tomont_p384.o";;
 ****)

let bignum_tomont_p384_mc =
  define_assert_from_elf "bignum_tomont_p384_mc" "X86/bignum_tomont_p384.o"
[
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
  0x41; 0x55;              (* PUSH (% r13) *)
...
let BIGNUM_TOMONT_P384_EXEC = X86_MK_EXEC_RULE bignum_tomont_p384_mc;;
...
let BIGNUM_TOMONT_P384_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC
   BIGNUM_TOMONT_P384_EXEC BIGNUM_TOMONT_P384_CORRECT
