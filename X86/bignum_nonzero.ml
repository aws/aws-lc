...
(**** print_literal_from_elf "X86/bignum_nonzero.o";;
 ****)

let bignum_nonzero_mc =
  define_assert_from_elf "bignum_nonzero_mc" "X86/bignum_nonzero.o"
[
...
let BIGNUM_NONZERO_EXEC = X86_MK_EXEC_RULE bignum_nonzero_mc;;
 ...
 (`!k a x pc stackpointer returnaddress.
        ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RDI] ,,
           MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_NONZERO_EXEC BIGNUM_NONZERO_CORRECT);;
