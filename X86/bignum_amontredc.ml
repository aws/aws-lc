...
(**** print_literal_from_elf "X86/bignum_amontredc.o";;
 ****)

let bignum_amontredc_mc =
  define_assert_from_elf "bignum_amontredc_mc" "X86/bignum_amontredc.o"
[
  0x53;                    (* PUSH (% rbx) *)
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_AMONTREDC_EXEC = X86_MK_EXEC_RULE bignum_amontredc_mc;;
 ...
 (`!k z r x m p a n pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RIP; RSP; RAX; RDX; R10; R11] ,,
              ...
              MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_STACK_TAC BIGNUM_AMONTREDC_EXEC BIGNUM_AMONTREDC_CORRECT
