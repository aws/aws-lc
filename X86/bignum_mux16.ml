...
(**** print_literal_from_elf "X86/bignum_mux16.o";;
 ****)

let bignum_mux16_mc =
  define_assert_from_elf "bignum_mux16_mc" "X86/bignum_mux16.o"
[
...
let BIGNUM_MUX16_EXEC = X86_MK_EXEC_RULE bignum_mux16_mc;;
 ...
 (`!k z xs i n pc stackpointer returnaddress.
     ...
     ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RSI; RCX; RAX; RDX; R8; R9; R10] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,val k)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_MUX16_EXEC BIGNUM_MUX16_CORRECT);;
