...
(**** print_literal_from_elf "X86/bignum_half_p256.o";;
 ****)

let bignum_half_p256_mc =
  define_assert_from_elf "bignum_half_p256_mc" "X86/bignum_half_p256.o"
[
...
let BIGNUM_HALF_P256_EXEC = X86_MK_EXEC_RULE bignum_half_p256_mc;;
 ...
 (`!z x n pc stackpointer returnaddress.
        ...
        ==> ensures x86
            ...
            (MAYCHANGE [RIP; RSP; RAX; RDX; RCX; R8; R9] ,,
             MAYCHANGE SOME_FLAGS ,,
             MAYCHANGE [memory :> bignum(z,4)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_HALF_P256_EXEC
