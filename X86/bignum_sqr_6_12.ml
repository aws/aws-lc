...
(**** print_literal_from_elf "X86/bignum_sqr_6_12.o";;
 ****)

let bignum_sqr_6_12_mc =
  define_assert_from_elf "bignum_sqr_6_12_mc" "X86/bignum_sqr_6_12.o"
[
  0x55;                    (* PUSH (% rbp) *)
  0x53;                    (* PUSH (% rbx) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_SQR_6_12_EXEC = X86_MK_EXEC_RULE bignum_sqr_6_12_mc;;
...
let BIGNUM_SQR_6_12_CORRECT = time prove
 (`!z x a pc.
     nonoverlapping (word pc,0x223) (z,8 * 12) /\
 ...
 (`!z x a pc stackpointer returnaddress.
     ...
     ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RCX; RDX; R8; R9; R10; R11] ,,
           ...
           MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_STACK_TAC BIGNUM_SQR_6_12_EXEC BIGNUM_SQR_6_12_CORRECT
