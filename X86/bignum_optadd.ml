...
(**** print_literal_from_elf "X86/bignum_optadd.o";;
 ****)

let bignum_optadd_mc =
  define_assert_from_elf "bignum_optadd_mc" "X86/bignum_optadd.o"
[
...
let BIGNUM_OPTADD_EXEC = X86_MK_EXEC_RULE bignum_optadd_mc;;
 ...
 (`!k z x p y a b pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RIP; RSP; RAX; RCX; R9; R10; R11] ,,
              MAYCHANGE SOME_FLAGS ,,
              MAYCHANGE [memory :> bignum(z,val k)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_OPTADD_EXEC BIGNUM_OPTADD_CORRECT);;
