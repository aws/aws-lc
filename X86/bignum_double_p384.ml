...
(**** print_literal_from_elf "X86/bignum_double_p384.o";;
 ****)

let bignum_double_p384_mc =
  define_assert_from_elf "bignum_double_p384_mc" "X86/bignum_double_p384.o"
[
...
let BIGNUM_DOUBLE_P384_EXEC = X86_MK_EXEC_RULE bignum_double_p384_mc;;
