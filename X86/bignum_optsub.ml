...
(**** print_literal_from_elf "X86/bignum_optsub.o";;
 ****)

let bignum_optsub_mc =
  define_assert_from_elf "bignum_optsub_mc" "X86/bignum_optsub.o"
[
...
let BIGNUM_OPTSUB_EXEC = X86_MK_EXEC_RULE bignum_optsub_mc;;
 ...
 (`!k z x p y m n pc stackpointer returnaddress.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RCX; R9; R10; R11] ,,
           ...
           MAYCHANGE [memory :> bignum(z,val k)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_OPTSUB_EXEC BIGNUM_OPTSUB_CORRECT);;
