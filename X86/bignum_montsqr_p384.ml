...
(**** print_literal_from_elf "X86/bignum_montsqr_p384.o";;
 ****)

let bignum_montsqr_p384_mc =
  define_assert_from_elf "bignum_montsqr_p384_mc" "X86/bignum_montsqr_p384.o"
[
  0x53;                    (* PUSH (% rbx) *)
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_MONTSQR_P384_EXEC = X86_MK_EXEC_RULE bignum_montsqr_p384_mc;;
...
let BIGNUM_MONTSQR_P384_CORRECT = time prove
 (`!z x a pc.
  ...
  ASM_CASES_TAC `a EXP 2 <= 2 EXP 384 * p_384` THENL
   [ASM_REWRITE_TAC[]; X86_SIM_TAC BIGNUM_MONTSQR_P384_EXEC (1--237)] THEN
  ...
  X86_ACCSTEPS_TAC BIGNUM_MONTSQR_P384_EXEC (206--222) (206--222) THEN
  SUBGOAL_THEN
   `sum_s221:int64 = word(bitval(p_384 <= t))`
  SUBST_ALL_TAC THENL
  ...
  X86_ACCSTEPS_TAC BIGNUM_MONTSQR_P384_EXEC (223--237) (223--237) THEN
...
let BIGNUM_MONTSQR_P384_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC
   BIGNUM_MONTSQR_P384_EXEC BIGNUM_MONTSQR_P384_CORRECT
