...
(**** print_literal_from_elf "X86/bignum_shr_small.o";;
 ****)

let bignum_shr_small_mc =
  define_assert_from_elf "bignum_shr_small_mc" "X86/bignum_shr_small.o"
[
...
let BIGNUM_SHR_SMALL_EXEC = X86_MK_EXEC_RULE bignum_shr_small_mc;;
 ...
 (`!p z n x a c pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RIP; RSP; RDI; RAX; RCX; R8; R9; R10] ,,
              MAYCHANGE SOME_FLAGS ,,
              MAYCHANGE [memory :> bignum(z,val p)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_SHR_SMALL_EXEC BIGNUM_SHR_SMALL_CORRECT);;
