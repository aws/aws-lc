...
(**** print_literal_from_elf "X86/bignum_demont_p256.o";;
 ****)

let bignum_demont_p256_mc =
  define_assert_from_elf "bignum_demont_p256_mc" "X86/bignum_demont_p256.o"
[
  0x53;                    (* PUSH (% rbx) *)
...
let BIGNUM_DEMONT_P256_EXEC = X86_MK_EXEC_RULE bignum_demont_p256_mc;;
...
let BIGNUM_DEMONT_P256_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC
    BIGNUM_DEMONT_P256_EXEC BIGNUM_DEMONT_P256_CORRECT `[RBX]` 8);;
