...
(**** print_literal_from_elf "X86/bignum_optneg_p384.o";;
 ****)

let bignum_optneg_p384_mc = define_assert_from_elf "bignum_optneg_p384_mc" "X86/bignum_optneg_p384.o"
[
...
let BIGNUM_OPTNEG_P384_EXEC = X86_MK_EXEC_RULE bignum_optneg_p384_mc;;
 ...
 (`!z q x n pc.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RSI; RAX; RCX; R8; R9; R10; R11] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,6)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_OPTNEG_P384_EXEC
