...
(**** print_literal_from_elf "X86/bignum_double_p256.o";;
 ****)

let bignum_double_p256_mc =
  define_assert_from_elf "bignum_double_p256_mc" "X86/bignum_double_p256.o"
[
...
let BIGNUM_DOUBLE_P256_EXEC = X86_MK_EXEC_RULE bignum_double_p256_mc;;
