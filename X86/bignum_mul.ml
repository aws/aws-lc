...
(**** print_literal_from_elf "X86/bignum_mul.o";;
 ****)

let bignum_mul_mc =
  define_assert_from_elf "bignum_mul_mc" "X86/bignum_mul.o"
[
  0x53;                    (* PUSH (% rbx) *)
  0x55;                    (* PUSH (% rbp) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_MUL_EXEC = X86_MK_EXEC_RULE bignum_mul_mc;;
...
let BIGNUM_MUL_SUBROUTINE_CORRECT = prove
 (`!p m n z x y a b pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC BIGNUM_MUL_EXEC BIGNUM_MUL_CORRECT
