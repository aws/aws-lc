...
(**** print_literal_from_elf "X86/bignum_modifier.o";;
 ****)

let bignum_modifier_mc =
  define_assert_from_elf "bignum_modifier_mc" "X86/bignum_modifier.o"
[
  0x55;                    (* PUSH (% rbp) *)
  0x53;                    (* PUSH (% rbx) *)
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_MODIFIER_EXEC = X86_MK_EXEC_RULE bignum_modifier_mc;;
 ...
 (`!k z m t n pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RIP; RSP; RAX; RCX; RDX; R8; R9; R10; R11] ,,
              ...
              MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_STACK_TAC BIGNUM_MODIFIER_EXEC BIGNUM_MODIFIER_CORRECT
   `[RBX; RBP; R12; R13]` 32);;
