...
(**** print_literal_from_elf "X86/bignum_coprime.o";;
 ****)

let bignum_coprime_mc =
  define_assert_from_elf "bignum_coprime_mc" "X86/bignum_coprime.o"
[
  0x55;                    (* PUSH (% rbp) *)
  0x53;                    (* PUSH (% rbx) *)
  0x41; 0x54;              (* PUSH (% r12) *)
   ...
   [UNDISCH_TAC `64 <= t` THEN ARITH_TAC;
    ...
    ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
     [SIMPLE_ARITH_TAC;
      ...
      MATCH_MP_TAC LE_MULT2 THEN REWRITE_TAC[LE_EXP] THEN SIMPLE_ARITH_TAC;
