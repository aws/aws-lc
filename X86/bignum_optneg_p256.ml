...
(**** print_literal_from_elf "X86/bignum_optneg_p256.o";;
 ****)

let bignum_optneg_p256_mc = define_assert_from_elf "bignum_optneg_p256_mc" "X86/bignum_optneg_p256.o"
[
...
let BIGNUM_OPTNEG_P256_EXEC = X86_MK_EXEC_RULE bignum_optneg_p256_mc;;
 ...
 (`!z q x n pc stackpointer returnaddress.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RSI; RAX; RCX; R8; R9] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,4)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_OPTNEG_P256_EXEC
