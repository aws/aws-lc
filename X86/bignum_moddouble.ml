...
(**** print_literal_from_elf "X86/bignum_moddouble.o";;
 ****)

let bignum_moddouble_mc =
  define_assert_from_elf "bignum_moddouble_mc" "X86/bignum_moddouble.o"
[
...
let BIGNUM_MODDOUBLE_EXEC = X86_MK_EXEC_RULE bignum_moddouble_mc;;
 ...
 (`!k z x m a n pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RIP; RSP; RAX; R8; R9; R10] ,,
              MAYCHANGE SOME_FLAGS ,,
              MAYCHANGE [memory :> bignum(z,val k)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_MODDOUBLE_EXEC BIGNUM_MODDOUBLE_CORRECT);;
