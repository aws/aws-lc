...
(**** print_literal_from_elf "X86/bignum_cmul_p384.o";;
 ****)

let bignum_cmul_p384_mc =
  define_assert_from_elf "bignum_cmul_p384_mc" "X86/bignum_cmul_p384.o"
[
  0x41; 0x54;              (* PUSH (% r12) *)
...
let BIGNUM_CMUL_P384_EXEC = X86_MK_EXEC_RULE bignum_cmul_p384_mc;;
...
let BIGNUM_CMUL_P384_SUBROUTINE_CORRECT = time prove
 (`!z c x a pc stackpointer returnaddress.
  ...
  X86_ADD_RETURN_STACK_TAC
    BIGNUM_CMUL_P384_EXEC BIGNUM_CMUL_P384_CORRECT
    `[R12]` 8);;
