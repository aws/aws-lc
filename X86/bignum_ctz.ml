...
(**** print_literal_from_elf "X86/bignum_ctz.o";;
 ****)

let bignum_ctz_mc = define_assert_from_elf "bignum_ctz_mc" "X86/bignum_ctz.o"
[
...
let BIGNUM_CTZ_EXEC = X86_MK_EXEC_RULE bignum_ctz_mc;;
 ...
 (`!k a x pc stackpointer returnaddress.
        ensures x86
         ...
         (MAYCHANGE [RIP; RSP; RDI; RDX; RCX; RAX] ,,
          MAYCHANGE SOME_FLAGS)`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_CTZ_EXEC BIGNUM_CTZ_CORRECT);;
