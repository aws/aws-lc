...
(**** print_literal_from_elf "X86/bignum_mod_p256_4.o";;
 ****)

let bignum_mod_p256_4_mc =
  define_assert_from_elf "bignum_mod_p256_4_mc" "X86/bignum_mod_p256_4.o"
[
...
let BIGNUM_MOD_P256_4_EXEC = X86_MK_EXEC_RULE bignum_mod_p256_4_mc;;
 ...
 (`!z x n pc stackpointer returnaddress.
      ...
      ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSP; RAX; RDX; RCX; R8; R9; R10; R11] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,4)])`,
  X86_ADD_RETURN_NOSTACK_TAC BIGNUM_MOD_P256_4_EXEC BIGNUM_MOD_P256_4_CORRECT);;
