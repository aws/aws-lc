...
[
  ...
  0x93cf260f;       (* arm_EXTR X15 X16 X15 (rvalue (word 9)) *)
  0x93d02630;       (* arm_EXTR X16 X17 X16 (rvalue (word 9)) *)
  0xa900400f;       (* arm_STP X15 X16 X0 (Immediate_Offset (iword (&0))) *)
  0x93d12671;       (* arm_EXTR X17 X19 X17 (rvalue (word 9)) *)
  0x93d324f3;       (* arm_EXTR X19 X7 X19 (rvalue (word 9)) *)
  0xa9014c11;       (* arm_STP X17 X19 X0 (Immediate_Offset (iword (&16))) *)
  ...
  0x93ca268a;       (* arm_EXTR X10 X20 X10 (rvalue (word 9)) *)
...
let BIGNUM_MUL_P521_CORRECT = prove
 (`!z x y a b pc.
        ALL (nonoverlapping (z,8 * 9)) [(word pc,0x9e4); (x,8 * 9); (y,8 * 9)]
        ==> ensures arm
