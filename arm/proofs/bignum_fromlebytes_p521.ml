...
let BIGNUM_FROMLEBYTES_P521_CORRECT = time prove
 (`!z x l pc.
  ...
  REWRITE_TAC[BIT_WORD_JOIN; BIT_WORD_SUBWORD; BIT_WORD_ZX; BIT_WORD_0] THEN
  ...
  REWRITE_TAC[BITVAL_CLAUSES] THEN ONCE_REWRITE_TAC[BIT_GUARD] THEN
  CONV_TAC(DEPTH_CONV
   (NUM_RED_CONV ORELSEC DIMINDEX_CONV ORELSEC
