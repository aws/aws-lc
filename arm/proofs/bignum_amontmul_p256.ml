...
(* ========================================================================= *)
(* Almost-Montgomery multiplication modulo p_256.                            *)
(* ========================================================================= *)

(**** print_literal_from_elf "arm/p256/bignum_amontmul_p256.o";;
 ****)

let bignum_amontmul_p256_mc =
  define_assert_from_elf "bignum_amontmul_p256_mc" "arm/p256/bignum_amontmul_p256.o"
[
...
let BIGNUM_AMONTMUL_P256_EXEC = ARM_MK_EXEC_RULE bignum_amontmul_p256_mc;;
...
let BIGNUM_AMONTMUL_P256_CORRECT = time prove
 (`!z x y a b pc.
        ...
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) bignum_amontmul_p256_mc /\
                  read PC s = word pc /\
                  C_ARGUMENTS [z; x; y] s /\
  ...
  ***)
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC (29--46) (29--46) THEN
  SUBGOAL_THEN
  ...
  ***)
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC [71;72;76;78] (71--78) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC [79;80;84;86] (79--86) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[ADD_CLAUSES; WORD_RULE
   `word_sub (word 0) x = word_neg x`]) THEN
  SUBGOAL_THEN
  ...
  ARM_STEPS_TAC BIGNUM_AMONTMUL_P256_EXEC [87] THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC (88--94) (88--94) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC (136--154) (136--154) THEN
  ABBREV_TAC
  ...
  SUBGOAL_THEN `sum_s154:int64 = word h` SUBST_ALL_TAC THENL
   [MAP_EVERY EXPAND_TAC ["h"; "t"] THEN
    REWRITE_TAC[ARITH_RULE `256 = 64 + 64 + 64 + 64`] THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P256_EXEC [166;169;170;173] (166--175) THEN
 ...
 (`!z x y a b pc returnaddress.
        ...
        ==> ensures arm
             ...
             (MAYCHANGE [PC; X1; X2; X3; X4; X5; X6; X7; X8; X9; X10; X11; X12;
              ...
              MAYCHANGE [memory :> bytes(z,8 * 4)] ,,
              MAYCHANGE SOME_FLAGS)`,
  ARM_ADD_RETURN_NOSTACK_TAC BIGNUM_AMONTMUL_P256_EXEC
