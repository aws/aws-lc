...
let LOCAL_SQR_P256K1_TAC =
  ARM_MACRO_SIM_ABBREV_TAC secp256k1_jadd_mc 78 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (1--45) (1--45) THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (46--64) (46--64) THEN
  ...
  ARM_STEPS_TAC SECP256K1_JADD_EXEC [93] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (66--78) (66--78) THEN
...
let LOCAL_MUL_P256K1_TAC =
  ARM_MACRO_SIM_ABBREV_TAC secp256k1_jadd_mc 100 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (1--67) (1--67) THEN
  MAP_EVERY ABBREV_TAC
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (68--86) (68--86) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[COND_SWAP; GSYM WORD_BITVAL]) THEN
  ABBREV_TAC
   `ca = bignum_of_wordlist
  ...
  SUBGOAL_THEN `ca DIV 2 EXP 256 = val(sum_s86:int64)` SUBST_ALL_TAC THENL
   [EXPAND_TAC "ca" THEN CONV_TAC(LAND_CONV BIGNUM_OF_WORDLIST_DIV_CONV) THEN
    ...
    FIRST_ASSUM(ASSUME_TAC o MATCH_MP (ARITH_RULE
     `n + 1 < 2 EXP 64 ==> n < 2 EXP 64 - 1`))] THEN
  ARM_STEPS_TAC SECP256K1_JADD_EXEC [87] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (88--100) (88--100) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC(LAND_CONV BIGNUM_EXPAND_CONV) THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC SYM_CONV THEN MATCH_MP_TAC MOD_UNIQ_BALANCED_REAL THEN
  MAP_EVERY EXISTS_TAC [`val(q:int64)`; `256`] THEN ASM_REWRITE_TAC[] THEN
...
let SECP256K1_JADD_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer.
        ...
        ==> ensures arm
             ...
             (\s. read PC s = word (pc + 0x198c) /\
                  (!x1 y1 z1 x2 y2 z2.
                        ...
                        t2 = tripled secp256k1_encode (x2,y2,z2)
  ...
  DISCH_THEN(fun th -> DISCH_TAC THEN ENSURES_FINAL_STATE_TAC THEN MP_TAC th) THEN
  ...
  ASM_REWRITE_TAC[tripled; jacobian_add; secp256k1] THEN
