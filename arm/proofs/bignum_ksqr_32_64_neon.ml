...
let bignum_ksqr_32_64_neon_mc =
  define_assert_from_elf "bignum_ksqr_32_64_neon_mc" "arm/fastmul/bignum_ksqr_32_64_neon.o"
[
...
let BIGNUM_KSQR_32_64_NEON_SUBLEMMA = prove
 (`!z x a pc returnaddress.
      ALL (nonoverlapping (z,8 * 16))
          [(word pc,3596); (x,8 * 8)]
      ==> ensures arm
           (\s. aligned_bytes_loaded s (word(pc + 0x0)) bignum_ksqr_32_64_neon_mc /\
  ...
  ARM_REWRITE_ASSUM_AND_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC
  ...
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC
  ...
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (332--364) (332--365) THEN
...
let BIGNUM_KSQR_32_64_NEON_SUBLEMMA_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_NEON_EXEC,
     0x0,bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_NEON_SUBLEMMA)
    [`read X0 s`; `read X1 s`;
...
let BIGNUM_KSQR_32_64_NEON_LEMMA = prove
 (`!z x a t pc.
        ...
        ALLPAIRS nonoverlapping
         ...
         [(word pc,3596); (x,8 * 16)]
        ==> ensures arm
              (\s. aligned_bytes_loaded s (word pc) bignum_ksqr_32_64_neon_mc /\
  ...
  ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (1--4) THEN
  BIGNUM_KSQR_32_64_NEON_SUBLEMMA_TAC 5 THEN
  ...
  ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (44--46) THEN
  BIGNUM_KSQR_32_64_NEON_SUBLEMMA_TAC 47 THEN
  ...
  ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (84--86) THEN
  BIGNUM_KSQR_32_64_NEON_SUBLEMMA_TAC 87 THEN
...
let BIGNUM_KSQR_32_64_NEON_SUBROUTINE_LEMMA = prove
 (`!z x a t pc stackpointer returnaddress.
        ...
        ==> ensures arm
              (\s. aligned_bytes_loaded s
                    (word (pc + 0x0)) bignum_ksqr_32_64_neon_mc /\
  ...
  ARM_ADD_RETURN_STACK_TAC
   BIGNUM_KSQR_32_64_NEON_EXEC BIGNUM_KSQR_32_64_NEON_LEMMA
    `[X19;X20;X21;X22;X23;X24;X25;X30]` 64);;

let BIGNUM_KSQR_32_64_NEON_LEMMA_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_NEON_EXEC,
     0x0,bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_NEON_SUBROUTINE_LEMMA)
    [`read X0 s`; `read X1 s`;
...
let BIGNUM_KSQR_32_64_NEON_SUBROUTINE_CORRECT = prove
 (`!z x t a pc stackpointer returnaddress.
  ...
  REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THENL
   [ENSURES_EXISTING_PRESERVED_TAC `SP`;
    DISCH_THEN(fun th ->
      ...
      ENSURES_INIT_TAC "s0" THEN
      ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (1--2) THEN
      MP_TAC th) THEN
    ARM_BIGSTEP_TAC BIGNUM_KSQR_32_64_NEON_EXEC "s3" THEN
    ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (4--6) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[]] THEN
  ...
  ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (1--4) THEN
  BIGNUM_KSQR_32_64_NEON_LEMMA_TAC 5 THEN

  (*** Second nested squaring: high part ***)

  ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (6--9) THEN
  BIGNUM_KSQR_32_64_NEON_LEMMA_TAC 10 THEN
  ...
  ARM_STEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (157--160) THEN
  BIGNUM_KSQR_32_64_NEON_LEMMA_TAC 161 THEN
