...
let BIGNUM_SQR_P521_ALT_CORRECT = time prove
 (`!z x n pc.
        nonoverlapping (word pc,0x3c0) (z,8 * 9)
        ==> ensures arm
  ...
  ASM_CASES_TAC `n < p_521` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC BIGNUM_SQR_P521_ALT_EXEC (1--229)] THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_SQR_P521_ALT_EXEC (1--194) (1--194) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_SQR_P521_ALT_EXEC (215--223) (215--229) THEN
