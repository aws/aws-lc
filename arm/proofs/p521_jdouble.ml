...
let LOCAL_SQR_P521_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p521_jdouble_mc 230 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `n < p_521` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P521_JDOUBLE_EXEC (1--230)] THEN
  ...
  ARM_ACCSTEPS_TAC P521_JDOUBLE_EXEC (1--195) (1--195) THEN
  ...
  ARM_ACCSTEPS_TAC P521_JDOUBLE_EXEC (216--224) (216--230) THEN
...
let LOCAL_MUL_P521_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p521_jdouble_mc 373 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    ARM_SIM_TAC P521_JDOUBLE_EXEC (1--373)] THEN
  ...
  ARM_ACCSTEPS_TAC P521_JDOUBLE_EXEC (1--334) (1--334) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[COND_SWAP; GSYM WORD_BITVAL]) THEN
  ...
  ARM_ACCSTEPS_TAC P521_JDOUBLE_EXEC (359--367) (359--373) THEN
...
let LOCAL_ADD_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m < p_521 /\ n < p_521` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P521_JDOUBLE_EXEC (1--37)] THEN
  REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
...
let LOCAL_WEAKMUL_P521_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p521_jdouble_mc 362 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
    !a. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 9)) t = a
    ==>
    !b. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 9)) t = b
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    ARM_SIM_TAC P521_JDOUBLE_EXEC (1--362)] THEN
