...
let bignum_montmul_p521_mc =
  define_assert_from_elf "bignum_montmul_p521_mc" "arm/p521/bignum_montmul_p521.o"
[
  ...
  0xba150231;       (* arm_ADCS X17 X17 X21 *)
  0x9a150273;       (* arm_ADC X19 X19 X21 *)
  0xd377d975;       (* arm_LSL X21 X11 (rvalue (word 9)) *)
  0x93cbdd8b;       (* arm_EXTR X11 X12 X11 (rvalue (word 55)) *)
  0x93ccddac;       (* arm_EXTR X12 X13 X12 (rvalue (word 55)) *)
  0x93cdddcd;       (* arm_EXTR X13 X14 X13 (rvalue (word 55)) *)
  0xd377fdce;       (* arm_LSR X14 X14 (rvalue (word 55)) *)
  ...
  0xd377d978;       (* arm_LSL X24 X11 (rvalue (word 9)) *)
  0xaa190318;       (* arm_ORR X24 X24 X25 *)
  0xba1800e7;       (* arm_ADCS X7 X7 X24 *)
  0x93cbdd98;       (* arm_EXTR X24 X12 X11 (rvalue (word 55)) *)
  0xba180108;       (* arm_ADCS X8 X8 X24 *)
  0x93ccddb8;       (* arm_EXTR X24 X13 X12 (rvalue (word 55)) *)
  0xba180129;       (* arm_ADCS X9 X9 X24 *)
  0x93cdddd8;       (* arm_EXTR X24 X14 X13 (rvalue (word 55)) *)
  0xba18014a;       (* arm_ADCS X10 X10 X24 *)
  0xd377fdd8;       (* arm_LSR X24 X14 (rvalue (word 55)) *)
  ...
  0x93c3d098;       (* arm_EXTR X24 X4 X3 (rvalue (word 52)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd6;       (* arm_MUL X22 X6 X24 *)
  0x93cbd198;       (* arm_EXTR X24 X12 X11 (rvalue (word 52)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374fef8;       (* arm_LSR X24 X23 (rvalue (word 52)) *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374cef7;       (* arm_LSL X23 X23 (rvalue (word 12)) *)
  0x93d732d8;       (* arm_EXTR X24 X22 X23 (rvalue (word 12)) *)
  ...
  0x93c4a0b8;       (* arm_EXTR X24 X5 X4 (rvalue (word 40)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd7;       (* arm_MUL X23 X6 X24 *)
  0x93cca1b8;       (* arm_EXTR X24 X13 X12 (rvalue (word 40)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd374fed8;       (* arm_LSR X24 X22 (rvalue (word 52)) *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd374ced6;       (* arm_LSL X22 X22 (rvalue (word 12)) *)
  0x93d662f8;       (* arm_EXTR X24 X23 X22 (rvalue (word 24)) *)
  0xba180210;       (* arm_ADCS X16 X16 X24 *)
  0x93c57078;       (* arm_EXTR X24 X3 X5 (rvalue (word 28)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd6;       (* arm_MUL X22 X6 X24 *)
  0x93cd7178;       (* arm_EXTR X24 X11 X13 (rvalue (word 28)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374fef8;       (* arm_LSR X24 X23 (rvalue (word 52)) *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374cef7;       (* arm_LSL X23 X23 (rvalue (word 12)) *)
  0x93d792d8;       (* arm_EXTR X24 X22 X23 (rvalue (word 36)) *)
  ...
  0x93c34098;       (* arm_EXTR X24 X4 X3 (rvalue (word 16)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd7;       (* arm_MUL X23 X6 X24 *)
  0x93cb4198;       (* arm_EXTR X24 X12 X11 (rvalue (word 16)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd3503eb5;       (* arm_LSL X21 X21 (rvalue (word 48)) *)
  0x8b1502f7;       (* arm_ADD X23 X23 X21 *)
  0xd374fed8;       (* arm_LSR X24 X22 (rvalue (word 52)) *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd374ced6;       (* arm_LSL X22 X22 (rvalue (word 12)) *)
  0x93d6c2f8;       (* arm_EXTR X24 X23 X22 (rvalue (word 48)) *)
  0xba180273;       (* arm_ADCS X19 X19 X24 *)
  0x8a13035a;       (* arm_AND X26 X26 X19 *)
  0xd344fc98;       (* arm_LSR X24 X4 (rvalue (word 4)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd6;       (* arm_MUL X22 X6 X24 *)
  0xd344fd98;       (* arm_LSR X24 X12 (rvalue (word 4)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374fef8;       (* arm_LSR X24 X23 (rvalue (word 52)) *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374cef7;       (* arm_LSL X23 X23 (rvalue (word 12)) *)
  0x93d7f2d9;       (* arm_EXTR X25 X22 X23 (rvalue (word 60)) *)
  0x93c4e0b8;       (* arm_EXTR X24 X5 X4 (rvalue (word 56)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd7;       (* arm_MUL X23 X6 X24 *)
  0x93cce1b8;       (* arm_EXTR X24 X13 X12 (rvalue (word 56)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd374fed8;       (* arm_LSR X24 X22 (rvalue (word 52)) *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd378df39;       (* arm_LSL X25 X25 (rvalue (word 8)) *)
  0x93d922f8;       (* arm_EXTR X24 X23 X25 (rvalue (word 8)) *)
  0xba1800e7;       (* arm_ADCS X7 X7 X24 *)
  ...
  0x93c5b078;       (* arm_EXTR X24 X3 X5 (rvalue (word 44)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd6;       (* arm_MUL X22 X6 X24 *)
  0x93cdb178;       (* arm_EXTR X24 X11 X13 (rvalue (word 44)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374fef8;       (* arm_LSR X24 X23 (rvalue (word 52)) *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374cef7;       (* arm_LSL X23 X23 (rvalue (word 12)) *)
  0x93d752d8;       (* arm_EXTR X24 X22 X23 (rvalue (word 20)) *)
  0xba180108;       (* arm_ADCS X8 X8 X24 *)
  0x8a08035a;       (* arm_AND X26 X26 X8 *)
  0x93c38098;       (* arm_EXTR X24 X4 X3 (rvalue (word 32)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187cd7;       (* arm_MUL X23 X6 X24 *)
  0x93cb8198;       (* arm_EXTR X24 X12 X11 (rvalue (word 32)) *)
  0x9240cf18;       (* arm_AND X24 X24 (rvalue (word 4503599627370495)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd374fed8;       (* arm_LSR X24 X22 (rvalue (word 52)) *)
  0x8b1802f7;       (* arm_ADD X23 X23 X24 *)
  0xd374ced6;       (* arm_LSL X22 X22 (rvalue (word 12)) *)
  0x93d682f8;       (* arm_EXTR X24 X23 X22 (rvalue (word 32)) *)
  0xba180129;       (* arm_ADCS X9 X9 X24 *)
  0x8a09035a;       (* arm_AND X26 X26 X9 *)
  0xd354fc98;       (* arm_LSR X24 X4 (rvalue (word 20)) *)
  0x9b187cd6;       (* arm_MUL X22 X6 X24 *)
  0xd354fd98;       (* arm_LSR X24 X12 (rvalue (word 20)) *)
  0x9b187dd8;       (* arm_MUL X24 X14 X24 *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374fef8;       (* arm_LSR X24 X23 (rvalue (word 52)) *)
  0x8b1802d6;       (* arm_ADD X22 X22 X24 *)
  0xd374cef7;       (* arm_LSL X23 X23 (rvalue (word 12)) *)
  0x93d7b2d8;       (* arm_EXTR X24 X22 X23 (rvalue (word 44)) *)
  0xba18014a;       (* arm_ADCS X10 X10 X24 *)
  0x8a0a035a;       (* arm_AND X26 X26 X10 *)
  0x9b0e7cd8;       (* arm_MUL X24 X6 X14 *)
  0xd36cfed6;       (* arm_LSR X22 X22 (rvalue (word 44)) *)
  0x8b160318;       (* arm_ADD X24 X24 X22 *)
  0x9a180294;       (* arm_ADC X20 X20 X24 *)
  0xd349fe96;       (* arm_LSR X22 X20 (rvalue (word 9)) *)
  ...
  0xd377d9f6;       (* arm_LSL X22 X15 (rvalue (word 9)) *)
  ...
  0xd377fdef;       (* arm_LSR X15 X15 (rvalue (word 55)) *)
...
let BIGNUM_MONTMUL_P521_EXEC = ARM_MK_EXEC_RULE bignum_montmul_p521_mc;;
...
let BIGNUM_MONTMUL_P521_CORRECT = prove
 (`!z x y a b pc.
        ALL (nonoverlapping (z,8 * 9)) [(word pc,0x9d0); (x,8 * 9); (y,8 * 9)]
        ==> ensures arm
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    ARM_SIM_TAC BIGNUM_MONTMUL_P521_EXEC (1--619)] THEN
  ...
  SUBGOAL_THEN
   `a DIV 2 EXP (8 * 64) < 2 EXP 9 /\ b DIV 2 EXP (8 * 64) < 2 EXP 9`
  MP_TAC THENL
   [MAP_EVERY UNDISCH_TAC [`a < p_521`; `b < p_521`] THEN
    REWRITE_TAC[p_521] THEN ARITH_TAC;
    MAP_EVERY EXPAND_TAC ["a"; "b"] THEN
    CONV_TAC(LAND_CONV(BINOP_CONV(LAND_CONV(RAND_CONV(RAND_CONV(LAND_CONV
  ...
  REWRITE_TAC[ARITH_RULE
   `n < 2 EXP 522 <=> n DIV 2 EXP (8 * 64) < 2 EXP 10`] THEN
  EXPAND_TAC "hl" THEN
  ...
  STRIP_ASSUME_TAC THENL
   [REWRITE_TAC[MOD_LT_EQ] THEN UNDISCH_TAC `n < 2 EXP 576` THEN ARITH_TAC;
    ALL_TAC] THEN
  ARM_STEPS_TAC BIGNUM_MONTMUL_P521_EXEC (596--598) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_MONTMUL_P521_EXEC (599--601) (599--601) THEN
  SUBGOAL_THEN
   `carry_s601 <=>
    2 EXP 192 <=
  ...
  (ASSUME_TAC o SYM) THENL
   [MATCH_MP_TAC FLAG_FROM_CARRY_LE THEN EXISTS_TAC `192` THEN
    ...
    DISCH_THEN(fun th -> REWRITE_TAC[th]) THEN BOUNDER_TAC;
    ACCUMULATOR_POP_ASSUM_LIST(K ALL_TAC)] THEN
  ARM_ACCSTEPS_TAC BIGNUM_MONTMUL_P521_EXEC (602--610) (602--610) THEN
  SUBGOAL_THEN
  ...
  SUBGOAL_THEN `val(h:int64) = n DIV 2 EXP 521` SUBST_ALL_TAC THENL
   [SUBST1_TAC(SYM(ASSUME `word_ushr sum_s595 9 = (h:int64)`)) THEN
    REWRITE_TAC[VAL_WORD_USHR] THEN
    MATCH_MP_TAC(ARITH_RULE
     `m DIV 2 EXP (8 * 64) = x ==> x DIV 2 EXP 9 = m DIV 2 EXP 521`) THEN
    EXPAND_TAC "n" THEN
    REWRITE_TAC[TOP_DEPTH_CONV num_CONV `8`; MULT_CLAUSES; ADD_CLAUSES] THEN
    REWRITE_TAC[EXP_ADD; GSYM DIV_DIV; BIGNUM_OF_WORDLIST_DIV] THEN
   ...
   [MATCH_MP_TAC EQUAL_FROM_CONGRUENT_MOD_MOD THEN
    ...
    REPEAT CONJ_TAC THENL
     [REWRITE_TAC[BIGNUM_OF_WORDLIST_SPLIT_RULE(8,1)] THEN
      ...
      MATCH_MP_TAC(ARITH_RULE
       `x < 2 EXP (64 * 8) ==> x + 2 EXP 512 * m MOD 2 EXP 9 < 2 EXP 521`) THEN
      MATCH_MP_TAC BIGNUM_OF_WORDLIST_BOUND THEN
      REWRITE_TAC[LENGTH] THEN ARITH_TAC;
      REWRITE_TAC[p_521] THEN ARITH_TAC;
      REWRITE_TAC[p_521] THEN ARITH_TAC;
  ...
  ARM_STEPS_TAC BIGNUM_MONTMUL_P521_EXEC (611--619) THEN
