...
let BIGNUM_MONTSQR_P256_CORE_EQUIV = prove(equiv_goal,
  ...
  EQUIV_TRANS_TAC
    ...
    (montsqr_p256_eqin,montsqr_p256_eqout_TRANS)
    (BIGNUM_MONTSQR_P256_CORE_EXEC,BIGNUM_MONTSQR_P256_INTERM1_CORE_EXEC,
     BIGNUM_MONTSQR_P256_NEON_CORE_EXEC));;
...
let BIGNUM_MONTSQR_P256_NEON_CORE_CORRECT = prove(
  ...
  PROVE_ENSURES_FROM_EQUIV_AND_ENSURES_N_TAC
    BIGNUM_MONTSQR_P256_CORE_EQUIV BIGNUM_MONTSQR_P256_CORE_CORRECT_N
...
let BIGNUM_AMONTSQR_P256_NEON_CORE_CORRECT = prove(
  ...
  PROVE_ENSURES_FROM_EQUIV_AND_ENSURES_N_TAC
    BIGNUM_MONTSQR_P256_CORE_EQUIV BIGNUM_AMONTSQR_P256_CORE_CORRECT_N
    (BIGNUM_MONTSQR_P256_CORE_EXEC,BIGNUM_MONTSQR_P256_NEON_CORE_EXEC)
    (montsqr_p256_eqin,montsqr_p256_eqout));;
