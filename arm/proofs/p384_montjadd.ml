...
let LOCAL_MONTSQR_P384_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p384_montjadd_mc 260 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1.
    !a. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 6)) t = a
    ==>
    aligned 16 (read SP t) /\
    nonoverlapping (word pc,0x5b78) (word_add (read p3 t) (word n3),48)
    ==> ensures arm
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a EXP 2 <= 2 EXP 384 * p_384` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P384_MONTJADD_EXEC (1--260)] THEN
  ENSURES_INIT_TAC "s0" THEN
  FIRST_ASSUM(BIGNUM_DIGITIZE_TAC "x_" o lhand o concl) THEN

  (*** Squaring of the lower half ***)

  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (1--28) (1--28) THEN
  SUBGOAL_THEN
  ...
  montred_tac P384_MONTJADD_EXEC
  ...
  montred_subst_tac P384_MONTJADD_EXEC
  ...
  ARM_STEPS_TAC P384_MONTJADD_EXEC [74;75;76] THEN
 ...
 (*** Double the cross-product and add the Montgomerified lower square ***)
  ...
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (139--155) (139--155) THEN
  ...
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (201--237) (201--237) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[ADD_CLAUSES; VAL_WORD_BITVAL]) THEN
 ...
 (*** To make bounds reasoning more transparent, recast top as a bit ***)
  ...
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (238--247) (238--247) THEN
  SUBGOAL_THEN
  ...
  ARM_STEPS_TAC P384_MONTJADD_EXEC [248] THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_RULE
   `word_sub (word 0) x:int64 = word_neg x`]) THEN
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (249--260) (249--260) THEN
...
let LOCAL_MONTMUL_P384_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p384_montjadd_mc 377 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a * b <= 2 EXP 384 * p_384` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P384_MONTJADD_EXEC (1--377)] THEN
  ENSURES_INIT_TAC "s0" THEN
  ...
  ***)
  ...
  ARM_STEPS_TAC P384_MONTJADD_EXEC (114--116) THEN
  SUBGOAL_THEN
   `2 EXP 192 *
    bignum_of_wordlist
  ...
  ***)
  ...
  ARM_STEPS_TAC P384_MONTJADD_EXEC [201] THEN
  ...
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (202--214) (202--214) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[ADD_CLAUSES]) THEN
  SUBGOAL_THEN
   `bignum_of_wordlist
  ...
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (349--352) (349--352) THEN
  ...
  ARM_ACCSTEPS_TAC P384_MONTJADD_EXEC (357--362) (353--362) THEN
  SUBGOAL_THEN
  ...
  ARM_STEPS_TAC P384_MONTJADD_EXEC [363] THEN
...
let P384_MONTJADD_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer.
        ...
        ALL (nonoverlapping (stackpointer,336))
            [(word pc,0x5b78); (p1,144); (p2,144); (p3,144)] /\
        nonoverlapping (p3,144) (word pc,0x5b78)
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) p384_montjadd_mc /\
  ...
  ARM_STEPS_TAC P384_MONTJADD_EXEC (27--113) THEN
