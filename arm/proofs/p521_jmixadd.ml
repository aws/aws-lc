...
let LOCAL_SQR_P521_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p521_jmixadd_mc 230 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1.
    !n. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 9)) t = n
    ==>
    aligned 16 (read SP t) /\
    nonoverlapping (word pc,0x3d60) (word_add (read p3 t) (word n3),72)
    ==> ensures arm
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `n < p_521` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P521_JMIXADD_EXEC (1--230)] THEN
  ...
  ARM_ACCSTEPS_TAC P521_JMIXADD_EXEC (1--195) (1--195) THEN
  ...
  ARM_ACCSTEPS_TAC P521_JMIXADD_EXEC (216--224) (216--230) THEN
...
let LOCAL_MUL_P521_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p521_jmixadd_mc 373 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
    ...
    nonoverlapping (read X28 t,144) (read X26 t,216) /\
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    ARM_SIM_TAC P521_JMIXADD_EXEC (1--373)] THEN
  ...
  ARM_ACCSTEPS_TAC P521_JMIXADD_EXEC (1--334) (1--334) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[COND_SWAP; GSYM WORD_BITVAL]) THEN
  ...
  ARM_ACCSTEPS_TAC P521_JMIXADD_EXEC (359--367) (359--373) THEN
...
let LOCAL_SUB_P521_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p521_jmixadd_mc 34 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC P521_JMIXADD_EXEC (20--28) (20--34) THEN
...
let P521_JMIXADD_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer.
        ...
        ALLPAIRS nonoverlapping
         [(p3,216); (stackpointer,432)]
         [(word pc,0x3d60); (p1,216); (p2,144)] /\
        nonoverlapping (p3,216) (stackpointer,432)
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) p521_jmixadd_mc /\
...
let P521_JMIXADD_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
        ...
        ALLPAIRS nonoverlapping
         ...
         [(word pc,0x3d60); (p1,216); (p2,144)] /\
        nonoverlapping (p3,216) (word_sub stackpointer (word 512),512)
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) p521_jmixadd_mc /\
                  read PC s = word pc /\
                  read SP s = stackpointer /\
