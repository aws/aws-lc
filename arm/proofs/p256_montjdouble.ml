...
[
  ...
  0xa90c13e3;       (* arm_STP X3 X4 SP (Immediate_Offset (iword (&192))) *)
  0xa90d1be5;       (* arm_STP X5 X6 SP (Immediate_Offset (iword (&208))) *)
  ...
  0xa9460be1;       (* arm_LDP X1 X2 SP (Immediate_Offset (iword (&96))) *)
...
let LOCAL_MONTSQR_P256_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p256_montjdouble_mc 91 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a EXP 2 <= 2 EXP 256 * p_256` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P256_MONTJDOUBLE_EXEC (1--91)] THEN
  ENSURES_INIT_TAC "s0" THEN
  FIRST_ASSUM(BIGNUM_DIGITIZE_TAC "x_" o lhand o concl) THEN

  (*** Simulate the core pre-reduced result accumulation ***)

  ARM_ACCSTEPS_TAC P256_MONTJDOUBLE_EXEC (1--79) (1--79) THEN
  ...
  ARM_ACCSTEPS_TAC P256_MONTJDOUBLE_EXEC (81--85) (80--91) THEN
...
let LOCAL_MONTMUL_P256_TAC =
  ARM_MACRO_SIM_ABBREV_TAC p256_montjdouble_mc 117 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a * b <= 2 EXP 256 * p_256` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC P256_MONTJDOUBLE_EXEC (1--117)] THEN
  ENSURES_INIT_TAC "s0" THEN
  ...
  ARM_ACCSTEPS_TAC P256_MONTJDOUBLE_EXEC (1--104) (1--104) THEN
  ...
  ARM_ACCSTEPS_TAC P256_MONTJDOUBLE_EXEC (107--111) (105--117) THEN
  RULE_ASSUM_TAC(REWRITE_RULE
   [GSYM WORD_BITVAL; COND_SWAP; REAL_BITVAL_NOT]) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC(LAND_CONV BIGNUM_EXPAND_CONV) THEN ASM_REWRITE_TAC[] THEN
