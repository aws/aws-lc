...
let BIGNUM_MONTMUL_P256_CORE_EQUIV = prove(equiv_goal,
  ...
  EQUIV_TRANS_TAC
    ...
    (montmul_p256_eqin,montmul_p256_eqout_TRANS)
    (BIGNUM_MONTMUL_P256_CORE_EXEC,BIGNUM_MONTMUL_P256_INTERM1_CORE_EXEC,
     BIGNUM_MONTMUL_P256_NEON_CORE_EXEC));;
...
let BIGNUM_MONTMUL_P256_NEON_CORE_CORRECT = prove(
  ...
  PROVE_ENSURES_FROM_EQUIV_AND_ENSURES_N_TAC
    BIGNUM_MONTMUL_P256_CORE_EQUIV BIGNUM_MONTMUL_P256_CORE_CORRECT_N
    (BIGNUM_MONTMUL_P256_CORE_EXEC,BIGNUM_MONTMUL_P256_NEON_CORE_EXEC)
...
let BIGNUM_AMONTMUL_P256_NEON_CORE_CORRECT = prove(
  ...
  PROVE_ENSURES_FROM_EQUIV_AND_ENSURES_N_TAC
    BIGNUM_MONTMUL_P256_CORE_EQUIV BIGNUM_AMONTMUL_P256_CORE_CORRECT_N
    (BIGNUM_MONTMUL_P256_CORE_EXEC,BIGNUM_MONTMUL_P256_NEON_CORE_EXEC)
    (montmul_p256_eqin,montmul_p256_eqout));;
