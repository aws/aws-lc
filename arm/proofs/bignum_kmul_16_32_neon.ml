...
let bignum_kmul_16_32_neon_mc = define_assert_from_elf "bignum_kmul_16_32_neon_mc" "arm/fastmul/bignum_kmul_16_32_neon.o"
[
...
let BIGNUM_KMUL_16_32_NEON_EXEC = ARM_MK_EXEC_RULE bignum_kmul_16_32_neon_mc;;
...
let BIGNUM_KMUL_16_32_NEON_LEMMA = prove
 (`!z x y a b pc returnaddress.
      ALL (nonoverlapping (z,8 * 16))
          [(word pc,2932); (x,8 * 8); (y,8 * 8)]
      ==> ensures arm
            (\s. aligned_bytes_loaded s (word(pc + 0)) bignum_kmul_16_32_neon_mc /\
  ...
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (1--16) THEN
  simplify_128bit_words_and_accumulate "s16" THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (17--17) THEN
  simplify_128bit_words_and_accumulate "s17" THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (18--25) THEN
  simplify_128bit_words_and_accumulate "s25" THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (26--26) THEN
  ...
  rewrite_assumptions `y_6_7 = word_join (y_7:(64)word) (y_6:(64)word):(128)word`
    (MAP_EVERY EXPAND_TAC ["y_6_7"; "y_7"; "y_6"] THEN
     REWRITE_TAC[READ_MEMORY_BYTESIZED_SPLIT; WORD_ADD_ASSOC_CONSTS] THEN
     ARITH_TAC) THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (27--30) THEN

  (* First ADK block: Run the remaining scalar parts (1) *)
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [32;34;36] (31--37) THEN

  (* Second ADK block: multiply using vector instructions, but not move the
     results to scalar registers *)
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (38--44) THEN
  simplify_128bit_words THEN

  (* First ADK block: Run the remaining scalar parts *)
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC
  ...
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (153--161) THEN
  simplify_128bit_words_and_accumulate "s161" THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (162--162) THEN
  simplify_128bit_words_and_accumulate "s162" THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (163--170) THEN
  simplify_128bit_words_and_accumulate "s170" THEN
  ARM_ACCSTEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC [] (171--171) THEN
...
let BIGNUM_KMUL_16_32_NEON_LEMMA_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_kmul_16_32_neon_mc,BIGNUM_KMUL_16_32_NEON_EXEC,
     0x0,bignum_kmul_16_32_neon_mc,BIGNUM_KMUL_16_32_NEON_LEMMA)
...
let BIGNUM_KMUL_16_32_NEON_CORRECT = prove
 (`!z x y a b t pc.
        ...
        ==> ensures arm
              (\s. aligned_bytes_loaded s (word pc) bignum_kmul_16_32_neon_mc /\
  ...
  ARM_STEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC (1--5) THEN
  BIGNUM_KMUL_16_32_NEON_LEMMA_TAC 6 THEN
  ...
  ARM_STEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC (45--48) THEN
  BIGNUM_KMUL_16_32_NEON_LEMMA_TAC 49 THEN
  ...
  ARM_STEPS_TAC BIGNUM_KMUL_16_32_NEON_EXEC (125--128) THEN
  BIGNUM_KMUL_16_32_NEON_LEMMA_TAC 129 THEN
...
let BIGNUM_KMUL_16_32_NEON_SUBROUTINE_CORRECT = prove
