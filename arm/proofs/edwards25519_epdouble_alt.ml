...
let LOCAL_MUL_P25519_TAC =
  ARM_MACRO_SIM_ABBREV_TAC edwards25519_epdouble_alt_mc 102 lvs
   `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
      ...
      nonoverlapping (word pc,0xc7c) (word_add (read p3 t) (word n3),8 * 4)
      ==> ensures arm
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (68--85) (68--85) THEN
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (86--88) (86--88) THEN
  ...
  SUBGOAL_THEN `ca DIV 2 EXP 255 = val(sum_s88:int64)` SUBST_ALL_TAC THENL
   [UNDISCH_TAC `ca DIV 2 EXP 255 + 1 <= 78` THEN REWRITE_TAC[ARITH_RULE
    ...
    ACCUMULATOR_POP_ASSUM_LIST(K ALL_TAC)] THEN
  ARM_STEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (89--90) THEN
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (91--102) (91--102) THEN
...
let LOCAL_SQR_4_TAC =
  ARM_MACRO_SIM_ABBREV_TAC edwards25519_epdouble_alt_mc 74 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (46--63) (46--63) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[COND_SWAP; GSYM WORD_BITVAL]) THEN
  ABBREV_TAC
   `ca = bignum_of_wordlist
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (64--66) (64--66) THEN
  ...
  THENL
   [UNDISCH_TAC `ca DIV 2 EXP 255 + 1 <= 78` THEN REWRITE_TAC[ARITH_RULE
    ...
    DISCH_THEN(fun th -> REWRITE_TAC[th]) THEN REAL_INTEGER_TAC;
    ACCUMULATOR_POP_ASSUM_LIST(K ALL_TAC)] THEN
  ARM_STEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (67--68) THEN
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_EPDOUBLE_ALT_EXEC (69--72) (69--74) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let EDWARDS25519_EPDOUBLE_ALT_CORRECT = time prove
 (`!p3 p1 T1 pc stackpointer.
    ...
    ALL (nonoverlapping (stackpointer,160))
        [(word pc,0xc7c); (p3,128); (p1,96)] /\
    nonoverlapping (p3,128) (word pc,0xc7c)
    ==> ensures arm
         (\s. aligned_bytes_loaded s (word pc) edwards25519_epdouble_alt_mc /\
