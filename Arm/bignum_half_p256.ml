...
(**** print_literal_from_elf "Arm/bignum_half_p256.o";;
 ****)

let bignum_half_p256_mc = define_assert_from_elf "bignum_half_p256_mc" "Arm/bignum_half_p256.o"
[
  0xa9400c22;       (* arm_LDP X2 X3 X1 (Immediate_Offset (iword (&0))) *)
  0xa9411424;       (* arm_LDP X4 X5 X1 (Immediate_Offset (iword (&16))) *)
  0x92400047;       (* arm_AND X7 X2 (rvalue (word 1)) *)
  0xcb0703e7;       (* arm_NEG X7 X7 *)
  0x92800008;       (* arm_MOVN X8 (word 0) 0 *)
 ...
 (`!z x n pc.
  ...
  SUBGOAL_THEN `bit 0 (n_0:int64) <=> ODD n` SUBST_ALL_TAC THENL
   [EXPAND_TAC "n" THEN REWRITE_TAC[BIT_LSB; ODD_ADD; ODD_MULT; ODD_EXP] THEN
    ...
    ALL_TAC] THEN
  ARM_ACCSTEPS_TAC BIGNUM_HALF_P256_EXEC (5--14) (5--21) THEN
  ...
  SUBST1_TAC THENL
   [REWRITE_TAC[MOD_UNIQUE] THEN CONJ_TAC THENL
    ...
    ALL_TAC] THEN
  SUBGOAL_THEN
   `2 EXP 256 * bitval(carry_s14) +
    bignum_of_wordlist [sum_s7; sum_s10; sum_s11; sum_s14] =
