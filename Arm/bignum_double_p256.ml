...
(**** print_literal_from_elf "Arm/bignum_double_p256.o";;
 ****)

let bignum_double_p256_mc = define_assert_from_elf "bignum_double_p256_mc" "Arm/bignum_double_p256.o"
[
...
let BIGNUM_DOUBLE_P256_CORRECT = time prove
 (`!z x n pc.
  ...
  ARM_ACCSTEPS_TAC BIGNUM_DOUBLE_P256_EXEC (1--21) (1--21) THEN
