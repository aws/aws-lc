...
(* ========================================================================= *)
(* Almost-Montgomery multiplication modulo p_384.                            *)
(* ========================================================================= *)

(**** print_literal_from_elf "Arm/p384/bignum_amontmul_p384.o";;
 ****)

let bignum_amontmul_p384_mc =
  define_assert_from_elf "bignum_amontmul_p384_mc" "Arm/p384/bignum_amontmul_p384.o"
[
...
let BIGNUM_AMONTMUL_P384_EXEC = ARM_MK_EXEC_RULE bignum_amontmul_p384_mc;;
...
let BIGNUM_AMONTMUL_P384_CORRECT = time prove
 (`!z x y a b pc.
        ...
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) bignum_amontmul_p384_mc /\
  ...
  ***)
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P384_EXEC
  ...
  montred_tac BIGNUM_AMONTMUL_P384_EXEC
  ...
  montred_subst_tac BIGNUM_AMONTMUL_P384_EXEC
   `[X16;X15;X1;X20;X19;X17;X16; X21;X22;X23]` 83 THEN
  montred_subst_tac BIGNUM_AMONTMUL_P384_EXEC
   `[X17;X16;X15;X1;X20;X19;X17; X21;X22;X23]` 98 THEN

  ARM_STEPS_TAC BIGNUM_AMONTMUL_P384_EXEC (114--116) THEN
  SUBGOAL_THEN
   `2 EXP 192 *
    bignum_of_wordlist
  ...
  ***)
  ...
  ARM_STEPS_TAC BIGNUM_AMONTMUL_P384_EXEC [201] THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P384_EXEC (202--214) (202--214) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P384_EXEC (349--352) (349--352) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_AMONTMUL_P384_EXEC (357--362) (353--362) THEN
  SUBGOAL_THEN
  ...
  ARM_STEPS_TAC BIGNUM_AMONTMUL_P384_EXEC [363] THEN
