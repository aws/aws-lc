...
(**** print_literal_from_elf "Arm/bignum_sub_p256.o";;
 ****)

let bignum_sub_p256_mc = define_assert_from_elf "bignum_sub_p256_mc" "Arm/bignum_sub_p256.o"
[
...
let BIGNUM_SUB_P256_CORRECT = time prove
 (`!z x y m n pc.
  ...
  ARM_ACCSTEPS_TAC BIGNUM_SUB_P256_EXEC (10--19) (10--19) THEN
