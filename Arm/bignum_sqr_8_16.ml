...
(**** print_literal_from_elf "Arm/bignum_sqr_8_16.o";;
 ****)

let bignum_sqr_8_16_mc = define_assert_from_elf "bignum_sqr_8_16_mc" "Arm/bignum_sqr_8_16.o"
[
...
let BIGNUM_SQR_8_16_CORRECT = prove
 (`!z x a pc.
  ...
  ARM_ACCSTEPS_TAC BIGNUM_SQR_8_16_EXEC
  ...
  ARM_ACCSTEPS_TAC BIGNUM_SQR_8_16_EXEC (258--290) (258--290) THEN
