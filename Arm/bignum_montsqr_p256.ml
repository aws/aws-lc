...
(**** print_literal_from_elf "Arm/bignum_montsqr_p256.o";;
 ****)

let bignum_montsqr_p256_mc =
  define_assert_from_elf "bignum_montsqr_p256_mc" "Arm/bignum_montsqr_p256.o"
[
  ...
  0xfa1f015f;       (* arm_SBCS XZR X10 XZR *)
...
let BIGNUM_MONTSQR_P256_CORRECT = time prove
 (`!z x a pc.
  ...
  ASM_CASES_TAC `a EXP 2 <= 2 EXP 256 * p_256` THENL
   [ASM_REWRITE_TAC[]; ARM_SIM_TAC BIGNUM_MONTSQR_P256_EXEC (1--117)] THEN
