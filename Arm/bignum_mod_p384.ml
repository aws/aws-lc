...
(**** print_literal_from_elf "Arm/bignum_mod_p384.o";;
 ****)

let bignum_mod_p384_mc =
  define_assert_from_elf "bignum_mod_p384_mc" "Arm/bignum_mod_p384.o"
[
 ...
 (`!z k x n pc.
  ...
  ANTS_TAC THENL
   [UNDISCH_TAC
    ...
    EXPAND_TAC "m" THEN
    REWRITE_TAC[ARITH_RULE `384 = 64 + 64 + 64 + 64 + 64 + 64`] THEN
    REWRITE_TAC[BIGNUM_OF_WORDLIST_DIV; GSYM DIV_DIV; EXP_ADD] THEN
    REWRITE_TAC[COND_SWAP; BIGNUM_OF_WORDLIST_SING] THEN
   ...
   [MATCH_MP_TAC MASK_AND_VALUE_FROM_CARRY_LT THEN
    ...
    SUBST_ALL_TAC THENL
     [FIRST_ASSUM(MP_TAC o MATCH_MP (ARITH_RULE
      ...
      REWRITE_TAC[ARITH_RULE `384 = 64 + 64 + 64 + 64 + 64 + 64`] THEN
      REWRITE_TAC[BIGNUM_OF_WORDLIST_DIV; GSYM DIV_DIV; EXP_ADD] THEN
      REWRITE_TAC[VAL_BOUND_64; BIGNUM_OF_WORDLIST_SING] THEN
