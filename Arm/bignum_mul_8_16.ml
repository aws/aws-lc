...
(**** print_literal_from_elf "Arm/bignum_mul_8_16.o";;
 ****)

let bignum_mul_8_16_mc = define_assert_from_elf "bignum_mul_8_16_mc" "Arm/bignum_mul_8_16.o"
[
...
let BIGNUM_MUL_8_16_CORRECT = prove
 (`!z x y a b pc.
  ...
  ARM_ACCSTEPS_TAC BIGNUM_MUL_8_16_EXEC
