...
(**** print_literal_from_elf "Arm/bignum_le.o";;
 ****)

let bignum_le_mc = define_assert_from_elf "bignum_le_mc" "Arm/bignum_le.o"
[
...
let BIGNUM_LE_CORRECT = prove
 (`!m a x n b y pc.
  ...
  REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; BIGNUM_LE_EXEC] THEN
    ...
    CONJ_TAC THENL
     [ASM_CASES_TAC `m = 0` THENL
       [UNDISCH_THEN `m = 0` SUBST_ALL_TAC THEN
        ...
        ENSURES_INIT_TAC "s0" THEN ARM_STEPS_TAC BIGNUM_LE_EXEC (1--4) THEN
      ...
      ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
       [REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES; SUB_0] THEN
        ...
        ENSURES_INIT_TAC "s0" THEN ARM_STEPS_TAC BIGNUM_LE_EXEC [1] THEN
        ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
        VAL_INT64_TAC `m - i:num` THEN ASM_REWRITE_TAC[SUB_EQ_0; NOT_LE];
        ARM_SIM_TAC BIGNUM_LE_EXEC [1]] THEN
      ...
      ASSUME_TAC THENL
       [MAP_EVERY EXPAND_TAC ["y"; "x"] THEN
        ...
        ALL_TAC] THEN
      ARM_STEPS_TAC BIGNUM_LE_EXEC (1--5) THEN
      ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
      ...
      ASM_CASES_TAC `n:num = m` THENL
       [UNDISCH_THEN `n:num = m` SUBST_ALL_TAC THEN
        ...
        ENSURES_INIT_TAC "s0" THEN ARM_STEPS_TAC BIGNUM_LE_EXEC (1--2) THEN
      ...
      ASSUME_TAC THENL
       [EXPAND_TAC "y" THEN
        ...
        ASM_REWRITE_TAC[WORD_VAL];
        ALL_TAC] THEN
      ARM_STEPS_TAC BIGNUM_LE_EXEC (1--4) THEN
      ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    ...
    CONJ_TAC THENL
     [ASM_CASES_TAC `n = 0` THENL
       [UNDISCH_THEN `n = 0` SUBST_ALL_TAC THEN
        ASM_REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES; SUB_0] THEN
        ENSURES_INIT_TAC "s0" THEN ARM_STEPS_TAC BIGNUM_LE_EXEC (1--5) THEN
        ENSURES_FINAL_STATE_TAC THEN
      ...
      ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
       [REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES; SUB_0] THEN
        ...
        ENSURES_INIT_TAC "s0" THEN ARM_STEPS_TAC BIGNUM_LE_EXEC (1--6) THEN
