...
extern void curve25519_pxscalarmul(uint64_t res[8],uint64_t point[4],uint64_t scalar[4]);
extern void curve25519_pxscalarmul_alt(uint64_t res[8],uint64_t point[4],uint64_t scalar[4]);
