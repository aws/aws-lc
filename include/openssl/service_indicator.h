...
enum FIPSStatus { AWSLC_NOT_APPROVED = 0, AWSLC_APPROVED = 1 };

#if defined(AWSLC_FIPS)

#define AWSLC_MODE_STRING "AWS-LC FIPS "

// CALL_SERVICE_AND_CHECK_APPROVED performs an approval check and runs the
// service. The |approved| value passed in will change to |AWSLC_APPROVED| and
