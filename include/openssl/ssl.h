...
// is never invoked. These functions are provided only for API compatibility.
...
// This is a no-op provided for OpenSSL compatibility.
OPENSSL_EXPORT void SSL_CTX_set_security_callback(
