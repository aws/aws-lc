...
// Code generated by ./peg/peg aws-lc/util/fipstools/delocate/delocate.peg DO NOT EDIT.
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l776:
				...
				add(ruleARMGOTLow12, position767)
			}
			return true
		l766:
		...
		func() bool {
			position778, tokenIndex778 := position, tokenIndex
			{
				...
				position++
				add(ruleARMPostincrement, position779)
			}
			return true
		l778:
		...
		func() bool {
			...
			l787:
				...
				position++
				add(ruleBaseIndexScale, position781)
			}
			return true
		l780:
		...
		func() bool {
			...
			l845:
				...
				position++
				add(ruleSegmentRegister, position844)
			}
			return true
		l843:
