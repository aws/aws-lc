	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l780:
				...
				add(ruleARMGOTLow12, position771)
			}
			return true
		l770:
		...
		func() bool {
			position782, tokenIndex782 := position, tokenIndex
			{
				...
				position++
				add(ruleARMPostincrement, position783)
			}
			return true
		l782:
		...
		func() bool {
			...
			l791:
				...
				position++
				add(ruleBaseIndexScale, position785)
			}
			return true
		l784:
		...
		func() bool {
			...
			l849:
				...
				position++
				add(ruleSegmentRegister, position848)
			}
			return true
		l847:
