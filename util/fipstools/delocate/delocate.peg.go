...
func (p *Asm) Init(options ...func(*Asm) error) error {
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l720:
				add(ruleARMVectorRegister, position714)
			}
			return true
		l713:
		...
		func() bool {
			...
			l768:
				add(ruleLow12BitsSymbolRef, position760)
			}
			return true
		l759:
		...
		func() bool {
			...
			l803:
				add(ruleARMBaseIndexScale, position770)
			}
			return true
		l769:
		...
		func() bool {
			...
			l814:
				...
				add(ruleARMGOTLow12, position805)
			}
			return true
		l804:
		...
		func() bool {
			position816, tokenIndex816 := position, tokenIndex
			{
				...
				position++
				add(ruleARMPostincrement, position817)
			}
			return true
		l816:
		...
		func() bool {
			...
			l825:
				...
				position++
				add(ruleBaseIndexScale, position819)
			}
			return true
		l818:
		...
		func() bool {
			...
			l840:
				add(ruleOffsetOperator, position839)
			}
			return true
		l838:
		...
		func() bool {
			...
			l910:
				...
				position++
				add(ruleSegmentRegister, position909)
			}
			return true
		l908:
