	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l782:
				...
				add(ruleARMGOTLow12, position773)
			}
			return true
		l772:
		...
		func() bool {
			position784, tokenIndex784 := position, tokenIndex
			{
				...
				position++
				add(ruleARMPostincrement, position785)
			}
			return true
		l784:
		...
		func() bool {
			...
			l793:
				...
				position++
				add(ruleBaseIndexScale, position787)
			}
			return true
		l786:
		...
		func() bool {
			...
			l851:
				...
				position++
				add(ruleSegmentRegister, position850)
			}
			return true
		l849:
