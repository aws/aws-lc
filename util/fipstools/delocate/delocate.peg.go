...
// Code generated by /Users/shanggu/Desktop/bssl/peg/peg delocate.peg DO NOT EDIT.
...
func (p *Asm) Init(options ...func(*Asm) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 40 ARMConstantTweak <- <(((('l' / 'L') ('s' / 'S') ('l' / 'L')) / (('s' / 'S') ('x' / 'X') ('t' / 'T') ('w' / 'W')) / (('s' / 'S') ('x' / 'X') ('t' / 'T') ('b' / 'B')) / (('u' / 'U') ('x' / 'X') ('t' / 'T') ('w' / 'W')) / (('u' / 'U') ('x' / 'X') ('t' / 'T') ('b' / 'B')) / (('l' / 'L') ('s' / 'S') ('r' / 'R')) / (('r' / 'R') ('o' / 'O') ('r' / 'R')) / (('a' / 'A') ('s' / 'S') ('r' / 'R'))) ((WS '#'? Offset) / (WS '(' Offset WS '-' WS Offset ')'))?)> */
		func() bool {
		...
		/* 41 ARMRegister <- <((('s' / 'S') ('p' / 'P')) / (('x' / 'w' / 'd' / 'q' / 's') [0-9] [0-9]?) / (('x' / 'X') ('z' / 'Z') ('r' / 'R')) / (('w' / 'W') ('z' / 'Z') ('r' / 'R')) / ARMVectorRegister / ('{' WS? ARMVectorRegister (',' WS? ARMVectorRegister)* WS? '}' ('[' [0-9] [0-9]? ']')?) / ('{' WS? ARMVectorRegister WS? '-' WS? ARMVectorRegister WS? '}'))> */
		func() bool {
			...
			l642:
				add(ruleARMRegister, position641)
			}
			return true
		l640:
		...
		/* 46 ARMBaseIndexScale <- <('[' ARMRegister (',' WS? (('#' Offset (('*' [0-9]+) / ('*' '(' [0-9]+ Operator [0-9]+ ')') / ('+' [0-9]+)*)?) / ('#'? ARMGOTLow12) / ('#'? Low12BitsSymbolRef) / ARMRegister / Offset) (',' WS? ARMConstantTweak)?)? ']' ARMPostincrement?)> */
		func() bool {
		...
		func() bool {
			...
			l794:
				...
				add(ruleARMGOTLow12, position785)
			}
			return true
		l784:
		...
		func() bool {
			position796, tokenIndex796 := position, tokenIndex
			{
				...
				position++
				add(ruleARMPostincrement, position797)
			}
			return true
		l796:
		...
		func() bool {
			...
			l805:
				...
				position++
				add(ruleBaseIndexScale, position799)
			}
			return true
		l798:
		...
		func() bool {
			...
			l863:
				...
				position++
				add(ruleSegmentRegister, position862)
			}
			return true
		l861:
