...
func NewWithIO(cmd *exec.Cmd, in io.WriteCloser, out io.ReadCloser) *Subprocess {
	...
	m.primitives = map[string]primitive{
		...
		"ACVP-AES-CFB1":      &blockCipher{"AES-CFB1", 16, 100, true, true, iterateAESCBC},
		"ACVP-AES-CFB8":      &blockCipher{"AES-CFB8", 16, 100, true, true, iterateAESCBC},
		"ACVP-AES-CFB128":    &blockCipher{"AES-CFB128", 16, 100, true, true, iterateAESCBC},
