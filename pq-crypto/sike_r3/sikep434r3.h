...
#elif defined(_WIN32) || defined(_X86_) || defined(_ARM_) || defined(__arm__) || defined(__i386__)
...
#define SIKE_P434_R3_MAXBITS_FIELD   448
// Number of 64-bit words of a 434-bit field element
#define SIKE_P434_R3_NWORDS64_FIELD  ((SIKE_P434_R3_NBITS_FIELD+63)/64)
#define SIKE_P434_R3_NBITS_ORDER     256
// Number of words of oA and oB, where oA and oB are the subgroup orders of Alice and Bob, resp.
#define SIKE_P434_R3_NWORDS_ORDER    ((SIKE_P434_R3_NBITS_ORDER+SIKE_P434_R3_RADIX-1)/SIKE_P434_R3_RADIX)
#define SIKE_P434_R3_ALICE           0
#define SIKE_P434_R3_BOB             1
#define SIKE_P434_R3_OALICE_BITS     216
#define SIKE_P434_R3_OBOB_BITS       218
#define SIKE_P434_R3_MASK_ALICE      0xFF
#define SIKE_P434_R3_MASK_BOB        0x01

// Fixed parameters for isogeny tree computation
#define SIKE_P434_R3_MAX_INT_POINTS_ALICE    7
#define SIKE_P434_R3_MAX_INT_POINTS_BOB      8
#define SIKE_P434_R3_MAX_ALICE               108
#define SIKE_P434_R3_MAX_BOB                 137
#define SIKE_P434_R3_MSG_BYTES               16
#define SIKE_P434_R3_SECRETKEY_A_BYTES       ((SIKE_P434_R3_OALICE_BITS + 7) / 8)
#define SIKE_P434_R3_SECRETKEY_B_BYTES       ((SIKE_P434_R3_OBOB_BITS - 1 + 7) / 8)
#define SIKE_P434_R3_FP2_ENCODED_BYTES       (2 * ((SIKE_P434_R3_NBITS_FIELD + 7) / 8))

// SIDH's basic element definitions and point representations S
...
#define SIKE_P434_R3_UNREFERENCED_PARAMETER(PAR) ((void)(PAR))
...
{
    return (unsigned int)((x | (0-x)) >> (SIKE_P434_R3_RADIX-1));
}
...
{
    return (unsigned int)((x ^ ((x ^ y) | ((x - y) ^ y))) >> (SIKE_P434_R3_RADIX-1));
}
...
#define SIKE_P434_R3_ADDC(carryIn, addend1, addend2, carryOut, sumOut)                        \
    { digit_t tempReg = (addend1) + (digit_t)(carryIn);                                           \
    (sumOut) = (addend2) + tempReg;                                                               \
    (carryOut) = (is_digit_lessthan_ct(tempReg, (digit_t)(carryIn)) | is_digit_lessthan_ct((sumOut), tempReg)); }

// Digit subtraction with borrow
#define SIKE_P434_R3_SUBC(borrowIn, minuend, subtrahend, borrowOut, differenceOut)            \
...
#define SIKE_P434_R3_SHIFTR(highIn, lowIn, shift, shiftOut, DigitSize)                        \
