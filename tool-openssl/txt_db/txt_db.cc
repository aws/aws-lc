...
TXT_DB *TXT_DB_read(BIO *in, int num) {
  ...
  if ((ret->data = sk_OPENSSL_PSTRING_new_null()) == NULL ||
      (ret->index = (LHASH_OF(OPENSSL_STRING) **)OPENSSL_malloc(
           sizeof(LHASH_OF(OPENSSL_STRING) *) * num)) == NULL ||
      (ret->qual = (int (**)(OPENSSL_STRING *))OPENSSL_malloc(
           sizeof(int (*)(OPENSSL_STRING *)) * num)) == NULL) {
    goto err;
  }
