...
; in the window [rax; r15;r14;r13;r12]

        add     r14, r9
        adc     r15, 0
        adc     rax, 0

; Load non-trivial digits of p_256 = [v; 0; u; -1] masked using rax.
