...
let BIGNUM_MONTMUL_P521_ALT_EXEC = X86_MK_EXEC_RULE bignum_montmul_p521_alt_mc;;
...
let BIGNUM_MONTMUL_P521_ALT_CORRECT = prove
 (`!z x y a b pc.
        ALL (nonoverlapping (z,8 * 9)) [(word pc,0x6c9); (x,8 * 9); (y,8 * 9)]
        ==> ensures x86
