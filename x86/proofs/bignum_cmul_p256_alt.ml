...
let BIGNUM_CMUL_P256_ALT_EXEC = X86_MK_CORE_EXEC_RULE bignum_cmul_p256_alt_mc;;
...
let BIGNUM_CMUL_P256_ALT_CORRECT = time prove
 (`!z c x a pc.
        ...
        ==> ensures x86
             (\s. bytes_loaded s (word pc) (BUTLAST bignum_cmul_p256_alt_mc) /\
                  read RIP s = word pc /\
                  C_ARGUMENTS [z; c; x] s /\
 ...
 (`!z c x a pc stackpointer returnaddress.
        ...
        ==> ensures x86
             ...
             (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
              MAYCHANGE [memory :> bytes(z,8 * 4)])`,
  X86_PROMOTE_RETURN_NOSTACK_TAC bignum_cmul_p256_alt_mc
...
let windows_bignum_cmul_p256_alt_mc = define_from_elf
   "windows_bignum_cmul_p256_alt_mc" "x86/p256/bignum_cmul_p256_alt.obj";;
...
let WINDOWS_BIGNUM_CMUL_P256_ALT_SUBROUTINE_CORRECT = time prove
 (`!z c x a pc stackpointer returnaddress.
  ...
  WINDOWS_X86_WRAP_NOSTACK_TAC windows_bignum_cmul_p256_alt_mc
    bignum_cmul_p256_alt_mc BIGNUM_CMUL_P256_ALT_CORRECT);;
