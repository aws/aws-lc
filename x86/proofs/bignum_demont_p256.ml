...
let BIGNUM_DEMONT_P256_CORRECT = time prove
 (`!z x a pc.
        ...
        ==> ensures x86
             (\s. bytes_loaded s (word pc) (BUTLAST bignum_demont_p256_mc) /\
...
let BIGNUM_DEMONT_P256_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  X86_PROMOTE_RETURN_STACK_TAC
    bignum_demont_p256_mc BIGNUM_DEMONT_P256_CORRECT `[RBX]` 8);;
...
let WINDOWS_BIGNUM_DEMONT_P256_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  WINDOWS_X86_WRAP_STACK_TAC
    windows_bignum_demont_p256_mc bignum_demont_p256_mc
