...
let BIGNUM_OPTNEG_SM2_EXEC = X86_MK_CORE_EXEC_RULE bignum_optneg_sm2_mc;;
...
let BIGNUM_OPTNEG_SM2_CORRECT = time prove
 (`!z q x n pc.
        ...
        ==> ensures x86
             (\s. bytes_loaded s (word pc) (BUTLAST bignum_optneg_sm2_mc) /\
                  read RIP s = word pc /\
                  C_ARGUMENTS [z; q; x] s /\
 ...
 (`!z q x n pc stackpointer returnaddress.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE [memory :> bignum(z,4)])`,
  X86_PROMOTE_RETURN_NOSTACK_TAC bignum_optneg_sm2_mc
...
let windows_bignum_optneg_sm2_mc = define_from_elf
   "windows_bignum_optneg_sm2_mc" "x86/sm2/bignum_optneg_sm2.obj";;
...
let WINDOWS_BIGNUM_OPTNEG_SM2_SUBROUTINE_CORRECT = time prove
 (`!z q x n pc stackpointer returnaddress.
  ...
  WINDOWS_X86_WRAP_NOSTACK_TAC
    windows_bignum_optneg_sm2_mc bignum_optneg_sm2_mc
    BIGNUM_OPTNEG_SM2_CORRECT);;
