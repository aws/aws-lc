...
let curve25519_x25519base_alt_mc,curve25519_x25519base_alt_data =
  ...
  "curve25519_x25519base_alt_mc" "curve25519_x25519base_alt_data"
...
[
  ...
  0x4c; 0x8d; 0x15; 0x07; 0x21; 0x00; 0x00;
                           (* LEA (% r10) (Riprel (word 8455)) *)
  0x4c; 0x8d; 0x1d; 0x60; 0x21; 0x00; 0x00;
                           (* LEA (% r11) (Riprel (word 8544)) *)
  ...
  0x48; 0x8d; 0x05; 0x95; 0x20; 0x00; 0x00;
                           (* LEA (% rax) (Riprel (word 8341)) *)
  ...
  0x48; 0x03; 0x84; 0x24; 0x80; 0x00; 0x00; 0x00;
                           (* ADD (% rax) (Memop Quadword (%% (rsp,128))) *)
  ...
  0x48; 0x13; 0x84; 0x24; 0x88; 0x00; 0x00; 0x00;
                           (* ADC (% rax) (Memop Quadword (%% (rsp,136))) *)
  ...
  0x48; 0x13; 0x84; 0x24; 0x90; 0x00; 0x00; 0x00;
                           (* ADC (% rax) (Memop Quadword (%% (rsp,144))) *)
  ...
  0x0f; 0x82; 0xec; 0xe8; 0xff; 0xff;
                           (* JB (Imm32 (word 4294961388)) *)
  0x48; 0x8b; 0x84; 0x24; 0x80; 0x00; 0x00; 0x00;
                           (* MOV (% rax) (Memop Quadword (%% (rsp,128))) *)
  0x48; 0x03; 0x84; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* ADD (% rax) (Memop Quadword (%% (rsp,224))) *)
  0x48; 0x89; 0x84; 0x24; 0xa0; 0x00; 0x00; 0x00;
                           (* MOV (Memop Quadword (%% (rsp,160))) (% rax) *)
  0x48; 0x8b; 0x84; 0x24; 0x88; 0x00; 0x00; 0x00;
                           (* MOV (% rax) (Memop Quadword (%% (rsp,136))) *)
  0x48; 0x13; 0x84; 0x24; 0xe8; 0x00; 0x00; 0x00;
                           (* ADC (% rax) (Memop Quadword (%% (rsp,232))) *)
  0x48; 0x89; 0x84; 0x24; 0xa8; 0x00; 0x00; 0x00;
                           (* MOV (Memop Quadword (%% (rsp,168))) (% rax) *)
  0x48; 0x8b; 0x84; 0x24; 0x90; 0x00; 0x00; 0x00;
                           (* MOV (% rax) (Memop Quadword (%% (rsp,144))) *)
  0x48; 0x13; 0x84; 0x24; 0xf0; 0x00; 0x00; 0x00;
                           (* ADC (% rax) (Memop Quadword (%% (rsp,240))) *)
  0x48; 0x89; 0x84; 0x24; 0xb0; 0x00; 0x00; 0x00;
                           (* MOV (Memop Quadword (%% (rsp,176))) (% rax) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xc0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,192)) *)
  0x48; 0x8d; 0x0d; 0x9a; 0x07; 0x00; 0x00;
                           (* LEA (% rcx) (Riprel (word 1946)) *)
...
let CURVE25519_X25519BASE_ALT_EXEC =
  X86_MK_EXEC_RULE curve25519_x25519base_alt_mc;;
...
let BYTES_LOADED_DATA = prove
 (`bytes_loaded s (word (pc + 8507)) curve25519_x25519base_alt_data <=>
   read (memory :> bytes(word (pc + 8507),48608)) s =
...
let X25519BASE_TABLE_LEMMA = prove
 (`read (memory :> bytes(word (pc + 8507),48608)) s =
   num_of_bytelist curve25519_x25519base_alt_data
   ==> bignum_from_memory(word(pc + 0x213b),4) s = p_25519 /\
       edwards25519_exprojective
        (group_pow edwards25519_group E_25519 (2 EXP 254))
        (bignum_from_memory(word(pc + 0x215b),4) s,
         bignum_from_memory(word(pc + 0x217b),4) s,
         1,
         bignum_from_memory(word(pc + 0x219b),4) s) /\
       edwards25519_exprojective
        (group_pow edwards25519_group E_25519 (2 EXP 254 + 8))
        (bignum_from_memory(word(pc + 0x21bb),4) s,
         bignum_from_memory(word(pc + 0x21db),4) s,
         1,
         bignum_from_memory(word(pc + 0x21fb),4) s) /\
       !i. i < 63
           ==> !j. j < 8
                   ==> edwards25519_epprojective
                        (group_pow edwards25519_group E_25519
                           (2 EXP (4 * (i + 1)) * (j + 1)))
         (bignum_from_memory(word(pc + 0x221b + 768 * i + 96 * j),4) s,
          bignum_from_memory(word(pc + 0x221b + 768 * i + 96 * j + 32),4) s,
          bignum_from_memory(word(pc + 0x221b + 768 * i + 96 * j + 64),4) s) /\
         ~(bignum_from_memory(word(pc + 0x221b + 768 * i + 96 * j + 64),4) s =
           0)`,
  let GE25519_POWERS =
    end_itlist CONJ
...
let LOCAL_MUL_P25519_TAC =
  X86_MACRO_SIM_ABBREV_TAC curve25519_x25519base_alt_mc 129 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      ...
      ==>
      nonoverlapping (word pc,0xdf1b) (word_add (read p3 t) (word n3),8 * 4)
      ==> ensures x86
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (2--84) (2--84) THEN
  ...
  MAP_EVERY (fun n ->
    X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC [n] THEN
  ...
  X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (110--114) THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC
...
let LOCAL_MUL_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC curve25519_x25519base_alt_mc 120 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      ...
      ==>
      nonoverlapping (word pc,0xdf1b) (word_add (read q3 t) (word n3),8 * 4)
      ==> ensures x86
           (\s. bytes_loaded s (word pc) curve25519_x25519base_alt_mc /\
                read RIP s = pcin /\
                read RSP s = read RSP t /\
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (110--113) THEN
  ABBREV_TAC `hw:int64 = word_subword
    ((word_join:int64->int64->int128) sum_s109 sum_s107) (63,64)` THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (114--117) (114--121) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let LOCAL_ADD_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC curve25519_x25519base_alt_mc 12 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      !m. read(memory :> bytes(word_add (read q1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read q2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC [2;5;8;11] (1--12) THEN
...
let LOCAL_SUB_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC curve25519_x25519base_alt_mc 17 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      !m. read(memory :> bytes(word_add (read q1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read q2 t) (word n2),8 * 4)) t = n
...
let LOCAL_ADD_TWICE4_TAC =
  X86_MACRO_SIM_ABBREV_TAC curve25519_x25519base_alt_mc 19 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      !m. read(memory :> bytes(word_add (read q1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read q2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC [3;5;7;9] (1--11) THEN
  SUBGOAL_THEN `carry_s9 <=> 2 EXP 256 <= m + n` SUBST_ALL_TAC THENL
   [MATCH_MP_TAC FLAG_FROM_CARRY_LE THEN EXISTS_TAC `256` THEN
    ...
    ALL_TAC] THEN
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (12--15) (12--19) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN DISCH_TAC THEN
...
let LOCAL_SUB_TWICE4_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (1--10) (1--10) THEN
  SUBGOAL_THEN `carry_s10 <=> m < n` SUBST_ALL_TAC THENL
   [MATCH_MP_TAC FLAG_FROM_CARRY_LT THEN EXISTS_TAC `256` THEN
    ...
    DISCH_THEN(fun th -> REWRITE_TAC[th]) THEN BOUNDER_TAC[];
    ALL_TAC] THEN
  X86_ACCSTEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (12--15) (11--19) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN DISCH_TAC THEN
  MATCH_MP_TAC(MESON[INT_OF_NUM_LT]
   `!x':int. (x' == a) (mod p) /\ x' < &e /\ &x = x'
             ==> x < e /\ (&x:int == a) (mod p)`) THEN
...
let LOCAL_MODINV_TAC =
  ...
  X86_SUBROUTINE_SIM_TAC(bth,CURVE25519_X25519BASE_ALT_EXEC,0x19a9,cth,th)
...
let CURVE25519_X25519BASE_ALT_CORRECT = time prove
 (`!res scalar n pc stackpointer.
    ALL (nonoverlapping (stackpointer,488))
        [(word pc,0xdf1b); (res,32); (scalar,32)] /\
    nonoverlapping (res,32) (word pc,0xdf1b)
    ==> ensures x86
  ...
  REWRITE_TAC[CONJUNCT1 CURVE25519_X25519BASE_ALT_EXEC] THEN
  ...
  ENSURES_WHILE_AUP_TAC `1` `64` `pc + 0x19a` `pc + 0x189c`
   `\i s.
      read (memory :> bytes(word(pc + 8507),48608)) s =
      num_of_bytelist curve25519_x25519base_alt_data /\
      read RSP s = stackpointer /\
   ...
   [ARITH_TAC;
    ...
    SUBGOAL_THEN
     `nonoverlapping_modulo (2 EXP 64) (val(stackpointer:int64),488)
                                       (val(wpc:int64),0xdf1b)`
    ASSUME_TAC THENL
     [EXPAND_TAC "wpc" THEN NONOVERLAPPING_TAC; ALL_TAC] THEN
    REPEAT(DISCH_THEN(CONJUNCTS_THEN2 ASSUME_TAC MP_TAC)) THEN
    DISCH_THEN(K ALL_TAC) THEN
    BIGNUM_LDIGITIZE_TAC "x0_"
      `bignum_from_memory(word_add wpc (word 8539),4) s0` THEN
    BIGNUM_LDIGITIZE_TAC "y0_"
      `bignum_from_memory(word_add wpc (word 8571),4) s0` THEN
    BIGNUM_LDIGITIZE_TAC "t0_"
      `bignum_from_memory(word_add wpc (word 8603),4) s0` THEN
    BIGNUM_LDIGITIZE_TAC "x1_"
      `bignum_from_memory(word_add wpc (word 8635),4) s0` THEN
    BIGNUM_LDIGITIZE_TAC "y1_"
      `bignum_from_memory(word_add wpc (word 8667),4) s0` THEN
    BIGNUM_LDIGITIZE_TAC "t1_"
      `bignum_from_memory(word_add wpc (word 8699),4) s0` THEN
    ...
    X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (15--72) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV) THEN
    ASM_REWRITE_TAC[] THEN
    ...
    X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (1--8) THEN
    ...
    X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (9--17) THEN
    ...
    ABBREV_TAC `tab:int64 = word(pc + 0x221b + 768 * (i - 1))` THEN
    ...
    X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC (18--239) THEN
    ...
    X86_STEPS_TAC CURVE25519_X25519BASE_ALT_EXEC [296] THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    ...
    X86_SIM_TAC CURVE25519_X25519BASE_ALT_EXEC (1--2) THEN
...
let WINDOWS_CURVE25519_X25519BASE_ALT_SUBROUTINE_CORRECT = time prove
 (`!res scalar n pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 560),560))
        [(word pc,0xdf2b); (scalar,32)] /\
    nonoverlapping (res,32) (word pc,0xdf2b) /\
  ...
  let WINDOWS_CURVE25519_X25519BASE_ALT_EXEC =
    X86_MK_EXEC_RULE windows_curve25519_x25519base_alt_mc in
  let subth =
   REWRITE_RULE[BYTES_LOADED_APPEND_CLAUSE; BYTES_LOADED_DATA;
                CONJUNCT1 CURVE25519_X25519BASE_ALT_EXEC]
             CURVE25519_X25519BASE_ALT_SUBROUTINE_CORRECT in
  ...
  REWRITE_TAC[BYTES_LOADED_APPEND_CLAUSE] THEN
  REWRITE_TAC[CONJUNCT1 WINDOWS_CURVE25519_X25519BASE_ALT_EXEC] THEN
  GEN_REWRITE_TAC
  ...
  REWRITE_TAC[READ_BYTELIST_EQ_BYTES; CONV_RULE (RAND_CONV LENGTH_CONV)
     (AP_TERM `LENGTH:byte list->num`
      windows_curve25519_x25519base_alt_data)] THEN
  REWRITE_TAC[windows_curve25519_x25519base_alt_data] THEN
  REWRITE_TAC[GSYM curve25519_x25519base_alt_data] THEN
  ...
  RULE_ASSUM_TAC(REWRITE_RULE[ARITH_RULE `pc + 8523 = (pc + 16) + 8507`]) THEN
  X86_SUBROUTINE_SIM_TAC
    (windows_curve25519_x25519base_alt_mc,
     WINDOWS_CURVE25519_X25519BASE_ALT_EXEC,
     0x10,curve25519_x25519base_alt_mc,subth)
