...
[
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xc0; 0x01; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,448)) *)
  0xe8; 0x02; 0x1e; 0x00; 0x00;
                           (* CALL (Imm32 (word 7682)) *)
  ...
  0x48; 0x8d; 0xac; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* LEA (% rbp) (%% (rsp,576)) *)
  0xe8; 0x6f; 0x3a; 0x00; 0x00;
                           (* CALL (Imm32 (word 14959)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x40; 0x03; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,832)) *)
  0x48; 0x8d; 0xb4; 0x24; 0x40; 0x02; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,576)) *)
  0xe8; 0xd0; 0x1d; 0x00; 0x00;
                           (* CALL (Imm32 (word 7632)) *)
  ...
  0x48; 0x8d; 0xac; 0x24; 0x40; 0x03; 0x00; 0x00;
                           (* LEA (% rbp) (%% (rsp,832)) *)
  0xe8; 0x3d; 0x3a; 0x00; 0x00;
                           (* CALL (Imm32 (word 14909)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x40; 0x04; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,1088)) *)
  0x48; 0x8d; 0xb4; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,704)) *)
  0xe8; 0x9e; 0x1d; 0x00; 0x00;
                           (* CALL (Imm32 (word 7582)) *)
  ...
  0x48; 0x8d; 0xac; 0x24; 0x40; 0x04; 0x00; 0x00;
                           (* LEA (% rbp) (%% (rsp,1088)) *)
  0xe8; 0x0b; 0x3a; 0x00; 0x00;
                           (* CALL (Imm32 (word 14859)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x40; 0x05; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,1344)) *)
  0x48; 0x8d; 0xb4; 0x24; 0x40; 0x03; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,832)) *)
  0xe8; 0x6c; 0x1d; 0x00; 0x00;
                           (* CALL (Imm32 (word 7532)) *)
  ...
  0x48; 0x8d; 0x2d; 0x61; 0x5c; 0x00; 0x00;
                           (* LEA (% rbp) (Riprel (word 23649)) *)
  ...
  0x48; 0x8d; 0xac; 0x24; 0x60; 0x01; 0x00; 0x00;
                           (* LEA (% rbp) (%% (rsp,352)) *)
  0xe8; 0xee; 0x43; 0x00; 0x00;
                           (* CALL (Imm32 (word 17390)) *)
  ...
  0x48; 0x8d; 0x74; 0x24; 0x60;
                           (* LEA (% rsi) (%% (rsp,96)) *)
  0xe8; 0xf0; 0x22; 0x00; 0x00;
                           (* CALL (Imm32 (word 8944)) *)
  0x48; 0x8b; 0x44; 0x24; 0x50;
                           (* MOV (% rax) (Memop Quadword (%% (rsp,80))) *)
  ...
  0x45; 0x31; 0xf6;        (* XOR (% r14d) (% r14d) *)
  0x45; 0x31; 0xff;        (* XOR (% r15d) (% r15d) *)
  0x48; 0x8d; 0x2d; 0x94; 0x52; 0x00; 0x00;
                           (* LEA (% rbp) (Riprel (word 21140)) *)
  0x48; 0x83; 0x7c; 0x24; 0x40; 0x01;
                           (* CMP (Memop Quadword (%% (rsp,64))) (Imm8 (word 1)) *)
  0x48; 0x8b; 0x75; 0x00;  (* MOV (% rsi) (Memop Quadword (%% (rbp,0))) *)
  0x48; 0x0f; 0x44; 0xc6;  (* CMOVE (% rax) (% rsi) *)
  ...
  0x48; 0x8d; 0x74; 0x24; 0x60;
                           (* LEA (% rsi) (%% (rsp,96)) *)
  0xe8; 0x99; 0x18; 0x00; 0x00;
                           (* CALL (Imm32 (word 6297)) *)
  ...
  0x48; 0x8d; 0xac; 0x24; 0x60; 0x01; 0x00; 0x00;
                           (* LEA (% rbp) (%% (rsp,352)) *)
  0xe8; 0x5d; 0x39; 0x00; 0x00;
                           (* CALL (Imm32 (word 14685)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x60;
                           (* LEA (% rdi) (%% (rsp,96)) *)
  0x48; 0x8d; 0x74; 0x24; 0x60;
                           (* LEA (% rsi) (%% (rsp,96)) *)
  0xe8; 0x6d; 0x18; 0x00; 0x00;
                           (* CALL (Imm32 (word 6253)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x60;
                           (* LEA (% rdi) (%% (rsp,96)) *)
  0x48; 0x8d; 0x74; 0x24; 0x60;
                           (* LEA (% rsi) (%% (rsp,96)) *)
  0xe8; 0x22; 0x09; 0x00; 0x00;
                           (* CALL (Imm32 (word 2338)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x60;
                           (* LEA (% rdi) (%% (rsp,96)) *)
  0x48; 0x8d; 0x74; 0x24; 0x60;
                           (* LEA (% rsi) (%% (rsp,96)) *)
  0x48; 0x8d; 0xac; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rbp) (%% (rsp,224)) *)
  0xe8; 0x95; 0x25; 0x00; 0x00;
                           (* CALL (Imm32 (word 9621)) *)
  0x48; 0x8b; 0x44; 0x24; 0x50;
                           (* MOV (% rax) (Memop Quadword (%% (rsp,80))) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xa0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,160)) *)
  0x48; 0x8d; 0x0d; 0xfb; 0x47; 0x00; 0x00;
                           (* LEA (% rcx) (Riprel (word 18427)) *)
...
let BYTES_LOADED_DATA = prove
 (`bytes_loaded s (word (pc + 0x60c9)) edwards25519_scalarmuldouble_alt_data <=>
   read (memory :> bytes(word (pc + 0x60c9),800)) s =
...
let EDWARDS25519DOUBLEBASE_TABLE_LEMMA = prove
 (`read (memory :> bytes(word (pc + 0x60c9),800)) s =
   num_of_bytelist edwards25519_scalarmuldouble_alt_data
   ==> bignum_from_memory(word(pc + 0x60c9),4) s = p_25519 /\
       !i. i < 8
           ==> edwards25519_epprojective
                (group_pow edwards25519_group E_25519 (i + 1))
         (bignum_from_memory(word(pc + 0x60e9 + 96 * i),4) s,
          bignum_from_memory(word(pc + 0x60e9 + 96 * i + 32),4) s,
          bignum_from_memory(word(pc + 0x60e9 + 96 * i + 64),4) s) /\
         ~(bignum_from_memory(word(pc + 0x60e9 + 96 * i + 64),4) s =
           0)`,
  let GE25519_POWERS =
    end_itlist CONJ
    (funpow 7 (fun l -> GE25519_GROUPER GE25519_POW_1 (hd l)::l)
                          [GE25519_POW_1]) in
  REWRITE_TAC[GSYM BYTES_LOADED_DATA; edwards25519_scalarmuldouble_alt_data] THEN
...
let LOCAL_MUL_P25519_TAC =
  X86_MACRO_SIM_ABBREV_TAC edwards25519_scalarmuldouble_alt_mc 129 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      ...
      ==>
      nonoverlapping (word pc,0x63e9) (word_add (read q3 t) (word n3),8 * 4)
      ==> ensures x86
           (\s. bytes_loaded s (word pc) edwards25519_scalarmuldouble_alt_mc /\
                read RIP s = pcin /\
...
let LOCAL_MUL_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC edwards25519_scalarmuldouble_alt_mc 120 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      !m. read(memory :> bytes(word_add (read q1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read q2 t) (word n2),8 * 4)) t = n
...
let LOCAL_SQR_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC edwards25519_scalarmuldouble_alt_mc 109 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1.
      !n.
      read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = n
      ==>
      nonoverlapping (word pc,0x63e9) (word_add (read p3 t) (word n3),8 * 4)
      ==> ensures x86
           (\s. bytes_loaded s (word pc) edwards25519_scalarmuldouble_alt_mc /\
                read RIP s = pcin /\
                read RSP s = read RSP t /\
...
let LOCAL_ADD_TWICE4_TAC =
  X86_MACRO_SIM_ABBREV_TAC edwards25519_scalarmuldouble_alt_mc 19 lvs
   `!(t:x86state) pcin pcout q3 n3 q1 n1 q2 n2.
      !m. read(memory :> bytes(word_add (read q1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read q2 t) (word n2),8 * 4)) t = n
...
let LOCAL_MODINV_TAC =
  ...
  and bth = edwards25519_scalarmuldouble_alt_mc
  and th = CONV_RULE (DEPTH_CONV WORD_NUM_RED_CONV)
                     (SPEC `word 4:int64` CORE_MODINV_CORRECT) in
  X86_SUBROUTINE_SIM_TAC(bth,EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC,0x18d6,cth,th)
...
let LOCAL_EPDOUBLE_CORRECT = time prove
 (`!p3 p1 T1 pc stackpointer.
    ALL (nonoverlapping (stackpointer,160))
        [(word pc,0x63e9); (p3,128); (p1,96)] /\
    nonoverlapping (p3,128) (word pc,0x63e9)
    ==> ensures x86
         (\s. bytes_loaded s (word pc)
                 edwards25519_scalarmuldouble_alt_mc /\
              read RIP s = word(pc + 0x21b4) /\
              read RSP s = stackpointer /\
              read RDI s = p3 /\
              read RSI s = p1 /\
              bignum_triple_from_memory(p1,4) s = T1)
         (\s. read RIP s = word (pc + 0x30e1) /\
...
let LOCAL_PDOUBLE_CORRECT = time prove
 (`!p3 p1 T1 pc stackpointer.
    ALL (nonoverlapping (stackpointer,160))
        [(word pc,0x63e9); (p3,96); (p1,96)] /\
    nonoverlapping (p3,96) (word pc,0x63e9)
    ==> ensures x86
         (\s. bytes_loaded s (word pc)
                 edwards25519_scalarmuldouble_alt_mc /\
              read RIP s = word(pc + 0x30f0) /\
              read RSP s = stackpointer /\
              read RDI s = p3 /\
              read RSI s = p1 /\
              bignum_triple_from_memory(p1,4) s = T1)
         (\s. read RIP s = word (pc + 0x3e2f) /\
              !P1. P1 IN group_carrier edwards25519_group /\
                   edwards25519_projective2 P1 T1
...
let LOCAL_EPADD_CORRECT = time prove
 (`!p3 p1 Q1 p2 Q2 pc stackpointer.
    ALL (nonoverlapping (stackpointer,192))
        [(word pc,0x63e9); (p3,128); (p1,128); (p2,128)] /\
    nonoverlapping (p3,128) (word pc,0x63e9)
    ==> ensures x86
         (\s. bytes_loaded s (word pc)
                 edwards25519_scalarmuldouble_alt_mc /\
              read RIP s = word(pc + 0x3e3e) /\
              read RSP s = stackpointer /\
              read RDI s = p3 /\
              read RSI s = p1 /\
              read RBP s = p2 /\
...
let LOCAL_PEPADD_CORRECT = time prove
 (`!p3 p1 Q1 p2 T2 pc stackpointer.
    ALL (nonoverlapping (stackpointer,192))
        [(word pc,0x63e9); (p3,128); (p1,128); (p2,96)] /\
    nonoverlapping (p3,128) (word pc,0x63e9)
    ==> ensures x86
         (\s. bytes_loaded s (word pc)
                 edwards25519_scalarmuldouble_alt_mc /\
              read RIP s = word(pc + 0x51d1) /\
              read RSP s = stackpointer /\
              read RDI s = p3 /\
              read RSI s = p1 /\
              read RBP s = p2 /\
...
let EDWARDS25519_SCALARMULDOUBLE_ALT_CORRECT = time prove
 (`!res scalar point bscalar n xy m pc stackpointer.
    ALL (nonoverlapping (stackpointer,1672))
        [(word pc,0x63e9); (res,64); (scalar,32); (point,64); (bscalar,32)] /\
    nonoverlapping (res,64) (word pc,0x63e9)
    ==> ensures x86
         (\s. bytes_loaded s (word pc)
  ...
  REWRITE_TAC[CONJUNCT1 EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC] THEN
  ...
  ENSURES_WHILE_DOWN_TAC `63` `pc + 0xddc` `pc + 0x18a2`
   `\i s.
      read (memory :> bytes(word(pc + 0x60c9),800)) s =
      num_of_bytelist edwards25519_scalarmuldouble_alt_data /\
      read RSP s = word_add stackpointer (word 200) /\
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    REWRITE_TAC[ARITH_RULE `pc + 0x60e9 + x = (pc + 0x60e9) + x`] THEN
    GEN_REWRITE_TAC (LAND_CONV o ONCE_DEPTH_CONV) [WORD_ADD] THEN
    ABBREV_TAC `wpc:int64 = word(pc + 0x60e9)` THEN
    ...
    X86_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC (1--8) THEN
    RULE_ASSUM_TAC(REWRITE_RULE[WORD_RULE
...
let EDWARDS25519_SCALARMULDOUBLE_ALT_SUBROUTINE_CORRECT = time prove
 (`!res scalar point bscalar n xy m pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 1720),1720))
        [(word pc,0x63e9); (scalar,32); (point,64); (bscalar,32)] /\
    nonoverlapping (res,64) (word pc,0x63e9) /\
...
let WINDOWS_EDWARDS25519_SCALARMULDOUBLE_ALT_SUBROUTINE_CORRECT = time prove
 (`!res scalar point bscalar n xy m pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 1744),1744))
        [(word pc,0x63ff); (scalar,32); (point,64); (bscalar,32)] /\
    nonoverlapping (res,64) (word pc,0x63ff) /\
    nonoverlapping (res,64) (word_sub stackpointer (word 1744),1752)
    ==> ensures x86
         (\s. bytes_loaded s (word pc)
               (APPEND windows_edwards25519_scalarmuldouble_alt_mc
                       windows_edwards25519_scalarmuldouble_alt_data) /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
              read (memory :> bytes64 stackpointer) s = returnaddress /\
  ...
  let WINDOWS_EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC =
    X86_MK_EXEC_RULE windows_edwards25519_scalarmuldouble_alt_mc in
  let subth =
   REWRITE_RULE[BYTES_LOADED_APPEND_CLAUSE; BYTES_LOADED_DATA;
                CONJUNCT1 EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC]
             EDWARDS25519_SCALARMULDOUBLE_ALT_SUBROUTINE_CORRECT in
  ...
  REWRITE_TAC[BYTES_LOADED_APPEND_CLAUSE] THEN
  REWRITE_TAC[CONJUNCT1 WINDOWS_EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC] THEN
  GEN_REWRITE_TAC
  ...
  REWRITE_TAC[READ_BYTELIST_EQ_BYTES; CONV_RULE (RAND_CONV LENGTH_CONV)
     (AP_TERM `LENGTH:byte list->num`
      windows_edwards25519_scalarmuldouble_alt_data)] THEN
  REWRITE_TAC[windows_edwards25519_scalarmuldouble_alt_data] THEN
  ...
  RULE_ASSUM_TAC(REWRITE_RULE
   [ARITH_RULE `pc + 0x60df = (pc + 0x16) + 0x60c9`]) THEN
  X86_SUBROUTINE_SIM_TAC
    (windows_edwards25519_scalarmuldouble_alt_mc,
     WINDOWS_EDWARDS25519_SCALARMULDOUBLE_ALT_EXEC,
     0x16,edwards25519_scalarmuldouble_alt_mc,subth)
