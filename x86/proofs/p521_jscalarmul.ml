...
needs "x86/proofs/p521_jadd.ml";;
needs "x86/proofs/p521_jdouble.ml";;
...
[
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xf8; 0x01; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,504)) *)
  0xe8; 0x64; 0x9b; 0x00; 0x00;
                           (* CALL (Imm32 (word 39780)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xd0; 0x02; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,720)) *)
  0xe8; 0x32; 0x9b; 0x00; 0x00;
                           (* CALL (Imm32 (word 39730)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xa8; 0x03; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,936)) *)
  0xe8; 0x00; 0x9b; 0x00; 0x00;
                           (* CALL (Imm32 (word 39680)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0x80; 0x04; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,1152)) *)
  0xe8; 0xce; 0x9a; 0x00; 0x00;
                           (* CALL (Imm32 (word 39630)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0x58; 0x05; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,1368)) *)
  0xe8; 0x9c; 0x9a; 0x00; 0x00;
                           (* CALL (Imm32 (word 39580)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0x30; 0x06; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,1584)) *)
  0xe8; 0x6a; 0x9a; 0x00; 0x00;
                           (* CALL (Imm32 (word 39530)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0x08; 0x07; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,1800)) *)
  0xe8; 0x38; 0x9a; 0x00; 0x00;
                           (* CALL (Imm32 (word 39480)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xe0; 0x07; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,2016)) *)
  0xe8; 0x06; 0x9a; 0x00; 0x00;
                           (* CALL (Imm32 (word 39430)) *)
  ...
  0x48; 0x8d; 0x7c; 0x24; 0x48;
                           (* LEA (% rdi) (%% (rsp,72)) *)
  0xe8; 0x19; 0x97; 0x00; 0x00;
                           (* CALL (Imm32 (word 38681)) *)
  0x48; 0x8d; 0x74; 0x24; 0x48;
                           (* LEA (% rsi) (%% (rsp,72)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x48;
                           (* LEA (% rdi) (%% (rsp,72)) *)
  0xe8; 0x0a; 0x97; 0x00; 0x00;
                           (* CALL (Imm32 (word 38666)) *)
  0x48; 0x8d; 0x74; 0x24; 0x48;
                           (* LEA (% rsi) (%% (rsp,72)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x48;
                           (* LEA (% rdi) (%% (rsp,72)) *)
  0xe8; 0xfb; 0x96; 0x00; 0x00;
                           (* CALL (Imm32 (word 38651)) *)
  0x48; 0x8d; 0x74; 0x24; 0x48;
                           (* LEA (% rsi) (%% (rsp,72)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x48;
                           (* LEA (% rdi) (%% (rsp,72)) *)
  0xe8; 0xec; 0x96; 0x00; 0x00;
                           (* CALL (Imm32 (word 38636)) *)
  0x48; 0x8d; 0x74; 0x24; 0x48;
                           (* LEA (% rsi) (%% (rsp,72)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x48;
                           (* LEA (% rdi) (%% (rsp,72)) *)
  0xe8; 0xdd; 0x96; 0x00; 0x00;
                           (* CALL (Imm32 (word 38621)) *)
  0x4c; 0x8b; 0x04; 0x24;  (* MOV (% r8) (Memop Quadword (%% (rsp,0))) *)
  0x4c; 0x8b; 0x4c; 0x24; 0x08;
                           (* MOV (% r9) (Memop Quadword (%% (rsp,8))) *)
  0x4c; 0x8b; 0x54; 0x24; 0x10;
...
let LOCAL_JADD_TAC =
  ...
  [`read RDI s`; `read RSI s`;
   ...
   `pc + 0x1be7`; `read RSP s`; `read (memory :> bytes64(read RSP s)) s`];;
...
let LOCAL_JDOUBLE_TAC =
  ...
  X86_SUBROUTINE_SIM_TAC
   (p521_jscalarmul_mc,P521_JSCALARMUL_EXEC,
    0x9d80,p521_jdouble_mc,th)
  [`read RDI s`; `read RSI s`;
   `read(memory :> bytes(read RSI s,8 * 9)) s,
    read(memory :> bytes(word_add (read RSI s) (word 72),8 * 9)) s,
    read(memory :> bytes(word_add (read RSI s) (word 144),8 * 9)) s`;
   `pc + 0x9d80`; `read RSP s`; `read (memory :> bytes64(read RSP s)) s`];;
...
let P521_JSCALARMUL_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer.
        ALL (nonoverlapping (stackpointer,4656))
            [(word pc,0xdb6d); (res,216); (scalar,72); (point,216)] /\
        nonoverlapping (res,216) (word pc,0xdb6d)
        ==> ensures x86
             (\s. bytes_loaded s (word pc) p521_jscalarmul_mc /\
                  read RIP s = word(pc + 0x11) /\
                  read RSP s = word_add stackpointer (word 624) /\
          ...
          (MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           ...
           MAYCHANGE [memory :> bytes(res,216);
                      memory :> bytes(stackpointer,4656)])`,
  ...
  ENSURES_WHILE_DOWN_TAC `104` `pc + 0x654` `pc + 0x18a9`
   `\i s.
      read RSP s = word_add stackpointer (word 624) /\
      read (memory :> bytes64(word_add stackpointer (word 4584))) s = res /\
      read RBP s = word (5 * i) /\
      bignum_from_memory(word_add stackpointer (word 624),9) s =
      ...
      !P. P IN group_carrier p521_group /\ represents_p521 P (x,y',z)
          ==> represents_p521
                ...
                (bignum_triple_from_memory
                     (word_add stackpointer (word 696),9) s) /\
              !i. i < 16
                  ==> represents_p521 (group_pow p521_group P (i + 1))
                       (bignum_triple_from_memory
                       (word_add stackpointer (word(216 * i + 1128)),9) s)` THEN
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    BIGNUM_LDIGITIZE_TAC "nn_"
     `read (memory :> bytes (word_add stackpointer (word 624),8 * 9)) s17` THEN
    ...
    SUBGOAL_THEN
     `read (memory :> bytes (word_add stackpointer (word 624),8 * 9)) s58 =
      n_neg`
    ASSUME_TAC THENL
    ...
    `read (memory :> bytes (word_add stackpointer (word 1200),8 * 9)) s58` THEN
    X86_STEPS_TAC P521_JSCALARMUL_EXEC (59--97) THEN

    SUBGOAL_THEN
     `read (memory :> bytes (word_add stackpointer (word 1200),8 * 9)) s97 =
      y'`
    ASSUME_TAC THENL
    ...
    MAP_EVERY ABBREV_TAC
     [`x2 = read(memory :> bytes(word_add stackpointer (word 1344),8 * 9)) s101`;
      `y2 = read(memory :> bytes(word_add stackpointer (word 1416),8 * 9)) s101`;
      `z2 = read(memory :> bytes(word_add stackpointer (word 1488),8 * 9)) s101`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x3 = read(memory :> bytes(word_add stackpointer (word 1560),8 * 9)) s106`;
      `y3 = read(memory :> bytes(word_add stackpointer (word 1632),8 * 9)) s106`;
      `z3 = read(memory :> bytes(word_add stackpointer (word 1704),8 * 9)) s106`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x4 = read(memory :> bytes(word_add stackpointer (word 1776),8 * 9)) s110`;
      `y4 = read(memory :> bytes(word_add stackpointer (word 1848),8 * 9)) s110`;
      `z4 = read(memory :> bytes(word_add stackpointer (word 1920),8 * 9)) s110`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x5 = read(memory :> bytes(word_add stackpointer (word 1992),8 * 9)) s115`;
      `y5 = read(memory :> bytes(word_add stackpointer (word 2064),8 * 9)) s115`;
      `z5 = read(memory :> bytes(word_add stackpointer (word 2136),8 * 9)) s115`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x6 = read(memory :> bytes(word_add stackpointer (word 2208),8 * 9)) s119`;
      `y6 = read(memory :> bytes(word_add stackpointer (word 2280),8 * 9)) s119`;
      `z6 = read(memory :> bytes(word_add stackpointer (word 2352),8 * 9)) s119`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x7 = read(memory :> bytes(word_add stackpointer (word 2424),8 * 9)) s124`;
      `y7 = read(memory :> bytes(word_add stackpointer (word 2496),8 * 9)) s124`;
      `z7 = read(memory :> bytes(word_add stackpointer (word 2568),8 * 9)) s124`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x8 = read(memory :> bytes(word_add stackpointer (word 2640),8 * 9)) s128`;
      `y8 = read(memory :> bytes(word_add stackpointer (word 2712),8 * 9)) s128`;
      `z8 = read(memory :> bytes(word_add stackpointer (word 2784),8 * 9)) s128`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x9 = read(memory :> bytes(word_add stackpointer (word 2856),8 * 9)) s133`;
      `y9 = read(memory :> bytes(word_add stackpointer (word 2928),8 * 9)) s133`;
      `z9 = read(memory :> bytes(word_add stackpointer (word 3000),8 * 9)) s133`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xa = read(memory :> bytes(word_add stackpointer (word 3072),8 * 9)) s137`;
      `ya = read(memory :> bytes(word_add stackpointer (word 3144),8 * 9)) s137`;
      `za = read(memory :> bytes(word_add stackpointer (word 3216),8 * 9)) s137`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xb = read(memory :> bytes(word_add stackpointer (word 3288),8 * 9)) s142`;
      `yb = read(memory :> bytes(word_add stackpointer (word 3360),8 * 9)) s142`;
      `zb = read(memory :> bytes(word_add stackpointer (word 3432),8 * 9)) s142`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xc = read(memory :> bytes(word_add stackpointer (word 3504),8 * 9)) s146`;
      `yc = read(memory :> bytes(word_add stackpointer (word 3576),8 * 9)) s146`;
      `zc = read(memory :> bytes(word_add stackpointer (word 3648),8 * 9)) s146`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xd = read(memory :> bytes(word_add stackpointer (word 3720),8 * 9)) s151`;
      `yd = read(memory :> bytes(word_add stackpointer (word 3792),8 * 9)) s151`;
      `zd = read(memory :> bytes(word_add stackpointer (word 3864),8 * 9)) s151`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xe = read(memory :> bytes(word_add stackpointer (word 3936),8 * 9)) s155`;
      `ye = read(memory :> bytes(word_add stackpointer (word 4008),8 * 9)) s155`;
      `ze = read(memory :> bytes(word_add stackpointer (word 4080),8 * 9)) s155`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xf = read(memory :> bytes(word_add stackpointer (word 4152),8 * 9)) s160`;
      `yf = read(memory :> bytes(word_add stackpointer (word 4224),8 * 9)) s160`;
      `zf = read(memory :> bytes(word_add stackpointer (word 4296),8 * 9)) s160`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`xg = read(memory :> bytes(word_add stackpointer (word 4368),8 * 9)) s164`;
      `yg = read(memory :> bytes(word_add stackpointer (word 4440),8 * 9)) s164`;
      `zg = read(memory :> bytes(word_add stackpointer (word 4512),8 * 9)) s164`
     ] THEN
    ...
    BIGNUM_LDIGITIZE_TAC "nr_"
     `read(memory :> bytes (word_add stackpointer (word 624),8 * 9)) s164` THEN
    X86_ACCSTEPS_TAC P521_JSCALARMUL_EXEC
    ...
    BIGNUM_LDIGITIZE_TAC "xx_"
     `read(memory :> bytes (word_add stackpointer (word 1128),8 * 9)) s209` THEN
    BIGNUM_LDIGITIZE_TAC "yy_"
     `read(memory :> bytes (word_add stackpointer (word 1200),8 * 9)) s209` THEN
    BIGNUM_LDIGITIZE_TAC "zz_"
     `read(memory :> bytes (word_add stackpointer (word 1272),8 * 9)) s209` THEN
    ...
    BIGNUM_LDIGITIZE_TAC "x_"
     `read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s0` THEN
    BIGNUM_LDIGITIZE_TAC "y_"
     `read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s0` THEN
    BIGNUM_LDIGITIZE_TAC "z_"
     `read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s0` THEN
  ...
  GHOST_INTRO_TAC `Xa:num`
   `bignum_from_memory (word_add stackpointer (word 696),9)` THEN
  GHOST_INTRO_TAC `Ya:num`
   `bignum_from_memory (word_add stackpointer (word 768),9)` THEN
  GHOST_INTRO_TAC `Za:num`
   `bignum_from_memory (word_add stackpointer (word 840),9)` THEN
  ...
  MAP_EVERY ABBREV_TAC
   [`X2a = read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s5`;
    `Y2a = read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s5`;
    `Z2a = read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s5`
   ] THEN
  ...
  MAP_EVERY ABBREV_TAC
   [`X4a = read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s9`;
    `Y4a = read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s9`;
    `Z4a = read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s9`
   ] THEN
  ...
  MAP_EVERY ABBREV_TAC
   [`X8a = read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s13`;
    `Y8a = read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s13`;
    `Z8a = read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s13`
   ] THEN
  ...
  MAP_EVERY ABBREV_TAC
   [`Xha = read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s17`;
    `Yha = read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s17`;
    `Zha = read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s17`
   ] THEN
  ...
  MAP_EVERY ABBREV_TAC
   [`Xta = read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s21`;
    `Yta = read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s21`;
    `Zta = read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s21`
   ] THEN

  (*** Selection of bitfield ***)

  BIGNUM_LDIGITIZE_TAC "n_"
    `read (memory :> bytes (word_add stackpointer (word 624),8 * 9)) s21` THEN
  X86_STEPS_TAC P521_JSCALARMUL_EXEC (22--54) THEN
  ABBREV_TAC `bf = (n DIV (2 EXP (5 * i))) MOD 32` THEN
  SUBGOAL_THEN
   `word_ushr (n_8:int64) 59 = word bf /\
    read (memory :> bytes (word_add stackpointer (word 624),8 * 9)) s54 =
    2 EXP (576 - 5 * i) * n MOD 2 EXP (5 * i)`
  MP_TAC THENL
   [EXPAND_TAC "bf" THEN
    SUBGOAL_THEN
  ...
  BIGNUM_LDIGITIZE_TAC "tab_"
   `read(memory :> bytes(word_add stackpointer (word 1128),8 * 432)) s54` THEN
  X86_STEPS_TAC P521_JSCALARMUL_EXEC (55--579) THEN

  MAP_EVERY ABBREV_TAC
   [`Xt = read (memory :> bytes(word_add stackpointer (word 912),8 * 9)) s579`;
    `Zt = read (memory :> bytes(word_add stackpointer (word 1056),8 * 9)) s579`
   ] THEN
  ...
  ABBREV_TAC
   `Yt =
    read(memory :> bytes(word_add stackpointer (word 984),8 * 9)) s611` THEN
  SUBGOAL_THEN
   `!P. P IN group_carrier p521_group /\ represents_p521 P (x,y',z)
  ...
  MAP_EVERY ABBREV_TAC
   [`X' = read (memory :> bytes(word_add stackpointer (word 696),8 * 9)) s616`;
    `Y' = read (memory :> bytes(word_add stackpointer (word 768),8 * 9)) s616`;
    `Z' = read (memory :> bytes(word_add stackpointer (word 840),8 * 9)) s616`
   ] THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let P521_JSCALARMUL_SUBROUTINE_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 4704),4704))
            [(word pc,0xdb6d); (scalar,72); (point,216)] /\
        ALL (nonoverlapping (res,216))
            [(word pc,0xdb6d); (word_sub stackpointer (word 4704),4712)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) p521_jscalarmul_mc /\
                  read RIP s = word pc /\
          ...
          (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE[memory :> bytes(res,216);
                     memory :> bytes(word_sub stackpointer (word 4704),4704)])`,
   X86_ADD_RETURN_STACK_TAC P521_JSCALARMUL_EXEC
     P521_JSCALARMUL_CORRECT `[RBX; RBP; R12; R13; R14; R15]` 4704);;
...
let WINDOWS_P521_JSCALARMUL_SUBROUTINE_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 4728),4728))
            [(word pc,0xdb80); (scalar,72); (point,216)] /\
        ALL (nonoverlapping (res,216))
            [(word pc,0xdb80); (word_sub stackpointer (word 4728),4736)]
        ==> ensures x86
          ...
          (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE[memory :> bytes(res,216);
                     memory :> bytes(word_sub stackpointer (word 4728),4728)])`,
  ...
  REPLICATE_TAC 6 GEN_TAC THEN WORD_FORALL_OFFSET_TAC 4728 THEN
  ...
  UNDISCH_THEN `read RSP s0 = word_add stackpointer (word 4728)`
