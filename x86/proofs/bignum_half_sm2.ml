...
let BIGNUM_HALF_SM2_EXEC = X86_MK_CORE_EXEC_RULE bignum_half_sm2_mc;;
...
let BIGNUM_HALF_SM2_CORRECT = time prove
 (`!z x n pc.
        ...
        ==> ensures x86
             (\s. bytes_loaded s (word pc) (BUTLAST bignum_half_sm2_mc) /\
                  read RIP s = word pc /\
                  C_ARGUMENTS [z; x] s /\
...
let windows_bignum_half_sm2_mc = define_from_elf
   "windows_bignum_half_sm2_mc" "x86/sm2/bignum_half_sm2.obj";;
