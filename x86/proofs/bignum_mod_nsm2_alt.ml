...
let BIGNUM_MOD_NSM2_ALT_EXEC = X86_MK_EXEC_RULE bignum_mod_nsm2_alt_mc;;
...
let windows_bignum_mod_nsm2_alt_mc = define_from_elf
   "windows_bignum_mod_nsm2_alt_mc" "x86/sm2/bignum_mod_nsm2_alt.obj";;

let WINDOWS_BIGNUM_MOD_NSM2_ALT_CORRECT = time prove
 (`!z k x n pc.
      ...
      ==> ensures x86
          ...
          (MAYCHANGE [RIP; RSI; RAX; RDX; RCX; RBX; R8; R9; R10; R11; R12] ,,
           MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [memory :> bignum(z,4)])`,
  tac (X86_MK_EXEC_RULE windows_bignum_mod_nsm2_alt_mc)
      (curry mk_comb `(+) (pc:num)` o mk_small_numeral o (fun n -> n+11)));;

let WINDOWS_BIGNUM_MOD_NSM2_ALT_SUBROUTINE_CORRECT = time prove
 (`!z k x n pc stackpointer returnaddress.
  ...
  GEN_X86_ADD_RETURN_STACK_TAC
    (X86_MK_EXEC_RULE windows_bignum_mod_nsm2_alt_mc)
    WINDOWS_BIGNUM_MOD_NSM2_ALT_CORRECT
