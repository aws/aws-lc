...
let BIGNUM_DEAMONT_P384_ALT_EXEC = X86_MK_CORE_EXEC_RULE bignum_deamont_p384_alt_mc;;
...
let BIGNUM_DEAMONT_P384_ALT_CORRECT = time prove
 (`!z x a pc.
        ...
        ==> ensures x86
             (\s. bytes_loaded s (word pc) (BUTLAST bignum_deamont_p384_alt_mc) /\
...
let BIGNUM_DEAMONT_P384_ALT_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  X86_PROMOTE_RETURN_STACK_TAC
   bignum_deamont_p384_alt_mc BIGNUM_DEAMONT_P384_ALT_CORRECT
   `[R12; R13]` 16);;
...
let windows_bignum_deamont_p384_alt_mc = define_from_elf
   "windows_bignum_deamont_p384_alt_mc" "x86/p384/bignum_deamont_p384_alt.obj";;

let WINDOWS_BIGNUM_DEAMONT_P384_ALT_SUBROUTINE_CORRECT = time prove
 (`!z x a pc stackpointer returnaddress.
  ...
  WINDOWS_X86_WRAP_STACK_TAC
   windows_bignum_deamont_p384_alt_mc bignum_deamont_p384_alt_mc
