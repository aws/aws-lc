...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {"SHA3-224", "sha3-224", NID_sha3_224, 9, &kObjectData[6196], 0},
    {"SHA3-256", "sha3-256", NID_sha3_256, 9, &kObjectData[6205], 0},
    ...
    {"SHA512-224", "sha512-224", NID_sha512_224, 9, &kObjectData[6240], 0},
    {"SHAKE128", "shake128", NID_shake128, 9, &kObjectData[6249], 0},
    {"SHAKE256", "shake256", NID_shake256, 9, &kObjectData[6258], 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    ...
    {"MLKEM512", "MLKEM512", NID_MLKEM512, 9, &kObjectData[6267], 0},
    {"MLKEM768", "MLKEM768", NID_MLKEM768, 9, &kObjectData[6276], 0},
    {"MLKEM1024", "MLKEM1024", NID_MLKEM1024, 9, &kObjectData[6285], 0},
    {"X25519MLKEM768", "X25519MLKEM768", NID_X25519MLKEM768, 5,
     &kObjectData[6294], 0},
    {"SecP256r1MLKEM768", "SecP256r1MLKEM768", NID_SecP256r1MLKEM768, 5,
     &kObjectData[6299], 0},
    {"PQDSA", "PQDSA", NID_PQDSA, 8, &kObjectData[6304], 0},
    {"MLDSA44", "ML-DSA-44", NID_MLDSA44, 9, &kObjectData[6312], 0},
    {"MLDSA65", "ML-DSA-65", NID_MLDSA65, 9, &kObjectData[6321], 0},
    {"MLDSA87", "ML-DSA-87", NID_MLDSA87, 9, &kObjectData[6330], 0},
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    994 /* 2.16.840.1.101.3.4.3.17 (OBJ_MLDSA44) */,
    995 /* 2.16.840.1.101.3.4.3.18 (OBJ_MLDSA65) */,
    996 /* 2.16.840.1.101.3.4.3.19 (OBJ_MLDSA87) */,
    ...
    999 /* 1.3.6.1.4.1.11129.2.4.2 (OBJ_ct_precert_scts) */,
