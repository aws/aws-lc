...
static ossl_bf_key bf_key[2] = {
    {
        .key = {0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69,
                0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72,
                0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a},
        .len = 26,
    },
    {.key = {0x57, 0x68, 0x6f, 0x20, 0x69, 0x73, 0x20, 0x4a, 0x6f, 0x68, 0x6e,
             0x20, 0x47, 0x61, 0x6c, 0x74, 0x3f},
     .len = 17},
};
...
TEST(Blowfish, ossl_bf_cbc) {
  ...
  ASSERT_EQ(Bytes(cbc_in, sizeof(cbc_in)), Bytes(cbc_data, sizeof(cbc_in)));
}
