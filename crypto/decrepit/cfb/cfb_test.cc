...
static const CFBTestCase kCFBTestCases[] = {
    ...
    // CFB8
    {
        ...
        {0x3b, 0x79, 0x42, 0x4c, 0x9c, 0x0d, 0xd4, 0x36, 0xba, 0xce, 0x9e, 0x0e,
         0xd4, 0x58, 0x6a, 0x4f, 0x32, 0xb9},
    },
    {
        // This is the test case from
        // http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf,
        ...
        {0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11,
         0x73, 0x93, 0x17, 0x2a, 0xae, 0x2d},
        {0xcd, 0xa2, 0x52, 0x1e, 0xf0, 0xa9, 0x05, 0xca, 0x44, 0xcd, 0x05, 0x7c,
         0xbf, 0x0d, 0x47, 0xa0, 0x67, 0x8a},
    },
    {
        // This is the test case from
        // http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf,
        ...
        {0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11,
         0x73, 0x93, 0x17, 0x2a, 0xae, 0x2d},
        {0xdc, 0x1f, 0x1a, 0x85, 0x20, 0xa6, 0x4d, 0xb5, 0x5f, 0xcc, 0x8a, 0xc5,
         0x54, 0x84, 0x4e, 0x88, 0x97, 0x00},
    },
    // CFB/CFB128
    {
        // This is the test case from
...
TEST(CFBTest, TestVectors) {
  ...
  for (const auto &test : kCFBTestCases) {
    ...
    for (size_t stride = 1; stride <= input_len; stride++) {
      ...
      ASSERT_TRUE(EVP_EncryptInit_ex(ctx.get(), evp_cipher, nullptr, test.key,
                                     test.iv));
    ...
    ASSERT_TRUE(EVP_DecryptInit_ex(decrypt_ctx.get(), evp_cipher, nullptr,
                                   test.key, test.iv));
