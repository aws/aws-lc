...
OPENSSL_EXPORT int ml_dsa_44_keypair_internal_no_self_test(uint8_t *public_key,
                                                           uint8_t *private_key,
                                                           const uint8_t *seed);
...
OPENSSL_EXPORT int ml_dsa_44_sign_internal_no_self_test(const uint8_t *private_key,
                                                        uint8_t *sig, size_t *sig_len,
                                                        const uint8_t *message, size_t message_len,
                                                        const uint8_t *pre, size_t pre_len,
                                                        const uint8_t *rnd);
...
OPENSSL_EXPORT int ml_dsa_65_keypair_internal_no_self_test(uint8_t *public_key,
                                                           uint8_t *private_key,
                                                           const uint8_t *seed);
...
OPENSSL_EXPORT int ml_dsa_65_sign_internal_no_self_test(const uint8_t *private_key,
                                                        uint8_t *sig, size_t *sig_len,
                                                        const uint8_t *message, size_t message_len,
                                                        const uint8_t *pre, size_t pre_len,
                                                        const uint8_t *rnd);
...
OPENSSL_EXPORT int ml_dsa_87_keypair_internal_no_self_test(uint8_t *public_key,
                                                           uint8_t *private_key,
                                                           const uint8_t *seed);
...
OPENSSL_EXPORT int ml_dsa_87_sign_internal_no_self_test(const uint8_t *private_key,
                                                        uint8_t *sig, size_t *sig_len,
                                                        const uint8_t *message, size_t message_len,
                                                        const uint8_t *pre, size_t pre_len,
                                                        const uint8_t *rnd);
