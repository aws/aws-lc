...
HIDDEN uint32_t OPENSSL_armcap_P =
    ...
    ARMV8_SHA3 |
#endif
#if defined(OPENSSL_STATIC_ARMCAP_NEOVERSE_V1) || \
    defined(__ARM_FEATURE_NEOVERSE_V1)
    ARMV8_NEOVERSE_V1 |
#endif
#if defined(OPENSSL_STATIC_ARMCAP_NEOVERSE_V2) || \
    defined(__ARM_FEATURE_NEOVERSE_V2)
    ARMV8_NEOVERSE_V2 |
#endif
    0;
