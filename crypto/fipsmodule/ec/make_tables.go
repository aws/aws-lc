...
func writeECNISTP256(w *columnWriter) error {
	...
	if err := writeTableClean(w, curve, table, writeU64Mont, nil); err != nil {
		return err
	}
	if _, err := io.WriteString(w, ";\n#else\n" + table_def_str); err != nil {
		return err
	}
	if err := writeTableClean(w, curve, table, writeU32Mont, nil); err != nil {
		return err
	}
	if _, err := io.WriteString(w, ";\n#endif\n"); err != nil {
		return err
...
func writeECNISTP521(w *columnWriter) error {
	...
	if err := writeTableClean(w, curve, table, writeU64, nil); err != nil {
		return err
	}
	...
	if err := writeTableClean(w, curve, table, writeU58, nil); err != nil {
		return err
	}
	if _, err := io.WriteString(w, ";\n#else\n" + table_def_str); err != nil {
		return err
	...
	if err := writeTableClean(w, curve, table, writeU32Custom, bitSizes[:]); err != nil {
		return err
	}
	if _, err := io.WriteString(w, ";\n#endif\n#endif\n"); err != nil {
		return err
