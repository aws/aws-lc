...
#ifndef OPENSSL_HEADER_CRYPTO_FIPSMODULE_KDF_INTERNAL_H
#define OPENSSL_HEADER_CRYPTO_FIPSMODULE_KDF_INTERNAL_H
...
#endif  // OPENSSL_HEADER_CRYPTO_FIPSMODULE_KDF_INTERNAL_H
