...
#include <assert.h>
    ...
    defined(__ia64) || defined(__loongarch_lp64) ||                     \
...
static const uint64_t iotas[] = {
    ...
    defined(__loongarch__) || defined(__EMSCRIPTEN__)
...
static void Round(uint64_t R[KECCAK1600_ROWS][KECCAK1600_ROWS],
                  uint64_t A[KECCAK1600_ROWS][KECCAK1600_ROWS], size_t i) {
...
size_t Keccak1600_Absorb(uint64_t A[KECCAK1600_ROWS][KECCAK1600_ROWS],
                         const uint8_t *inp, size_t len, size_t r) {
...
size_t Keccak1600_Absorb_hw(uint64_t A[KECCAK1600_ROWS][KECCAK1600_ROWS],
                            const uint8_t *inp, size_t len, size_t r);
...
size_t Keccak1600_Squeeze_hw(uint64_t A[KECCAK1600_ROWS][KECCAK1600_ROWS],
                             const uint8_t *out, size_t len, size_t r,
                             int padded);
