...
static const uint8_t kSSHKDFkey[] = {
...
static const uint8_t kSSHKDFxcghash[] = {
...
static const uint8_t kSSHKDFsession[] = {
    0x0e, 0x68, 0x3f, 0xc8, 0xa9, 0xed, 0x7c, 0x2f, 0xf0, 0x2d, 0xef, 0x23,
    0xb2, 0x74, 0x5e, 0xbc, 0x99, 0xb2, 0x67, 0xda, 0xa8, 0x6a, 0x4a, 0xa7,
    0x69, 0x72, 0x39, 0x08, 0x82, 0x53, 0xf6, 0x42
};
...
static const uint8_t kSSHKDFexpected[] = {
...
static const struct SSHKDFTestVector {
    ...
    {
        EVP_sha256,
        kSSHKDFkey, sizeof(kSSHKDFkey),
        kSSHKDFxcghash, sizeof(kSSHKDFxcghash),
        kSSHKDFsession, sizeof(kSSHKDFsession),
        kSSHKDFtype,
        sizeof(kSSHKDFexpected),
        kSSHKDFexpected,
        AWSLC_APPROVED
    },
    {
        ...
        kSSHKDFtype,
        sizeof(kSSHKDFexpected),
        kSSHKDFexpected,  // Not actually, that's the SHA-256 data.
        AWSLC_NOT_APPROVED
    },
};
...
TEST_P(SSHKDF_ServiceIndicatorTest, SSHKDF) {
    ...
    FIPSStatus approved = AWSLC_NOT_APPROVED;
    uint8_t output[sizeof(kSSHKDFexpected)];   // largest test vector output size
    CALL_SERVICE_AND_CHECK_APPROVED(
