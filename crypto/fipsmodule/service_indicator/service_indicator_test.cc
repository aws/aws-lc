...
static const char masterSecretLabel[] = "master secret";
...
static const uint8_t kTLSOutput2_mdsha1[32] = {
    0x76, 0x7f, 0xc5, 0xc9, 0x55, 0xa9, 0x5b, 0xfc, 0x34, 0xfd, 0x09,
    0x09, 0xef, 0x93, 0xd7, 0x77, 0xbc, 0x96, 0xbf, 0xe9, 0x92, 0x51,
    0x59, 0x32, 0xea, 0x0b, 0x61, 0x6c, 0x2f, 0x1f, 0x93, 0xab
};
...
static const uint8_t kTLSOutput2_sha256[32] = {
    0x09, 0x97, 0xe8, 0x99, 0x79, 0x9b, 0x4c, 0x7a, 0xc5, 0x25, 0x7f,
    0x68, 0xa3, 0x71, 0xa1, 0xd0, 0x82, 0x53, 0x5c, 0xa3, 0x1a, 0x82,
    0x42, 0xdb, 0x22, 0xae, 0x7f, 0x5b, 0x80, 0x96, 0x6c, 0x01
};

static const uint8_t kTLSOutput2_sha384[32] = {
    0xb2, 0xab, 0x1f, 0x59, 0x7f, 0x46, 0x12, 0x34, 0xfb, 0xc5, 0x43,
    0xf8, 0xd3, 0x64, 0xf9, 0x40, 0x8f, 0x11, 0xcd, 0x9e, 0x9a, 0x80,
    0xf3, 0xae, 0x4e, 0xa5, 0x79, 0xf2, 0x78, 0x75, 0x93, 0xf7
};

static const uint8_t kTLSOutput2_sha512[32] = {
    0x6a, 0x81, 0x69, 0x67, 0xcc, 0xb7, 0xce, 0x14, 0x33, 0x06, 0xbd,
    0x99, 0x66, 0xf9, 0xf7, 0xe5, 0x90, 0xf9, 0xd8, 0x85, 0x59, 0xd1,
    0x2b, 0x06, 0x8e, 0x60, 0x1b, 0xc1, 0x2a, 0xea, 0xf8, 0x9e
};
...
static const struct KDFTestVector {
  ...
  const FIPSStatus expect_approved;
    ...
    {EVP_sha512, kTLSLabel, sizeof(kTLSLabel), kTLSOutput1_sha512,
     AWSLC_APPROVED},
    {EVP_md5_sha1, masterSecretLabel, sizeof(masterSecretLabel),
     kTLSOutput2_mdsha1, AWSLC_APPROVED},
    {EVP_sha256, masterSecretLabel, sizeof(masterSecretLabel),
     kTLSOutput2_sha256, AWSLC_NOT_APPROVED},
    {EVP_sha384, masterSecretLabel, sizeof(masterSecretLabel),
     kTLSOutput2_sha384, AWSLC_NOT_APPROVED},
    {EVP_sha512, masterSecretLabel, sizeof(masterSecretLabel),
     kTLSOutput2_sha512, AWSLC_NOT_APPROVED},
};
