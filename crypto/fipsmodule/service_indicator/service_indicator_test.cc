...
const KBKDFTestVectorSI nonzero_iv_vectors[] = {
  {
    EVP_sha1,
...
TEST_P(KBKDFTestSI, KBKDFCAVPVectorsSI) {
  const KBKDFTestVectorSI &test = GetParam();
  FIPSStatus approved = AWSLC_NOT_APPROVED;
  ...
  CALL_SERVICE_AND_CHECK_APPROVED(approved,
    ASSERT_TRUE(KBKDF_feedback(output, test.expected_len,
                               test.md_func(),
                               test.ki, test.ki_len,
...
const char kSSHKDFtype = EVP_KDF_SSHKDF_TYPE_INITIAL_IV_CLI_TO_SRV;
...
const uint8_t kSSHKDFkeySHA256[] = {
...
const uint8_t kSSHKDFxcghashSHA256[] = {
...
const uint8_t kSSHKDFsessionSHA256[] = {
    0x0e, 0x68, 0x3f, 0xc8, 0xa9, 0xed, 0x7c, 0x2f, 0xf0, 0x2d, 0xef, 0x23,
    0xb2, 0x74, 0x5e, 0xbc, 0x99, 0xb2, 0x67, 0xda, 0xa8, 0x6a, 0x4a, 0xa7,
    0x69, 0x72, 0x39, 0x08, 0x82, 0x53, 0xf6, 0x42
};
const uint8_t kSSHKDFexpectedSHA256[] = {
