 ...
 **************************************************/
void ml_dsa_polyvec_matrix_expand(ml_dsa_params *params, polyvecl *mat,
 ...
 **************************************************/
void ml_dsa_polyvecl_uniform_eta(ml_dsa_params *params, polyvecl *v,
 ...
 *              - uint16_t nonce: 2-byte nonce
 **************************************************/
void ml_dsa_polyvecl_uniform_gamma1(ml_dsa_params *params, polyvecl *v,
                                    const uint8_t seed[ML_DSA_CRHBYTES],
                                    uint16_t nonce) {
  unsigned int i;
  for (i = 0; i < params->l; ++i) {
 ...
 **************************************************/
void ml_dsa_polyvecl_add(ml_dsa_params *params, polyvecl *w, const polyvecl *u,
                         const polyvecl *v) {
  unsigned int i;
  for (i = 0; i < params->l; ++i) {
...
void ml_dsa_polyvecl_pointwise_acc_montgomery(ml_dsa_params *params,
                                              ml_dsa_poly *w, const polyvecl *u,
                                              const polyvecl *v) {
  unsigned int i;
  ml_dsa_poly t;
 ...
 * and 1 otherwise.
 **************************************************/
int ml_dsa_polyvecl_chknorm(ml_dsa_params *params, const polyvecl *v,
                            int32_t bound) {
  unsigned int i;
  for (i = 0; i < params->l; ++i) {
 ...
 *              - uint16_t nonce: 2-byte nonce
 **************************************************/
void ml_dsa_polyveck_uniform_eta(ml_dsa_params *params, polyveck *v,
                                 const uint8_t seed[ML_DSA_CRHBYTES],
                                 uint16_t nonce) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
 ...
 **************************************************/
void ml_dsa_polyveck_add(ml_dsa_params *params, polyveck *w, const polyveck *u,
                         const polyveck *v) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
    ml_dsa_poly_add(&w->vec[i], &u->vec[i], &v->vec[i]);
 ...
 **************************************************/
void ml_dsa_polyveck_sub(ml_dsa_params *params, polyveck *w, const polyveck *u,
                         const polyveck *v) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
 ...
 * and 1 otherwise.
 **************************************************/
int ml_dsa_polyveck_chknorm(ml_dsa_params *params, const polyveck *v,
                            int32_t bound) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
    if (ml_dsa_poly_chknorm(&v->vec[i], bound)) {
 ...
 *              - const polyveck *v: pointer to input vector
 **************************************************/
void ml_dsa_polyveck_power2round(ml_dsa_params *params, polyveck *v1,
                                 polyveck *v0, const polyveck *v) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
 ...
 *              - const polyveck *v: pointer to input vector
 **************************************************/
void ml_dsa_polyveck_decompose(ml_dsa_params *params, polyveck *v1,
                               polyveck *v0, const polyveck *v) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
 ...
 **************************************************/
unsigned int ml_dsa_polyveck_make_hint(ml_dsa_params *params, polyveck *h,
                                       const polyveck *v0, const polyveck *v1) {
  unsigned int i, s = 0;
  for (i = 0; i < params->k; ++i) {
 ...
 **************************************************/
void ml_dsa_polyveck_use_hint(ml_dsa_params *params, polyveck *w,
                              const polyveck *u, const polyveck *h) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
 ...
 **************************************************/
void ml_dsa_polyveck_pack_w1(ml_dsa_params *params, uint8_t *r,
                             const polyveck *w1) {
  unsigned int i;
  for (i = 0; i < params->k; ++i) {
    ml_dsa_polyw1_pack(params, &r[i * params->poly_w1_packed_bytes],
                       &w1->vec[i]);
  }
}
