...
int ml_dsa_44_sign(const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
                   size_t *sig_len /* OUT */, const uint8_t *message /* IN */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return ml_dsa_sign(&params, sig, sig_len, message, message_len, ctx_string,
                     ctx_string_len, private_key) == 0;
}

int ml_dsa_extmu_44_sign(const uint8_t *private_key /* IN */,
                         uint8_t *sig /* OUT */, size_t *sig_len /* OUT */,
                         const uint8_t *mu /* IN */, size_t mu_len /* IN */) {
  boringssl_ensure_ml_dsa_self_test();
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
...
int ml_dsa_44_sign_internal(const uint8_t *private_key /* IN */,
  ...
  return ml_dsa_44_sign_internal_no_self_test(
      private_key, sig, sig_len, message, message_len, pre, pre_len, rnd);
}

int ml_dsa_44_sign_internal_no_self_test(
    const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
    size_t *sig_len /* OUT */, const uint8_t *message /* IN */,
    size_t message_len /* IN */, const uint8_t *pre /* IN */,
    size_t pre_len /* IN */, const uint8_t *rnd /* IN */) {
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return ml_dsa_sign_internal(&params, sig, sig_len, message, message_len, pre,
                              pre_len, rnd, private_key, 0) == 0;
}

int ml_dsa_extmu_44_sign_internal(
    const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
    size_t *sig_len /* OUT */, const uint8_t *mu /* IN */,
    size_t mu_len /* IN */, const uint8_t *pre /* IN */,
    size_t pre_len /* IN */, const uint8_t *rnd /* IN */) {
  boringssl_ensure_ml_dsa_self_test();
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return ml_dsa_sign_internal(&params, sig, sig_len, mu, mu_len, pre, pre_len,
                              rnd, private_key, 1) == 0;
}

int ml_dsa_44_verify(const uint8_t *public_key /* IN */,
                     const uint8_t *sig /* IN */, size_t sig_len /* IN */,
                     const uint8_t *message /* IN */,
                     size_t message_len /* IN */,
                     const uint8_t *ctx_string /* IN */,
                     size_t ctx_string_len /* IN */) {
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return ml_dsa_verify(&params, sig, sig_len, message, message_len, ctx_string,
                       ctx_string_len, public_key) == 0;
}
...
int ml_dsa_extmu_44_verify(const uint8_t *public_key /* IN */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return ml_dsa_verify_internal(&params, sig, sig_len, mu, mu_len, NULL, 0,
                                public_key, 1) == 0;
}
...
int ml_dsa_44_verify_internal(const uint8_t *public_key /* IN */,
  ...
  return ml_dsa_44_verify_internal_no_self_test(
      public_key, sig, sig_len, message, message_len, pre, pre_len);
}
...
int ml_dsa_extmu_44_verify_internal(
    const uint8_t *public_key /* IN */, const uint8_t *sig /* IN */,
    size_t sig_len /* IN */, const uint8_t *mu /* IN */, size_t mu_len /* IN */,
    const uint8_t *pre /* IN */, size_t pre_len /* IN */) {
  boringssl_ensure_ml_dsa_self_test();
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return ml_dsa_verify_internal(&params, sig, sig_len, mu, mu_len, pre, pre_len,
                                public_key, 1) == 0;
}
...
int ml_dsa_65_sign(const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
                   size_t *sig_len /* OUT */, const uint8_t *message /* IN */,
                   size_t message_len /* IN */,
                   const uint8_t *ctx_string /* IN */,
                   size_t ctx_string_len /* IN */) {
...
int ml_dsa_extmu_65_sign_internal(
    const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
    size_t *sig_len /* OUT */, const uint8_t *mu /* IN */,
    size_t mu_len /* IN */, const uint8_t *pre /* IN */,
    size_t pre_len /* IN */, const uint8_t *rnd /* IN */) {
...
int ml_dsa_extmu_65_verify_internal(
    const uint8_t *public_key /* IN */, const uint8_t *sig /* IN */,
    size_t sig_len /* IN */, const uint8_t *mu /* IN */, size_t mu_len /* IN */,
    const uint8_t *pre /* IN */, size_t pre_len /* IN */) {
  boringssl_ensure_ml_dsa_self_test();
...
int ml_dsa_87_sign(const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
                   size_t *sig_len /* OUT */, const uint8_t *message /* IN */,
                   size_t message_len /* IN */,
                   const uint8_t *ctx_string /* IN */,
                   size_t ctx_string_len /* IN */) {
...
int ml_dsa_extmu_87_sign_internal(
    const uint8_t *private_key /* IN */, uint8_t *sig /* OUT */,
    size_t *sig_len /* OUT */, const uint8_t *mu /* IN */,
    size_t mu_len /* IN */, const uint8_t *pre /* IN */,
    size_t pre_len /* IN */, const uint8_t *rnd /* IN */) {
...
int ml_dsa_extmu_87_verify_internal(
    const uint8_t *public_key /* IN */, const uint8_t *sig /* IN */,
    size_t sig_len /* IN */, const uint8_t *mu /* IN */, size_t mu_len /* IN */,
    const uint8_t *pre /* IN */, size_t pre_len /* IN */) {
  boringssl_ensure_ml_dsa_self_test();
