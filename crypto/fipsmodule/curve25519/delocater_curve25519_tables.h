...
#else
    ge_precomp **k25519Precomp;
#endif
    ge_precomp *k25519Bi;
};

DEFINE_LOCAL_DATA(struct curve25519_data_st, curve25519_nohw_data) {
...
static const ge_precomp k25519Bi[8] = {
    ...
    out->k25519d = k25519d;
    out->k25519sqrtm1 = k25519sqrtm1;
    out->k25519d2 = k25519d2;
#if defined(OPENSSL_SMALL)
    out->k25519SmallPrecomp = (uint8_t *) k25519SmallPrecomp;
#else
    out->k25519Precomp = (ge_precomp **) k25519Precomp;
#endif
    out->k25519Bi = (ge_precomp *) k25519Bi;
}
