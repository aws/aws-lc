...
static int boringssl_self_test_fast(void) {
  ...
  static const uint8_t kDRBGOutput[64] = {
      0xc6, 0x13, 0x90, 0xa5, 0x86, 0xd2, 0x3c, 0x3a,
      0x56, 0xf6, 0x94, 0x10, 0x90, 0x7d, 0xbf, 0x57,
      0x33, 0xd8, 0xb4, 0xb4, 0x15, 0x37, 0xc8, 0x15,
      0xcf, 0x0c, 0x4f, 0x3c, 0x81, 0x28, 0x5d, 0xc2,
      0x9a, 0x3d, 0x47, 0xa6, 0x57, 0xea, 0x4e, 0x28,
      0xca, 0xed, 0xe1, 0x60, 0x9f, 0x07, 0x0b, 0x32,
      0xcb, 0x7f, 0xf6, 0x18, 0x6e, 0xfe, 0xe9, 0x87,
      0x92, 0x03, 0xaa, 0x41, 0x89, 0xaa, 0xc5, 0xbd,
  };
  ...
  static const uint8_t kDRBGReseedOutput[64] = {
      0x93, 0x48, 0x32, 0x7b, 0x4e, 0x34, 0xd3, 0x6e,
      0xb9, 0x45, 0xca, 0x81, 0x8d, 0xb0, 0xbf, 0x4d,
      0xf8, 0xa2, 0xb5, 0xe8, 0x48, 0xbb, 0x1c, 0xe0,
      0xf3, 0xc5, 0xd9, 0xa7, 0x44, 0x9a, 0x96, 0x6d,
      0x2b, 0x65, 0x12, 0x50, 0x23, 0xac, 0x61, 0x3d,
      0x64, 0xa9, 0xb6, 0x29, 0x5f, 0xf5, 0xcb, 0x1f,
      0x9b, 0xd6, 0xe3, 0x92, 0x2f, 0x2f, 0x75, 0xda,
      0x85, 0x81, 0xbe, 0xc4, 0x2b, 0xf9, 0x8a, 0x32,
  };
  CTR_DRBG_STATE drbg;
  if (!CTR_DRBG_init_df(&drbg, kDRBGEntropy, kDRBGPersonalization,
                     sizeof(kDRBGPersonalization), kDRBGNonce) ||
      !CTR_DRBG_generate_df(&drbg, output, sizeof(kDRBGOutput), kDRBGAD,
                         sizeof(kDRBGAD)) ||
      !check_test(kDRBGOutput, output, sizeof(kDRBGOutput),
                  "DRBG Generate KAT") ||
      !CTR_DRBG_reseed_df(&drbg, kDRBGEntropy2, kDRBGAD, sizeof(kDRBGAD)) ||
      !CTR_DRBG_generate_df(&drbg, output, sizeof(kDRBGReseedOutput), kDRBGAD,
                         sizeof(kDRBGAD)) ||
