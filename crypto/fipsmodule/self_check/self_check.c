...
static OPENSSL_NOINLINE int boringssl_self_test_ml_dsa(void) {
  ...
  // The keyGen/sigGen vectors below are ML-DSA-44 row 1 of Table 1 ("ML-DSA
  // Algorithm 7 ML-DSA.Sign_internal() Known Answer Tests for Rejection Cases")
  // in Section 6.1.2 of draft-celi-acvp-ml-dsa:
  // https://pages.nist.gov/ACVP/draft-celi-acvp-ml-dsa.html#name-ml-dsa-siggen-test-types
  //
  // FIPS 140-3 IG 10.3.A Resolution 15 Note23 recommends that the ML-DSA
  // signature generation CAST cover every applicable rejection-sampling loop
  // path, and points at that table for suitable values. ML-DSA-44 is the only
  // parameter set where the ct0 check is reachable, and this single vector
  // rejects once at each of the four checks in FIPS 204 Algorithm 7 -- z
  // (line 23), r0 (line 23), ct0 (line 28) and the number of 1s in h (line 28).
  //
  // To conserve space the draft publishes digests rather than the keys and
  // signature themselves. The expanded values below were generated with this
  // seed and cross-checked against those digests:
  //   SHA2-256(pk || sk) = AC825C59 D8A4C453 A2C4EFEA 8395741C
  //                        A404F300 0E28D56B 25D03BB4 02E5CB2F
  //   SHA2-256(sig)      = DCC71A42 1BC6FFAF B7DF0C7F 6D018A19
  //                        ADA154D1 E2EE360E D533CECD 5DC980AD
  ...
  static const uint8_t kMLDSAKeyGenPublicKey[MLDSA44_PUBLIC_KEY_BYTES] = {
    ,
  };
  ...
  static const uint8_t kMLDSAKeyGenPrivateKey[MLDSA44_PRIVATE_KEY_BYTES] = {
    ,
  };

  // M' from the Table 1 row named above. The CAST signs through
  // ml_dsa_44_sign_internal_no_self_test() with an empty prefix, so this value
  // is consumed directly as the M' input of FIPS 204 Algorithm 7.
  static const uint8_t kMLDSASignPlaintext[32] = {
    0x95, 0x1f, 0xdf, 0x54, 0x73, 0xa4, 0xcb, 0xa6, 0xd9, 0xe5, 0xb5, 0xdb,
    0x7e, 0x79, 0xfb, 0x81, 0x73, 0x92, 0x1b, 0xa5, 0xb1, 0x3e, 0x92, 0x71,
  ...
  static const uint8_t kMLDSASignSignature[MLDSA44_SIGNATURE_BYTES] = {
    ,
  };

  // Independent sigVer vector: kMLDSAVerifyPlaintext signed under the key
  // generated from kMLDSAKeyGenSeed with rnd = kMLDSASigGenSeed.
  static const uint8_t kMLDSAVerifySignature[MLDSA44_SIGNATURE_BYTES] = {
    ,
  };
