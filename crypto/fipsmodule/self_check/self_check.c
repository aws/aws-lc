...
// domainParameterGenerationMode is FC
static DH *self_test_ffc_dh_fc_key(void) {
  // The data is fetched from ACVP data.
  // Details are available in CryptoAlg-851?selectedConversation=c0120d22-f2bd-4eae-8ae6-b04fcca86743
  // File name: 197491/683930/testvector-request.json
  // Other details: "tgId": 2, "tcId": 6
  static const uint8_t kDH_p[256] = {
      
  };
  static const uint8_t kDH_q[32] = {
      0x80, 0x00, 0x00, 0x00, 0x06, 0x82, 0xd3, 0x8d, 0x40, 0x2b, 0xb8, 0x12,
      0x73, 0x1f, 0x36, 0xaa, 0xff, 0x83, 0x05, 0x4b, 0x9d, 0x9e, 0x8b, 0x42,
      0x47, 0xfe, 0x1c, 0xde, 0x7b, 0x74, 0x73, 0xdf
  };
  static const uint8_t kDH_g[256] = {
      
  };
  const uint8_t kDH_private_key[32] = {
      0x40, 0xb3, 0xf2, 0xdf, 0x32, 0x5a, 0x1c, 0x9e, 0x2c, 0x7c, 0x78, 0x85,
      0xc8, 0xd2, 0x12, 0x30, 0xe7, 0x52, 0xb1, 0xb0, 0xa5, 0x08, 0x00, 0x84,
      0x80, 0xa0, 0x40, 0xf0, 0x7c, 0xcb, 0x2d, 0x6f
  };
  const uint8_t kDH_public_key[256] = {
      
  };
  return self_test_ffc_dh_key(kDH_p, sizeof(kDH_p),
                              kDH_q, sizeof(kDH_q),
...
int boringssl_fips_self_test(
  ...
  // |kDH_fc_peer_public| and |kDH_fc_z| is fetched from ACVP data.
  // domainParameterGenerationMode is FC.
  // Details are available in
  // CryptoAlg-851?selectedConversation=c0120d22-f2bd-4eae-8ae6-b04fcca86743
  // File name: 197491/683930/testvector-request.json
  // Other details: "tgId": 2, "tcId": 6
  const uint8_t kDH_fc_peer_public[256] = {
      
  };
  const uint8_t kDH_fc_z[256] = {
      ,
#if !defined(BORINGSSL_FIPS_BREAK_FFC_DH)
      0xf3,
#else
  ...
  // FFC Diffie-Hellman KAT (domainParameterGenerationMode is FC).
  int fc_dh_ok = 0;
  DH *const fc_dh = self_test_ffc_dh_fc_key();
  BIGNUM* fc_peers_key = NULL;
  if (set_bignum(&fc_peers_key, kDH_fc_peer_public, sizeof(kDH_fc_peer_public)) && fc_dh) {
    uint8_t dh_out[sizeof(kDH_fc_z)];
    fc_dh_ok =
        sizeof(dh_out) == DH_size(fc_dh) &&
        DH_compute_key_padded(dh_out, fc_peers_key, fc_dh) == sizeof(dh_out) &&
        check_test(kDH_fc_z, dh_out, sizeof(dh_out), "FFC DH FC");
  }
  BN_free(fc_peers_key);
  DH_free(fc_dh);
  if (!fc_dh_ok) {
    fprintf(stderr, "FFDH FC failed.\n");
    goto err;
  }
