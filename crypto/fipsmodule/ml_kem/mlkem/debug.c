...
#if !defined(MLK_MULTILEVEL_BUILD_NO_SHARED) && defined(MLKEM_DEBUG)
...
#else /* !MLK_MULTILEVEL_BUILD_NO_SHARED && MLKEM_DEBUG */

MLK_EMPTY_CU(debug)

#endif /* !MLK_MULTILEVEL_BUILD_NO_SHARED && MLKEM_DEBUG */
