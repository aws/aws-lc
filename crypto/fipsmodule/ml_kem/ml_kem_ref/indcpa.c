 ...
 **************************************************/
static void pack_pk(ml_kem_params *params, uint8_t *r, polyvec *pk,
                    const uint8_t *seed) {
 ...
 *key
 **************************************************/
static void unpack_pk(ml_kem_params *params, polyvec *pk,
                      uint8_t seed[KYBER_SYMBYTES], const uint8_t *packedpk) {
 ...
 *key
 **************************************************/
static void unpack_sk(ml_kem_params *params, polyvec *sk,
 ...
 **************************************************/
static void pack_ciphertext(ml_kem_params *params, uint8_t *r, polyvec *b,
                            poly *v) {
 ...
 **************************************************/
static void unpack_ciphertext(ml_kem_params *params, polyvec *b, poly *v,
                              const uint8_t *c) {
...
void gen_matrix(ml_kem_params *params, polyvec *a,
 ...
 **************************************************/
void indcpa_keypair_derand(ml_kem_params *params, uint8_t *pk, uint8_t *sk,
  ...
  // FIPS 203. Section 3.3 Destruction of intermediate values.
  OPENSSL_cleanse(buf, sizeof(buf));
  OPENSSL_cleanse(coins_with_domain_separator,
 ...
 **************************************************/
void indcpa_enc(ml_kem_params *params, uint8_t *c, const uint8_t *m,
                const uint8_t *pk, const uint8_t coins[KYBER_SYMBYTES]) {
  unsigned int i;
 ...
 **************************************************/
void indcpa_dec(ml_kem_params *params, uint8_t *m, const uint8_t *c,
                const uint8_t *sk) {
  polyvec b, skpv;
  poly v, mp;
