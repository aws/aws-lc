...
// TODO [childw] from here https://lapo.it/asn1js/
static const uint8_t kPKCS7WithSIgnerInfos[] {
...
TEST(PKCS7Test, Basic) {
    ...
    const uint8_t *p7_der = kPKCS7WithSIgnerInfos;
    const size_t p7_der_len = sizeof(kPKCS7WithSIgnerInfos);
    p7.reset(d2i_PKCS7(nullptr, &p7_der, p7_der_len));
    ASSERT_TRUE(p7.get());
    ASSERT_TRUE(PKCS7_type_is_signed(p7.get()));
    STACK_OF(PKCS7_SIGNER_INFO) *sk_p7si = PKCS7_get_signer_info(p7.get());
    ASSERT_TRUE(sk_p7si);
