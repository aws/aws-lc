...
#define PQT25519_PUBLIC_KEY_BYTES \
  (MLKEM768IPD_PUBLIC_KEY_BYTES + T25519_PUBLIC_KEY_BYTES)
#define PQT25519_SECRET_KEY_BYTES                           \
  (MLKEM768IPD_SECRET_KEY_BYTES + T25519_SECRET_KEY_BYTES + \
   T25519_PUBLIC_KEY_BYTES)
#define PQT25519_CIPHERTEXT_BYTES \
  (MLKEM768IPD_CIPHERTEXT_BYTES + T25519_CIPHERTEXT_BYTES)
#define PQT25519_SHARED_SECRET_LEN PQT_SHARED_SECRET_LEN
#define PQT25519_KEYGEN_SEED_LEN \
  (MLKEM768IPD_KEYGEN_SEED_LEN + T25519_KEYGEN_SEED_LEN)
#define PQT25519_ENCAPS_SEED_LEN \
  (MLKEM768IPD_ENCAPS_SEED_LEN + T25519_ENCAPS_SEED_LEN)

// PQT256 Constants
#define PQT256_PUBLIC_KEY_BYTES \
  (MLKEM768IPD_PUBLIC_KEY_BYTES + T256_PUBLIC_KEY_BYTES)
#define PQT256_SECRET_KEY_BYTES \
  (MLKEM768IPD_SECRET_KEY_BYTES + T256_SECRET_KEY_BYTES + T256_PUBLIC_KEY_BYTES)
#define PQT256_CIPHERTEXT_BYTES \
  (MLKEM768IPD_CIPHERTEXT_BYTES + T256_CIPHERTEXT_BYTES)
#define PQT256_SHARED_SECRET_LEN PQT_SHARED_SECRET_LEN
#define PQT256_KEYGEN_SEED_LEN \
  (MLKEM768IPD_KEYGEN_SEED_LEN + T256_KEYGEN_SEED_LEN)
#define PQT256_ENCAPS_SEED_LEN \
  (MLKEM768IPD_ENCAPS_SEED_LEN + T256_ENCAPS_SEED_LEN)

// PQT384 Constants
#define PQT384_PUBLIC_KEY_BYTES \
  (MLKEM1024IPD_PUBLIC_KEY_BYTES + T384_PUBLIC_KEY_BYTES)
#define PQT384_SECRET_KEY_BYTES                            \
  (MLKEM1024IPD_SECRET_KEY_BYTES + T384_SECRET_KEY_BYTES + \
...
#define PQT384_KEYGEN_SEED_LEN \
  (MLKEM1024IPD_KEYGEN_SEED_LEN + T384_KEYGEN_SEED_LEN)
#define PQT384_ENCAPS_SEED_LEN \
  (MLKEM1024IPD_ENCAPS_SEED_LEN + T384_ENCAPS_SEED_LEN)
