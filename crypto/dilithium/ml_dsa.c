...
int ml_dsa_44_keypair(uint8_t *public_key   /* OUT */,
  ...
  return (mldsa_keypair(&params, public_key, private_key) == 0);
}
...
int ml_dsa_44_keypair_internal(uint8_t *public_key   /* OUT */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return mldsa_keypair_internal(&params, public_key, private_key, seed) == 0;
}
...
int ml_dsa_44_sign(const uint8_t *private_key /* IN */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return mldsa_signature(&params, sig, sig_len, message, message_len,
...
int ml_dsa_44_sign_internal(const uint8_t *private_key  /* IN */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return mldsa_signature_internal(&params, sig, sig_len, message, message_len,
...
int ml_dsa_44_verify(const uint8_t *public_key /* IN */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return mldsa_verify(&params, sig, sig_len, message, message_len,
...
int ml_dsa_44_verify_internal(const uint8_t *public_key /* IN */,
  ...
  ml_dsa_params params;
  ml_dsa_44_params_init(&params);
  return mldsa_verify_internal(&params, sig, sig_len, message, message_len,
