...
TEST(RandTest, PassiveEntropyDepletedObviouslyNotBroken) {
  ...
  EXPECT_TRUE(out_want_additional_input_false_default == 0 ||
              out_want_additional_input_false_default == 1);
  EXPECT_TRUE(out_want_additional_input_true_default == 0 ||
              out_want_additional_input_true_default == 1);
...
// we can only validate the correct value is set on the static build type.
  ...
  EXPECT_EQ(out_want_additional_input_false_default,
            want_additional_input_expect);
  EXPECT_EQ(out_want_additional_input_true_default,
            want_additional_input_expect);
#endif
