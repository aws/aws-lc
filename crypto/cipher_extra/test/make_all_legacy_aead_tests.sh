...
go run make_legacy_aead_tests.go -cipher aes128 -mac sha256 -implicit-iv > aes_128_cbc_sha256_tls_implicit_iv_tests.txt
...
go run make_legacy_aead_tests.go -cipher aes256 -mac sha256 -implicit-iv > aes_256_cbc_sha256_tls_implicit_iv_tests.txt
