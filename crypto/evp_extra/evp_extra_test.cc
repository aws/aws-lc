...
// This key is copied from
// https://github.com/aws/s2n-tls/blame/c4d90e34fbd2ba64bb17a95628622ccc1d0c6807/tests/pems/rsa_pss_2048_sha256_CA_key.pem#L1
...
// badRSAPSSKeyPKCS8_SaltLengthTooLarge contains a DER-encoded
// RSASSA-PSS-params:
//    Hash Algorithm: sha256
//    Mask Algorithm: mgf1 with sha256
//    Salt Length: 511
...
static const uint8_t kExampleECKeyDER[] = {
    0x30, 0x77, 0x02, 0x01, 0x01, 0x04, 0x20, 0x07, 0x0f, 0x08, 0x72,
    0x7a, 0xd4, 0xa0, 0x4a, 0x9c, 0xdd, 0x59, 0xc9, 0x4d, 0x89, 0x68,
    0x77, 0x08, 0xb5, 0x6f, 0xc9, 0x5d, 0x30, 0x77, 0x0e, 0xe8, 0xd1,
    0xc9, 0xce, 0x0a, 0x8b, 0xb4, 0x6a, 0xa0, 0x0a, 0x06, 0x08, 0x2a,
    0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07, 0xa1, 0x44, 0x03, 0x42,
    0x00, 0x04, 0xe6, 0x2b, 0x69, 0xe2, 0xbf, 0x65, 0x9f, 0x97, 0xbe,
    0x2f, 0x1e, 0x0d, 0x94, 0x8a, 0x4c, 0xd5, 0x97, 0x6b, 0xb7, 0xa9,
    0x1e, 0x0d, 0x46, 0xfb, 0xdd, 0xa9, 0xa9, 0x1e, 0x9d, 0xdc, 0xba,
    0x5a, 0x01, 0xe7, 0xd6, 0x97, 0xa8, 0x0a, 0x18, 0xf9, 0xc3, 0xc4,
    0xa3, 0x1e, 0x56, 0xe2, 0x7c, 0x83, 0x48, 0xdb, 0x16, 0x1a, 0x1c,
    0xf5, 0x1d, 0x7e, 0xf1, 0x94, 0x2d, 0x4b, 0xcf, 0x72, 0x22, 0xc1,
};
...
static const uint8_t kExampleMLDSA65KeyDER[] = {
    0x30, 0x82, 0xF,  0xD4, 0x2,  0x1,  0x0,  0x30, 0xB,  0x6,  0x9,  0x60,
    0x86, 0x48, 0x1,  0x65, 0x3,  0x4,  0x3,  0x12, 0x4,  0x82, 0xF,  0xC0,
    0x9B, 0x77, 0xAB, 0x96, 0x9D, 0x65, 0xA2, 0xC1, 0x55, 0x65, 0x2,  0x9B,
    0xA5, 0xD4, 0xE5, 0x93, 0xA1, 0xAC, 0xE7, 0x3E, 0x8C, 0x61, 0xB7, 0xCB,
    0xA1, 0x3E, 0x74, 0x8A, 0xC9, 0xC0, 0xA0, 0x63, 0x31, 0x99, 0xCE, 0x5B,
    0x64, 0x5C, 0x4,  0xBC, 0xAA, 0x47, 0x73, 0x13, 0x4E, 0x53, 0x9F, 0x83,
    0x81, 0x49, 0x98, 0x80, 0x58, 0xB2, 0xA1, 0xDB, 0xD8, 0xDB, 0xEB, 0xAD,
    0x42, 0xD0, 0xFF, 0xEE, 0x18, 0x1A, 0x15, 0x58, 0x9C, 0x84, 0x7F, 0x2A,
    0x73, 0x57, 0x63, 0x60, 0x82, 0xF7, 0xC6, 0xA3, 0xD1, 0x55, 0xC3, 0x4C,
    0xE3, 0xA0, 0x49, 0xBC, 0x17, 0xB4, 0x31, 0x99, 0xBF, 0x75, 0xCB, 0xF2,
    0xF8, 0x3A, 0x16, 0x87, 0xA0, 0x5F, 0x7D, 0x5A, 0x4C, 0x56, 0x90, 0xCE,
    0x2B, 0x82, 0x5A, 0x2B, 0x49, 0xD5, 0x2C, 0x11, 0x83, 0x96, 0xB9, 0xF6,
    0xDB, 0xA9, 0x66, 0xD6, 0xAC, 0x9B, 0x9,  0x3C, 0x6C, 0x15, 0xE3, 0x1D,
    0xF6, 0xF7, 0xEE, 0x9F, 0xA,  0xC5, 0x91, 0x14, 0x33, 0x4B, 0xDB, 0xC4,
    0xEE, 0xC,  0xFB, 0xE4, 0xD1, 0x43, 0xC2, 0x1B, 0xC3, 0x2,  0x9B, 0x6B};
...
TEST(EVPExtraTest, d2i_AutoPrivateKey) {
  ...
  TestValidPrivateKey(kExampleRSAPSSKeyNoPSSParams,
                      sizeof(kExampleRSAPSSKeyNoPSSParams), EVP_PKEY_RSA_PSS);
...
struct RsassaPssParamsMatchTestInput {
  ...
  int success;
    ...
    {kExampleRSAPSSKeyNoPSSParams, sizeof(kExampleRSAPSSKeyNoPSSParams),
...
TEST_P(EVPRsaPssExtraTest, PssParamsMatch) {
  ...
  EXPECT_EQ(EVP_PKEY_CTX_set_signature_md(pkey_ctx, signature_md),
            param.success);
...
struct BadPssKeyTestInput {
  ...
  size_t der_len;
    ...
    {badRSAPSSKeyPKCS8_SaltLengthTooLarge,
     sizeof(badRSAPSSKeyPKCS8_SaltLengthTooLarge)},
};
...
static const struct KnownKEM kKEMs[] = {
    {"Kyber512r3", NID_KYBER512_R3, 800, 1632, 768, 32, 64, 32,
     "kyber/kat/kyber512r3.txt"},
    {"Kyber768r3", NID_KYBER768_R3, 1184, 2400, 1088, 32, 64, 32,
     "kyber/kat/kyber768r3.txt"},
    {"Kyber1024r3", NID_KYBER1024_R3, 1568, 3168, 1568, 32, 64, 32,
     "kyber/kat/kyber1024r3.txt"},
    {"MLKEM512", NID_MLKEM512, 800, 1632, 768, 32, 64, 32,
     "fipsmodule/ml_kem/kat/mlkem512.txt"},
    {"MLKEM768", NID_MLKEM768, 1184, 2400, 1088, 32, 64, 32,
     "fipsmodule/ml_kem/kat/mlkem768.txt"},
    {"MLKEM1024", NID_MLKEM1024, 1568, 3168, 1568, 32, 64, 32,
     "fipsmodule/ml_kem/kat/mlkem1024.txt"},
};
...
static bssl::UniquePtr<EVP_PKEY_CTX> setup_ctx_and_generate_key(
    int kem_nid, const uint8_t *seed, size_t *seed_len) {
  // Create context of KEM type.
  bssl::UniquePtr<EVP_PKEY_CTX> ctx(EVP_PKEY_CTX_new_id(EVP_PKEY_KEM, nullptr));
  EXPECT_TRUE(ctx);
  ...
  // If a |seed| is NULL, we use EVP_PKEY_keygen, otherwise we use
...
TEST_P(PerKEMTest, Encapsulation) {
  ...
  ASSERT_FALSE(
      EVP_PKEY_encapsulate(ctx.get(), ct.data(), &ct_len, nullptr, &ss_len));
  uint32_t err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(EVP_R_MISSING_PARAMETERS, ERR_GET_REASON(err));

  ASSERT_FALSE(
      EVP_PKEY_encapsulate(ctx.get(), nullptr, &ct_len, ss.data(), &ss_len));
  err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(EVP_R_MISSING_PARAMETERS, ERR_GET_REASON(err));
  ...
  ASSERT_FALSE(
      EVP_PKEY_encapsulate(nullptr, ct.data(), &ct_len, ss.data(), &ss_len));
...
TEST_P(PerKEMTest, Decapsulation) {
  ...
  // Get the lengths and check them.
  ASSERT_TRUE(
      EVP_PKEY_decapsulate(ctx.get(), nullptr, &ss_len, ct.data(), ct_len));
  EXPECT_EQ(ss_len, GetParam().shared_secret_len);
  ...
  // ---- 5. Test more failure modes for EVP_PKEY_encapsulate. ----
  ASSERT_FALSE(
      EVP_PKEY_decapsulate(nullptr, ss.data(), &ss_len, ct.data(), ct_len));
...
TEST_P(PerKEMTest, EndToEnd) {
  ...
  bssl::UniquePtr<EVP_PKEY> b_pkey(
      EVP_PKEY_kem_new_raw_public_key(GetParam().nid, a_pk.data(), pk_len));
  ASSERT_TRUE(b_pkey);
  ...
  ASSERT_TRUE(EVP_PKEY_encapsulate(b_ctx.get(), b_ct.data(), &ct_len,
                                   b_ss.data(), &ss_len));
  ...
  ASSERT_TRUE(EVP_PKEY_decapsulate(a_ctx.get(), a_ss.data(), &ss_len,
                                   b_ct.data(), ct_len));
...
TEST_P(PerKEMTest, RawKeyOperations) {
  ...
  bssl::UniquePtr<EVP_PKEY> pkey_pk_new(
      EVP_PKEY_kem_new_raw_public_key(nid, pk.data(), pk_len));
  bssl::UniquePtr<EVP_PKEY> pkey_sk_new(
      EVP_PKEY_kem_new_raw_secret_key(nid, sk.data(), sk_len));
  bssl::UniquePtr<EVP_PKEY> pkey_new(
      EVP_PKEY_kem_new_raw_key(nid, pk.data(), pk_len, sk.data(), sk_len));
  ...
  bssl::UniquePtr<EVP_PKEY_CTX> a_ctx(
      EVP_PKEY_CTX_new(pkey_new.get(), nullptr));
  ASSERT_TRUE(a_ctx);

  // Create Bob's context with the new key that has only the public part.
  bssl::UniquePtr<EVP_PKEY_CTX> b_ctx(
      EVP_PKEY_CTX_new(pkey_pk_new.get(), nullptr));
  ASSERT_TRUE(b_ctx);
  ...
  ASSERT_FALSE(
      EVP_PKEY_get_raw_private_key(pkey_pk_new.get(), sk.data(), &sk_len));
  err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(EVP_R_NO_KEY_SET, ERR_GET_REASON(err));

  ASSERT_FALSE(
      EVP_PKEY_get_raw_public_key(pkey_sk_new.get(), pk.data(), &pk_len));
  err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(EVP_R_NO_KEY_SET, ERR_GET_REASON(err));
  ...
  ASSERT_FALSE(
      EVP_PKEY_kem_new_raw_key(0, pk.data(), pk_len, sk.data(), sk_len));
  err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(EVP_R_UNSUPPORTED_ALGORITHM, ERR_GET_REASON(err));
  ...
  ASSERT_FALSE(
      EVP_PKEY_kem_new_raw_key(nid, nullptr, pk_len, sk.data(), sk_len));
  err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(ERR_R_PASSED_NULL_PARAMETER, ERR_GET_REASON(err));

  ASSERT_FALSE(
      EVP_PKEY_kem_new_raw_key(nid, pk.data(), pk_len, nullptr, sk_len));
  err = ERR_get_error();
  EXPECT_EQ(ERR_LIB_EVP, ERR_GET_LIB(err));
  EXPECT_EQ(ERR_R_PASSED_NULL_PARAMETER, ERR_GET_REASON(err));
...
TEST_P(PerKEMTest, KAT) {
  ...
  FileTestGTest(kat_filepath.c_str(), [&](FileTest *t) {
    std::string count;
    std::vector<uint8_t> keypair_coins, encap_coins, pk_expected, sk_expected,
        ct_expected, ss_expected;
    ...
    bssl::UniquePtr<EVP_PKEY_CTX> ctx;
    ctx = setup_ctx_and_generate_key(GetParam().nid, keypair_coins.data(),
                                     &keygen_seed_len);
    ASSERT_TRUE(ctx);
...
TEST_P(PerKEMTest, KeygenSeedTest) {
  ...
  ASSERT_FALSE(EVP_PKEY_keygen_deterministic(
      ctx.get(), &raw, keygen_seed.data(), &keygen_seed_len));
  ...
  EXPECT_FALSE(EVP_PKEY_keygen_deterministic(
      ctx.get(), &raw, small_keygen_seed.data(), &keygen_seed_len));
  ...
  EXPECT_FALSE(EVP_PKEY_keygen_deterministic(
      ctx.get(), &raw, big_keygen_seed.data(), &keygen_seed_len));
  EXPECT_EQ(EVP_R_INVALID_PARAMETERS, ERR_GET_REASON(ERR_peek_last_error()));
...
TEST_P(PerMLKEMTest, InputValidation) {
  ...
  ASSERT_TRUE(
      EVP_PKEY_encapsulate(ctx.get(), ct.data(), &ct_len, ss.data(), &ss_len));
  ASSERT_TRUE(EVP_PKEY_decapsulate(ctx.get(), ss_expected.data(), &ss_len,
                                   ct.data(), ct_len));
  EXPECT_EQ(Bytes(ss_expected), Bytes(ss));

  // ---- 4. Test invalid secret key ----
  // FIPS 203 Section 7.3 Decapsulation key check (Hash check).
  // Invalidate the key by changing the hash of the public key within the secret
  // key. The 32-byte hash is stored right before the last 32 bytes of the
  // secret key.
  ctx->pkey->pkey.kem_key->secret_key[GetParam().secret_key_len - 64] ^= 1;
  ASSERT_FALSE(EVP_PKEY_decapsulate(ctx.get(), ss_expected.data(), &ss_len,
                                    ct.data(), ct_len));
}
...
INSTANTIATE_TEST_SUITE_P(
    All, PerParamgenCBTest, testing::ValuesIn(paramgenCBparams),
    [](const testing::TestParamInfo<ParamgenCBParam> &params) -> const char * {
      return params.param.name;
    });

TEST_P(PerParamgenCBTest, ParamgenCallbacks) {
  bssl::UniquePtr<EVP_PKEY_CTX> ctx(
      EVP_PKEY_CTX_new_id(GetParam().pkey_type, nullptr));
  ASSERT_TRUE(ctx);
  ...
  ASSERT_TRUE(EVP_PKEY_CTX_ctrl_str(ctx.get(), GetParam().setup_command,
                                    GetParam().setup_arg));
  {
    EVP_PKEY *pkey = EVP_PKEY_new();
    ASSERT_TRUE(pkey);
  ...
  for (int i = 0; i < keygen_info; i++) {
    if (i == 0) {
      EXPECT_EQ(EVP_PKEY_CTX_get_keygen_info(ctx.get(), i),
                GetParam().keygen_info_0);
    } else {
      EXPECT_EQ(EVP_PKEY_CTX_get_keygen_info(ctx.get(), i),
                GetParam().keygen_into_1);
    }
  }
}
...
static bssl::UniquePtr<EVP_PKEY> dsa_paramgen(int nbits, const EVP_MD *md,
  ...
  if (ctx && maybe_copy(&ctx) && 1 == EVP_PKEY_paramgen_init(ctx.get()) &&
...
static bssl::UniquePtr<EVP_PKEY> dsa_keygen(bssl::UniquePtr<EVP_PKEY> &params,
  ...
  bssl::UniquePtr<EVP_PKEY_CTX> ctx(EVP_PKEY_CTX_new(params.get(), nullptr));
  if (ctx && 1 == EVP_PKEY_keygen_init(ctx.get()) && maybe_copy(&ctx) &&
...
static bssl::UniquePtr<EVP_PKEY> dsa_public_key(
  ...
  bssl::UniquePtr<EVP_PKEY> pkey(nullptr);
  bssl::UniquePtr<BIO> bio(BIO_new(BIO_s_mem()));
  if (bio && 1 == PEM_write_bio_PUBKEY(bio.get(), private_key.get())) {
...
TEST(EVPExtraTest, DSASignDigestVerify) {
  ...
  {
    bssl::UniquePtr<EVP_PKEY_CTX> ctx(
        EVP_PKEY_CTX_new(private_key.get(), nullptr));
    ASSERT_TRUE(ctx);
  ...
  bssl::UniquePtr<EVP_PKEY> public_key = dsa_public_key(private_key);
  {
    ...
    ASSERT_EQ(1, EVP_DigestVerifyInit(md_ctx.get(), nullptr, EVP_sha1(),
...
TEST(EVPExtraTest, DSADigestSignFinalVerify) {
...

  {
    ...
    bssl::UniquePtr<EVP_MD_CTX> md_ctx(EVP_MD_CTX_new());
    ASSERT_TRUE(md_ctx);
    ASSERT_NE(1, EVP_DigestSignInit(md_ctx.get(), &raw_pctx, EVP_md5(), nullptr,
                                    private_key.get()));
    // md_ctx takes ownership of raw_pctx
    ASSERT_EQ(1, EVP_DigestSignInit(md_ctx.get(), &raw_pctx, EVP_sha256(),
                                    nullptr, private_key.get()));
...
TEST(EVPExtraTest, DSADigestSignVerify) {
...

  {
    bssl::UniquePtr<EVP_MD_CTX> md_ctx(EVP_MD_CTX_new());
    ASSERT_TRUE(md_ctx);
    ASSERT_EQ(1, EVP_DigestSignInit(md_ctx.get(), nullptr, EVP_sha256(),
                                    nullptr, private_key.get()));
    ASSERT_EQ(1, EVP_DigestSign(md_ctx.get(), nullptr, &siglen,
                                (const uint8_t *)data, data_len));
    sig.resize(siglen);
    ASSERT_EQ(1, EVP_DigestSign(md_ctx.get(), sig.data(), &siglen,
                                (const uint8_t *)data, data_len));
  }
  ...
  bssl::UniquePtr<EVP_PKEY> public_key = dsa_public_key(private_key);
  {
    bssl::UniquePtr<EVP_MD_CTX> md_ctx(EVP_MD_CTX_new());
    ASSERT_TRUE(md_ctx);
    ASSERT_TRUE(EVP_DigestVerifyInit(md_ctx.get(), nullptr, EVP_sha256(),
                                     nullptr, public_key.get()));
    ASSERT_TRUE(EVP_DigestVerify(md_ctx.get(), sig.data(), sig.size(),
                                 (const uint8_t *)data, data_len));
  }
}
