...
int awslc_prov_sha384_init(void *ctx) { return SHA384_Init((SHA512_CTX *)ctx); }
...
int awslc_prov_sha384_final(void *ctx, unsigned char *out, size_t out_size) {
  if (out_size < SHA384_DIGEST_LENGTH) {
    return 0;
  }
...
int awslc_prov_sha512_init(void *ctx) { return SHA512_Init((SHA512_CTX *)ctx); }
...
int awslc_prov_sha512_final(void *ctx, unsigned char *out, size_t out_size) {
  if (out_size < SHA512_DIGEST_LENGTH) {
    return 0;
  }
...
int awslc_prov_sha512_224_final(void *ctx, unsigned char *out,
                                size_t out_size) {
  if (out_size < SHA512_224_DIGEST_LENGTH) {
    return 0;
  }
...
int awslc_prov_sha512_256_final(void *ctx, unsigned char *out,
                                size_t out_size) {
  if (out_size < SHA512_256_DIGEST_LENGTH) {
    return 0;
  }
