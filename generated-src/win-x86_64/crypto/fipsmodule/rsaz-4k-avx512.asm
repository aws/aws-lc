...
global	rsaz_amm52x40_x1_ifma256
...
rsaz_amm52x40_x1_ifma256:
	...
	mov	rax,rsp
$L$SEH_begin_rsaz_amm52x40_x1_ifma256:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
	mov	rcx,r9
...
$L$rsaz_amm52x40_x1_ifma256_body:
...
$L$rsaz_amm52x40_x1_ifma256_epilogue:

	mov	rdi,QWORD[8+rsp]	;WIN64 epilogue
	mov	rsi,QWORD[16+rsp]
	DB	0F3h,0C3h		;repret

$L$SEH_end_rsaz_amm52x40_x1_ifma256:
...
global	rsaz_amm52x40_x2_ifma256
...
rsaz_amm52x40_x2_ifma256:
	...
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_rsaz_amm52x40_x2_ifma256:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
	mov	rcx,r9
...
DB	243,15,30,250
	...
	vmovdqa64	XMMWORD[128+rsp],xmm14
	vmovdqa64	XMMWORD[144+rsp],xmm15
$L$rsaz_amm52x40_x2_ifma256_body:
...
$L$loop40:
	...
	vpmadd52luq	ymm19,ymm1,YMMWORD[512+rdx]
	vpmadd52luq	ymm20,ymm1,YMMWORD[544+rdx]
	vpmadd52luq	ymm21,ymm1,YMMWORD[576+rdx]
	vpmadd52luq	ymm22,ymm1,YMMWORD[608+rdx]
	...
	vpmadd52luq	ymm19,ymm2,YMMWORD[512+r9]
	vpmadd52luq	ymm20,ymm2,YMMWORD[544+r9]
	vpmadd52luq	ymm21,ymm2,YMMWORD[576+r9]
	vpmadd52luq	ymm22,ymm2,YMMWORD[608+r9]
	...
	vpmadd52huq	ymm19,ymm1,YMMWORD[512+rdx]
	vpmadd52huq	ymm20,ymm1,YMMWORD[544+rdx]
	vpmadd52huq	ymm21,ymm1,YMMWORD[576+rdx]
	vpmadd52huq	ymm22,ymm1,YMMWORD[608+rdx]
	...
	vpmadd52huq	ymm19,ymm2,YMMWORD[512+r9]
	vpmadd52huq	ymm20,ymm2,YMMWORD[544+r9]
	vpmadd52huq	ymm21,ymm2,YMMWORD[576+r9]
	vpmadd52huq	ymm22,ymm2,YMMWORD[608+r9]
	lea	r11,[8+r11]
	dec	ebx
	jne	NEAR $L$loop40
	...
	vmovdqu64	YMMWORD[512+rcx],ymm19
	vmovdqu64	YMMWORD[544+rcx],ymm20
	vmovdqu64	YMMWORD[576+rcx],ymm21
	vmovdqu64	YMMWORD[608+rcx],ymm22
...
$L$rsaz_amm52x40_x2_ifma256_epilogue:
	mov	rdi,QWORD[8+rsp]	;WIN64 epilogue
	mov	rsi,QWORD[16+rsp]
	DB	0F3h,0C3h		;repret

$L$SEH_end_rsaz_amm52x40_x2_ifma256:
section	.text


ALIGN	32
global	extract_multiplier_2x40_win5
...
ALIGN	4
	DD	$L$SEH_begin_rsaz_amm52x40_x1_ifma256 wrt ..imagebase
	DD	$L$SEH_end_rsaz_amm52x40_x1_ifma256 wrt ..imagebase
	DD	$L$SEH_info_rsaz_amm52x40_x1_ifma256 wrt ..imagebase

	DD	$L$SEH_begin_rsaz_amm52x40_x2_ifma256 wrt ..imagebase
	DD	$L$SEH_end_rsaz_amm52x40_x2_ifma256 wrt ..imagebase
	DD	$L$SEH_info_rsaz_amm52x40_x2_ifma256 wrt ..imagebase

section	.xdata rdata align=8
ALIGN	8
$L$SEH_info_rsaz_amm52x40_x1_ifma256:
	DB	9,0,0,0
	DD	rsaz_avx_handler wrt ..imagebase
	DD	$L$rsaz_amm52x40_x1_ifma256_body wrt ..imagebase,$L$rsaz_amm52x40_x1_ifma256_epilogue wrt ..imagebase
$L$SEH_info_rsaz_amm52x40_x2_ifma256:
	DB	9,0,0,0
	DD	rsaz_avx_handler wrt ..imagebase
