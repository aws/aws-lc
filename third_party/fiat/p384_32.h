...
static void fiat_p384_opp(uint32_t out1[6], const uint32_t arg1[6]) __attribute__ ((unused));
static void fiat_p384_from_montgomery(uint32_t out1[6], const uint32_t arg1[6]) __attribute__ ((unused));
static void fiat_p384_to_montgomery(uint32_t out1[6], const uint32_t arg1[6]) __attribute__ ((unused));
static void fiat_p384_set_one(uint32_t out1[6]) __attribute__ ((unused));
static void fiat_p384_msat(uint32_t out1[7]) __attribute__ ((unused));
static void fiat_p384_divstep(uint32_t* out1, uint32_t out2[7], uint32_t out3[7], uint32_t out4[6], uint32_t out5[6], uint32_t arg1, const uint32_t arg2[7], const uint32_t arg3[7], const uint32_t arg4[6], const uint32_t arg5[6]) __attribute__ ((unused));
static void fiat_p384_divstep_precomp(uint32_t out1[6]) __attribute__ ((unused));
