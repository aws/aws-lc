...
let LOCAL_SQR_P521_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE p521_jmixadd_alt_mc) 353 lvs
  `!(t:x86state) pcin pcout p3 n3 p1 n1.
    ...
    ==> ensures x86
         (\s. bytes_loaded s (word pc) (BUTLAST p521_jmixadd_alt_mc) /\
              read RIP s = pcin /\
...
let LOCAL_MUL_P521_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE p521_jmixadd_alt_mc) 465 lvs
...
let LOCAL_SUB_P521_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE p521_jmixadd_alt_mc) 37 lvs
  `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
...
let P521_JMIXADD_ALT_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
  ...
  X86_PROMOTE_RETURN_STACK_TAC p521_jmixadd_alt_mc P521_JMIXADD_ALT_CORRECT
...
let WINDOWS_P521_JMIXADD_ALT_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
  ...
  WINDOWS_X86_WRAP_STACK_TAC
   windows_p521_jmixadd_alt_mc p521_jmixadd_alt_mc
