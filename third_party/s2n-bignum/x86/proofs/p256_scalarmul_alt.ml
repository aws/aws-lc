...
needs "x86/proofs/bignum_tomont_p256_alt.ml";;
...
(**** print_literal_from_elf "x86/p256/p256_scalarmul_alt.o";;
 ****)
...
[
  ...
  0xe8; 0xfc; 0x24; 0x00; 0x00;
                           (* CALL (Imm32 (word 9468)) *)
  0x48; 0x8d; 0x73; 0x20;  (* LEA (% rsi) (%% (rbx,32)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x00; 0x01; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,256)) *)
  0xe8; 0xeb; 0x24; 0x00; 0x00;
                           (* CALL (Imm32 (word 9451)) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,224)) *)
  0xe8; 0xcb; 0x4d; 0x00; 0x00;
                           (* CALL (Imm32 (word 19915)) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,224)) *)
  0xe8; 0x77; 0x62; 0x00; 0x00;
                           (* CALL (Imm32 (word 25207)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,512)) *)
  0x48; 0x8d; 0xb4; 0x24; 0x40; 0x01; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,320)) *)
  0xe8; 0x99; 0x4d; 0x00; 0x00;
                           (* CALL (Imm32 (word 19865)) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,224)) *)
  0xe8; 0x45; 0x62; 0x00; 0x00;
                           (* CALL (Imm32 (word 25157)) *)
  0x48; 0x8d; 0xbc; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,704)) *)
  0x48; 0x8d; 0xb4; 0x24; 0xa0; 0x01; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,416)) *)
  0xe8; 0x67; 0x4d; 0x00; 0x00;
                           (* CALL (Imm32 (word 19815)) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,224)) *)
  0xe8; 0x13; 0x62; 0x00; 0x00;
                           (* CALL (Imm32 (word 25107)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x80; 0x03; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,896)) *)
  0x48; 0x8d; 0xb4; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,512)) *)
  0xe8; 0x35; 0x4d; 0x00; 0x00;
                           (* CALL (Imm32 (word 19765)) *)
  ...
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x38; 0x49; 0x00; 0x00;
                           (* CALL (Imm32 (word 18744)) *)
  0x48; 0x8d; 0x74; 0x24; 0x20;
                           (* LEA (% rsi) (%% (rsp,32)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x29; 0x49; 0x00; 0x00;
                           (* CALL (Imm32 (word 18729)) *)
  0x48; 0x8d; 0x74; 0x24; 0x20;
                           (* LEA (% rsi) (%% (rsp,32)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x1a; 0x49; 0x00; 0x00;
                           (* CALL (Imm32 (word 18714)) *)
  0x48; 0x8d; 0x74; 0x24; 0x20;
                           (* LEA (% rsi) (%% (rsp,32)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x0b; 0x49; 0x00; 0x00;
                           (* CALL (Imm32 (word 18699)) *)
  ...
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x34; 0x1d; 0x00; 0x00;
                           (* CALL (Imm32 (word 7476)) *)
  0x48; 0x85; 0xed;        (* TEST (% rbp) (% rbp) *)
...
let LOCAL_DEMONT_TAC =
  X86_SUBROUTINE_SIM_TAC
   (p256_scalarmul_alt_mc,P256_SCALARMUL_ALT_EXEC,
    0xb96,bignum_demont_p256_alt_mc,BIGNUM_DEMONT_P256_ALT_SUBROUTINE_CORRECT)
...
let LOCAL_INV_TAC =
  X86_SUBROUTINE_SIM_TAC
   (p256_scalarmul_alt_mc,P256_SCALARMUL_ALT_EXEC,
    0xc55,bignum_inv_p256_mc,BIGNUM_INV_P256_SUBROUTINE_CORRECT)
  [`read RDI s`; `read RSI s`;
   `read(memory :> bytes(read RSI s,8 * 4)) s`;
...
let LOCAL_TOMONT_TAC =
  X86_SUBROUTINE_SIM_TAC
   (p256_scalarmul_alt_mc,P256_SCALARMUL_ALT_EXEC,
    0x25cc,bignum_tomont_p256_alt_mc,BIGNUM_TOMONT_P256_ALT_SUBROUTINE_CORRECT)
  [`read RDI s`; `read RSI s`;
   `read(memory :> bytes(read RSI s,8 * 4)) s`;
...
let LOCAL_JMIXADD_TAC =
  ...
  [`read RDI s`; `read RSI s`;
   ...
   `read(memory :> bytes(read RDX s,8 * 4)) s,
    read(memory :> bytes(word_add (read RDX s) (word 32),8 * 4)) s`;
   `pc + 0x643d`; `read RSP s`; `read (memory :> bytes64(read RSP s)) s`];;
 ...
 (`!res scalar point n xy pc stackpointer.
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    X86_ACCSTEPS_TAC P256_SCALARMUL_ALT_EXEC [8;10;12;14] (1--18) THEN
    ...
    X86_ACCSTEPS_TAC P256_SCALARMUL_ALT_EXEC (19--22) (19--28) THEN
    MAP_EVERY REABBREV_TAC
     [`nn_0 = read R8 s28`;
      `nn_1 = read R9 s28`;
      `nn_2 = read R10 s28`;
    ...
    X86_ACCSTEPS_TAC P256_SCALARMUL_ALT_EXEC (30--33) (29--38) THEN
    SUBGOAL_THEN
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (39--41) THEN LOCAL_TOMONT_TAC 42 THEN
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (43--45) THEN LOCAL_TOMONT_TAC 46 THEN
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (47--54) THEN
    SUBGOAL_THEN
    ...
    X86_ACCSTEPS_TAC P256_SCALARMUL_ALT_EXEC (64--67) (55--76) THEN
    SUBGOAL_THEN
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (77--79) THEN LOCAL_JDOUBLE_TAC 80 THEN
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (81--84) THEN LOCAL_JMIXADD_TAC 85 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (86--88) THEN LOCAL_JDOUBLE_TAC 89 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (90--93) THEN LOCAL_JMIXADD_TAC 94 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (95--97) THEN LOCAL_JDOUBLE_TAC 98 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (99--102) THEN LOCAL_JMIXADD_TAC 103 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (104--106) THEN LOCAL_JDOUBLE_TAC 107 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (108--109) THEN
    SUBGOAL_THEN
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (110--238) THEN
    ...
    REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (1--4) THEN
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (6--8) THEN LOCAL_JDOUBLE_TAC 9 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (10--12) THEN LOCAL_JDOUBLE_TAC 13 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (14--16) THEN LOCAL_JDOUBLE_TAC 17 THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (18--27) THEN
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (28--143) THEN
    MAP_EVERY REABBREV_TAC
     [`tab0 = read RAX s143`;
      `tab1 = read RBX s143`;
      `tab2 = read RCX s143`;
    ...
    X86_ACCSTEPS_TAC P256_SCALARMUL_ALT_EXEC (153--156) (144--169) THEN
    MAP_EVERY ABBREV_TAC
    ...
    X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (170--173) THEN LOCAL_JADD_TAC 174 THEN
    MAP_EVERY ABBREV_TAC
    ...
    CONV_TAC NUM_REDUCE_CONV THEN
    X86_SIM_TAC P256_SCALARMUL_ALT_EXEC (1--2) THEN
  ...
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (1--5) THEN LOCAL_SQR_TAC 6 THEN
  ABBREV_TAC
   `Z2 = read(memory :> bytes(word_add stackpointer (word 520),8 * 4)) s6` THEN
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (7--10) THEN LOCAL_MUL_TAC 11 THEN
  ABBREV_TAC
   `Z3 =
    read(memory :> bytes(word_add stackpointer (word 552),8 * 4)) s11` THEN
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (12--14) THEN LOCAL_DEMONT_TAC 15 THEN
  ABBREV_TAC
   `Z3' =
    read(memory :> bytes(word_add stackpointer (word 520),8 * 4)) s15` THEN
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (16--18) THEN LOCAL_INV_TAC 19 THEN
  ABBREV_TAC
   `I3 =
    read(memory :> bytes (word_add stackpointer (word 552),8 * 4)) s19` THEN
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (20--23) THEN LOCAL_MUL_TAC 24 THEN
  ABBREV_TAC
   `I2 =
    read (memory :> bytes (word_add stackpointer (word 520),8 * 4)) s24` THEN
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (25--29) THEN LOCAL_MUL_TAC 30 THEN
  ABBREV_TAC `X' = read (memory :> bytes (res,8 * 4)) s30` THEN
  X86_STEPS_TAC P256_SCALARMUL_ALT_EXEC (31--34) THEN LOCAL_MUL_TAC 35 THEN
  ABBREV_TAC
...
let WINDOWS_P256_SCALARMUL_ALT_SUBROUTINE_CORRECT = time prove
 (`!res scalar point n xy pc stackpointer returnaddress.
  ...
  let WINDOWS_P256_SCALARMUL_ALT_EXEC =
   ...
   and th =
    CONV_RULE(ONCE_DEPTH_CONV NUM_MULT_CONV)
     (REWRITE_RULE[bignum_pair_from_memory] P256_SCALARMUL_ALT_SUBROUTINE_CORRECT) in
