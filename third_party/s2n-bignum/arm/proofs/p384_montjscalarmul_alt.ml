...
needs "arm/proofs/p384_montjadd_alt.ml";;
needs "arm/proofs/p384_montjdouble_alt.ml";;

(* ------------------------------------------------------------------------- *)
(* Code.                                                                     *)
(* ------------------------------------------------------------------------- *)

(**** print_literal_from_elf "arm/p384/p384_montjscalarmul_alt.o";;
 ****)

let p384_montjscalarmul_alt_mc = define_assert_from_elf
  "p384_montjscalarmul_alt_mc" "arm/p384/p384_montjscalarmul_alt.o"
[
  ...
  0x9400135d;       (* arm_BL (word 19828) *)
  0x9100c3e0;       (* arm_ADD X0 SP (rvalue (word 48)) *)
  0x9100c3e1;       (* arm_ADD X1 SP (rvalue (word 48)) *)
  0x9400135a;       (* arm_BL (word 19816) *)
  0x9100c3e0;       (* arm_ADD X0 SP (rvalue (word 48)) *)
  0x9100c3e1;       (* arm_ADD X1 SP (rvalue (word 48)) *)
  0x94001357;       (* arm_BL (word 19804) *)
  0x9100c3e0;       (* arm_ADD X0 SP (rvalue (word 48)) *)
  0x9100c3e1;       (* arm_ADD X1 SP (rvalue (word 48)) *)
  0x94001354;       (* arm_BL (word 19792) *)
  0x9100c3e0;       (* arm_ADD X0 SP (rvalue (word 48)) *)
  0x9100c3e1;       (* arm_ADD X1 SP (rvalue (word 48)) *)
  0x94001351;       (* arm_BL (word 19780) *)
  0xa94007e0;       (* arm_LDP X0 X1 SP (Immediate_Offset (iword (&0))) *)
  0xa9410fe2;       (* arm_LDP X2 X3 SP (Immediate_Offset (iword (&16))) *)
  0xa94217e4;       (* arm_LDP X4 X5 SP (Immediate_Offset (iword (&32))) *)
...
let P384_MONTJSCALARMUL_ALT_EXEC = ARM_MK_EXEC_RULE p384_montjscalarmul_alt_mc;;
  ...
  let th =
    CONV_RULE(ONCE_DEPTH_CONV NUM_MULT_CONV)
      (REWRITE_RULE[bignum_triple_from_memory; bignum_pair_from_memory]
       P384_MONTJADD_ALT_SUBROUTINE_CORRECT) in
...
let LOCAL_JDOUBLE_TAC =
  let th =
    CONV_RULE(ONCE_DEPTH_CONV NUM_MULT_CONV)
      (REWRITE_RULE[bignum_triple_from_memory; bignum_pair_from_memory]
       P384_MONTJDOUBLE_ALT_SUBROUTINE_CORRECT) in
  ARM_SUBROUTINE_SIM_TAC
   (p384_montjscalarmul_alt_mc,P384_MONTJSCALARMUL_ALT_EXEC,
  ...
  [`read X0 s`; `read X1 s`;
   `read(memory :> bytes(read X1 s,8 * 6)) s,
    read(memory :> bytes(word_add (read X1 s) (word 48),8 * 6)) s,
    read(memory :> bytes(word_add (read X1 s) (word 96),8 * 6)) s`;
   `pc + 0x574c`; `read SP s`; `read X30 s`];;
 ...
 (`!res scalar point n xyz pc stackpointer.
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    ARM_ACCSTEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC (17--22) (1--31) THEN
    SUBGOAL_THEN
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC (32--49) THEN
    SUBGOAL_THEN
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC (50--52) THEN
    ...
    ARM_ACCSTEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC (135--144) THEN
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC (145--637) THEN
    ...
    ARM_SIM_TAC P384_MONTJSCALARMUL_ALT_EXEC [1] THEN
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_ALT_EXEC (1--19) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV) THEN ASM_REWRITE_TAC[] THEN
