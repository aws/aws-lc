...
(**** print_literal_from_elf "arm/sm2/bignum_montinv_sm2.o";;
 ****)

let bignum_montinv_sm2_mc = define_assert_from_elf "bignum_montinv_sm2_mc" "arm/sm2/bignum_montinv_sm2.o"
[
  ...
  0xa90137ea;       (* arm_STP X10 X13 SP (Immediate_Offset (iword (&16))) *)
  0xf90013ff;       (* arm_STR XZR SP (Immediate_Offset (word 32)) *)
  0xa9400c22;       (* arm_LDP X2 X3 X1 (Immediate_Offset (iword (&0))) *)
  0xb100044a;       (* arm_ADDS X10 X2 (rvalue (word 1)) *)
  0xfa0b006b;       (* arm_SBCS X11 X3 X11 *)
  0xa9411424;       (* arm_LDP X4 X5 X1 (Immediate_Offset (iword (&16))) *)
  0xba1f008c;       (* arm_ADCS X12 X4 XZR *)
  ...
  0xd2a0020a;       (* arm_MOVZ X10 (word 16) 16 *)
  0xb24e054a;       (* arm_ORR X10 X10 (rvalue (word 3377699720527872)) *)
  0xd2e0018b;       (* arm_MOVZ X11 (word 12) 48 *)
  0xd142016b;       (* arm_SUB X11 X11 (rvalue (word 524288)) *)
  0xa9082fea;       (* arm_STP X10 X11 SP (Immediate_Offset (iword (&128))) *)
  0xd2e0008c;       (* arm_MOVZ X12 (word 4) 48 *)
  0xb26e058c;       (* arm_ORR X12 X12 (rvalue (word 786432)) *)
  0xd2e0030d;       (* arm_MOVZ X13 (word 24) 48 *)
  0xb26e01ad;       (* arm_ORR X13 X13 (rvalue (word 262144)) *)
  ...
  0x92fc000b;       (* arm_MOVN X11 (word 57344) 48 *)
  0xba0b0021;       (* arm_ADCS X1 X1 X11 *)
  0xb2638bea;       (* arm_MOV X10 (rvalue (word 18446744073172680704)) *)
  0xba0a00c6;       (* arm_ADCS X6 X6 X10 *)
  0xfa1f00a5;       (* arm_SBCS X5 X5 XZR *)
  0x9262f96e;       (* arm_AND X14 X11 (rvalue (word 18446744073172680703)) *)
  0x9a0e0063;       (* arm_ADC X3 X3 X14 *)
  0xd3607c0a;       (* arm_LSL X10 X0 32 *)
  0xd360fc18;       (* arm_LSR X24 X0 32 *)
  0xeb00014e;       (* arm_SUBS X14 X10 X0 *)
  0xda1f030b;       (* arm_SBC X11 X24 XZR *)
  0xeb0e0021;       (* arm_SUBS X1 X1 X14 *)
  0xfa0b00c6;       (* arm_SBCS X6 X6 X11 *)
  0xfa0a00a5;       (* arm_SBCS X5 X5 X10 *)
  0xda18000e;       (* arm_SBC X14 X0 X24 *)
  0xab0e0063;       (* arm_ADDS X3 X3 X14 *)
  0xda9f33ee;       (* arm_CSETM X14 Condition_CS *)
  0xeb0e0021;       (* arm_SUBS X1 X1 X14 *)
  0x92607dcb;       (* arm_AND X11 X14 (rvalue (word 18446744069414584320)) *)
  0xfa0b00c6;       (* arm_SBCS X6 X6 X11 *)
  0x925ff9ca;       (* arm_AND X10 X14 (rvalue (word 18446744069414584319)) *)
  0xfa0e00a5;       (* arm_SBCS X5 X5 X14 *)
  ...
  0x54ff8e41;       (* arm_BNE (word 2093512) *)
  ...
  0xda0a0063;       (* arm_SBC X3 X3 X10 *)
  0x9280000a;       (* arm_MOVN X10 (word 0) 0 *)
  0xb100042a;       (* arm_ADDS X10 X1 (rvalue (word 1)) *)
  0xb2607feb;       (* arm_MOV X11 (rvalue (word 18446744069414584320)) *)
...
let BIGNUM_MONTINV_SM2_EXEC = ARM_MK_EXEC_RULE bignum_montinv_sm2_mc;;
...
let CORE_MONTINV_SM2_EXEC =
    ARM_MK_EXEC_RULE
     ((GEN_REWRITE_CONV RAND_CONV [bignum_montinv_sm2_mc] THENC TRIM_LIST_CONV)
      `TRIM_LIST (16,20) bignum_montinv_sm2_mc`);;
...
let PACKED_DIVSTEP_TAC n shf s =
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (s--s') THEN
  SUBGOAL_THEN
 ...
 (`!d f g pc.
       ensures arm
        (\s. aligned_bytes_loaded s (word pc)
                 (TRIM_LIST (16,20) bignum_montinv_sm2_mc) /\
             read PC s = word(pc + 0x548) /\
             read X1 s = d /\
             read X2 s = f /\
             read X3 s = g)
        (\s. read PC s = word(pc + 0xebc) /\
             (ival d rem &2 = &1 /\
              ival f rem &2 = &1 /\
              abs(ival d) < &2 pow 62 ==>
  ...
  ASM_CASES_TAC `d rem &2 = &1 /\ f rem &2 = &1 /\ abs(d:int) < &2 pow 62` THENL
   [FIRST_X_ASSUM(CONJUNCTS_THEN STRIP_ASSUME_TAC) THEN ASM_REWRITE_TAC[];
    ARM_QUICKSIM_TAC CORE_MONTINV_SM2_EXEC [`read X0 s = x`] (1--605)] THEN

  (*** The first packing ***)

  ENSURES_INIT_TAC "s0" THEN
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (1--5) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (185--194) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (195--202) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (203--207) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[DIVSTEP_FGVEC_PACK]) THEN
  FIRST_X_ASSUM(MP_TAC o SPEC `iword(divstep_dvec 0 (d,f,g)):int64` o
    MATCH_MP(MESON[] `read X1 s = a ==> !x. a = x ==> read X1 s = x`)) THEN
  ANTS_TAC THENL [REWRITE_TAC[divstep_dvec; DIVSTEP_D]; DISCH_TAC] THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (387--396) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[DIVSTEP_MAT_UNPACK_20]) THEN
  RULE_ASSUM_TAC(SIMP_RULE
   [DIVSTEP_MAT_MOD; divstep_dvec; DIVSTEP_D_MOD; ARITH_LE; ARITH_LT]) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (397--404) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_RULE
   `word(0 + val(iword(--x):int64) * val(iword g:int64)):int64 =
    iword(--(x * g))`]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[word_ishr; GSYM IWORD_INT_ADD]) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (405--409) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[DIVSTEP_FGVEC_PACK]) THEN
  FIRST_X_ASSUM(MP_TAC o SPEC `iword(divstep_dvec 0 (d,f,g)):int64` o
    MATCH_MP(MESON[] `read X1 s = a ==> !x. a = x ==> read X1 s = x`)) THEN
  ANTS_TAC THENL [REWRITE_TAC[divstep_dvec; DIVSTEP_D]; DISCH_TAC] THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (500--507) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (588--597) THEN
  ...
  ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (598--605) THEN
...
let CORE_MONTINV_SM2_CORRECT = time prove
 (`!z x n pc stackpointer.
        ...
        ALL (nonoverlapping (stackpointer,160))
            [(word pc,0x10a4); (z,8 * 4); (x,8 * 4)] /\
        nonoverlapping (word pc,0x10a4) (z,8 * 4)
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc)
                   (TRIM_LIST (16,20) bignum_montinv_sm2_mc) /\
                  read PC s = word pc /\
  ...
  ENSURES_WHILE_UP_TAC `9` `pc + 0x53c` `pc + 0x53c`
   `\i s.
      read SP s = stackpointer /\
      read X20 s = z /\
      ...
      (&2 pow (562 - 5 * i) * divstep_f (59 * i) t ==
       &n * &(read (memory :> bytes(word_add stackpointer (word 96),8 * 4)) s))
      (mod (&p_sm2)) /\
      (&2 pow (562 - 5 * i) * divstep_g (59 * i) t ==
  ...
  THEN REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    ARM_ACCSTEPS_TAC CORE_MONTINV_SM2_EXEC
     [9;10;12;13] (1--35) THEN
    ...
    REWRITE_TAC[INT_REM_REM; INT_MUL_RID; GSYM p_sm2] THEN
    ...
    SUBGOAL_THEN `carry_s13 <=> n < p_sm2` (SUBST1_TAC o SYM) THENL
    ...
    ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (5--7) THEN
    SUBGOAL_THEN
    ...
    ARM_STEPS_TAC CORE_MONTINV_SM2_EXEC (8--19) THEN
    ...
    ARM_ACCSTEPS_TAC CORE_MONTINV_SM2_EXEC [22;25] (20--25) THEN
    ...
    ARM_ACCSTEPS_TAC CORE_MONTINV_SM2_EXEC
     [150;152;153;156;158;160;162;164;165;167;169;171;174;176;
      ...
      235;239;241;243;244;246;248;249;250;251;252;253;254;255;
      257;259;261;262;268;270;271;274;275;277;278;282;284;286;
      287;289;291;292;293;294;295;296;297;298;300;302;304;305]
     (148--307) THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`uup = bignum_of_wordlist
      ...
      `vup = bignum_of_wordlist
              [sum_s169;sum_s193;sum_s217;sum_s277;sum_s278]`] THEN
    ...
    ASM_REWRITE_TAC[] THEN DISCARD_STATE_TAC "s307" THEN
    ...
    ABBREV_TAC
     `upos =
      bignum_of_wordlist[sum_s239;sum_s241;sum_s243;sum_s244;sum_s246]` THEN
    SUBGOAL_THEN
    ...
    SUBGOAL_THEN
     `(&2 pow 64 *
       &(bignum_of_wordlist[sum_s257; sum_s259; sum_s261; sum_s262]):int ==
       m00 * &u + m01 * &v) (mod &p_sm2)`
    ASSUME_TAC THENL
     [FIRST_X_ASSUM(MATCH_MP_TAC o MATCH_MP (REWRITE_RULE[IMP_CONJ_ALT]
          INT_CONG_TRANS)) THEN
      MATCH_MP_TAC INT_CONG_TRANS THEN EXISTS_TAC
       `if &upos + &(val(sum_s239:int64)) * &p_sm2:int < &2 pow 320
        then &upos + &(val sum_s239) * &p_sm2:int
        else (&upos + &(val sum_s239) * &p_sm2) - &2 pow 64 * &p_sm2` THEN
      ...
      SUBST1_TAC THENL
       [REWRITE_TAC[INT_OF_NUM_CLAUSES] THEN CONV_TAC SYM_CONV THEN
        ...
        REWRITE_TAC[REAL_POW_EQ_0; ARITH_EQ; REAL_OF_NUM_EQ] THEN
        ACCUMULATOR_POP_ASSUM_LIST(MP_TAC o end_itlist CONJ o
            rev o fst o chop_list 12 o snd o chop_list 50 o rev) THEN
        ...
        DISCH_THEN(fun th ->
          MP_TAC(end_itlist CONJ (DESUM_RULE (CONJUNCTS th))) THEN
          DISCH_THEN(fun th -> REWRITE_TAC[th]) THEN
          CONV_TAC(RAND_CONV REAL_POLY_CONV) THEN MP_TAC th) THEN
        DISCH_THEN(MP_TAC o end_itlist CONJ o DECARRY_RULE o CONJUNCTS) THEN
    ...
    ABBREV_TAC
     `vpos =
      bignum_of_wordlist[sum_s282;sum_s284;sum_s286;sum_s287;sum_s289]` THEN
    SUBGOAL_THEN
    ...
    STRIP_ASSUME_TAC THENL
     [REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN
      ...
      ACCUMULATOR_POP_ASSUM_LIST(MP_TAC o end_itlist CONJ o
          fst o chop_list 5 o snd o chop_list 69 o rev) THEN
      REWRITE_TAC[REAL_BITVAL_NOT; bignum_of_wordlist; p_sm2;
                  GSYM REAL_OF_NUM_CLAUSES] THEN
      DISCH_THEN(MP_TAC o end_itlist CONJ o DESUM_RULE o CONJUNCTS) THEN
      DISCH_THEN(fun th -> REWRITE_TAC[th]) THEN REAL_INTEGER_TAC;
    ...
    SUBGOAL_THEN
     `(&2 pow 64 *
       &(bignum_of_wordlist[sum_s300; sum_s302; sum_s304; sum_s305]):int ==
       m10 * &u + m11 * &v) (mod &p_sm2)`
    ASSUME_TAC THENL
     [FIRST_X_ASSUM(MATCH_MP_TAC o MATCH_MP (REWRITE_RULE[IMP_CONJ_ALT]
          INT_CONG_TRANS)) THEN
      MATCH_MP_TAC INT_CONG_TRANS THEN EXISTS_TAC
       `if &vpos + &(val(sum_s282:int64)) * &p_sm2:int < &2 pow 320
        then &vpos + &(val sum_s282) * &p_sm2:int
        else (&vpos + &(val sum_s282) * &p_sm2) - &2 pow 64 * &p_sm2` THEN
      CONJ_TAC THENL [ALL_TAC; COND_CASES_TAC THEN CONV_TAC INTEGER_RULE] THEN
      MATCH_MP_TAC INT_EQ_IMP_CONG THEN
      MATCH_MP_TAC INT_CONG_IMP_EQ THEN EXISTS_TAC `(&2:int) pow 320` THEN
      CONJ_TAC THENL
       [REWRITE_TAC[bignum_of_wordlist; GSYM INT_OF_NUM_CLAUSES] THEN
        ...
        ALL_TAC] THEN
      SUBGOAL_THEN
       `&vpos + &(val(sum_s282:int64)) * &p_sm2:int < &2 pow 320 <=>
        ~carry_s298`
      SUBST1_TAC THENL
       [REWRITE_TAC[INT_OF_NUM_CLAUSES] THEN CONV_TAC SYM_CONV THEN
        MATCH_MP_TAC FLAG_FROM_CARRY_LT THEN EXISTS_TAC `320` THEN
        ACCUMULATOR_POP_ASSUM_LIST(MP_TAC o end_itlist CONJ o
            rev o fst o chop_list 9 o snd o chop_list 73 o rev) THEN
        ...
        REWRITE_TAC[REAL_POW_EQ_0; ARITH_EQ; REAL_OF_NUM_EQ] THEN
        ACCUMULATOR_POP_ASSUM_LIST(MP_TAC o end_itlist CONJ o
            rev o fst o chop_list 13 o snd o chop_list 73 o rev) THEN
        REWRITE_TAC[COND_SWAP] THEN COND_CASES_TAC THEN
        ASM_REWRITE_TAC[BITVAL_CLAUSES; GSYM REAL_OF_INT_CLAUSES] THEN
        EXPAND_TAC "vpos" THEN
        REWRITE_TAC[REAL_BITVAL_NOT; bignum_of_wordlist;
    ...
    X_GEN_TAC `i:num` THEN STRIP_TAC THEN
    ARM_SIM_TAC CORE_MONTINV_SM2_EXEC [] THEN ASM_REWRITE_TAC[];
  ...
  ARM_ACCSTEPS_TAC CORE_MONTINV_SM2_EXEC
   [31;34;36;37;40;42;44;47;49;50;53;55;57;60;62;63;
    66;68;70;75;77;78;82;83;85;86;
    90;92;94;95;97;99;100;101;102;103;104;105;106;
    108;110;112;113;115;117;119;120]
   (5--126) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC(LAND_CONV(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV)) THEN
  ASM_REWRITE_TAC[] THEN DISCARD_STATE_TAC "s126" THEN
  ...
  ABBREV_TAC
   `upos =
    bignum_of_wordlist[sum_s90;sum_s92;sum_s94;sum_s95;sum_s97]` THEN
  SUBGOAL_THEN
   `upos < 2 EXP 318 /\
  ...
  SUBGOAL_THEN
   `(&2 pow 64 *
     &(bignum_of_wordlist[sum_s108; sum_s110; sum_s112; sum_s113]):int ==
  ...
  ABBREV_TAC
   `pra = bignum_of_wordlist[sum_s108;sum_s110;sum_s112;sum_s113]` THEN
  TRANS_TAC EQ_TRANS `&(pra MOD p_sm2):int` THEN CONJ_TAC THENL
   [REWRITE_TAC[INT_OF_NUM_CLAUSES] THEN CONV_TAC SYM_CONV THEN
    ...
    RULE_ASSUM_TAC(REWRITE_RULE[REAL_BITVAL_NOT]) THEN
    SUBGOAL_THEN `carry_s120 <=> pra < p_sm2` (SUBST1_TAC o SYM) THENL
     [MATCH_MP_TAC FLAG_FROM_CARRY_LT THEN EXISTS_TAC `256` THEN
      EXPAND_TAC "pra" THEN
      REWRITE_TAC[bignum_of_wordlist; MULT_CLAUSES; ADD_CLAUSES] THEN
      REWRITE_TAC[GSYM REAL_OF_NUM_EQ; GSYM REAL_OF_NUM_ADD; p_sm2;
...
let BIGNUM_MONTINV_SM2_CORRECT = time prove
 (`!z x n pc stackpointer.
        aligned 16 stackpointer /\
        ALL (nonoverlapping (stackpointer,160))
            [(word pc,0x10c8); (z,8 * 4); (x,8 * 4)] /\
        nonoverlapping (word pc,0x10c8) (z,8 * 4)
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) bignum_montinv_sm2_mc /\
                  read PC s = word(pc + 0x10) /\
                  read SP s = stackpointer /\
                  C_ARGUMENTS [z; x] s /\
                  bignum_from_memory (x,4) s = n)
             (\s. read PC s = word (pc + 0x10b4) /\
                  bignum_from_memory(z,4) s =
                  (if p_sm2 divides n then 0
                   else (2 EXP 512 * inverse_mod p_sm2 n) MOD p_sm2))
          (MAYCHANGE [PC; X0; X1; X2; X3; X4; X5; X6; X7; X8; X9;
  ...
  ARM_SUBROUTINE_SIM_TAC
      (bignum_montinv_sm2_mc,BIGNUM_MONTINV_SM2_EXEC,0x10,
       (GEN_REWRITE_CONV RAND_CONV [bignum_montinv_sm2_mc] THENC TRIM_LIST_CONV)
       `TRIM_LIST (16,20) bignum_montinv_sm2_mc`,
