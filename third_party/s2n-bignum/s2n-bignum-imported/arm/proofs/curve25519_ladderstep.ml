...
let LOCAL_MUL_P25519_TAC =
  ARM_MACRO_SIM_ABBREV_TAC curve25519_ladderstep_mc 180 lvs
   `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
      ...
      nonoverlapping (word pc,0x192c) (word_add (read p3 t) (word n3),8 * 4)
      ==> ensures arm
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [9;11;12;14] (1--14) THEN
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [34;36;37;39] (26--39) THEN
  RULE_ASSUM_TAC(REWRITE_RULE
   [VAL_WORD_MADDL_0; VAL_WORD_USHR; VAL_WORD_SHL;
    DIVMOD_32_32; DIMINDEX_64]) THEN
  SUBGOAL_THEN
  ...
  ARM_STEPS_TAC CURVE25519_LADDERSTEP_EXEC (113--137) THEN
  ...
  STRIP_TAC THEN
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [142;144;146;150] (138--150) THEN
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC (154--157) (151--160) THEN
...
let LOCAL_SQR_P25519_TAC =
  ARM_MACRO_SIM_ABBREV_TAC curve25519_ladderstep_mc 138 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [47;48;51;53] (47--53) THEN
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC (54--57) (54--57) THEN
  SUBGOAL_THEN
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC (80--90) (80--90) THEN
  RULE_ASSUM_TAC(REWRITE_RULE
  ...
  ARM_STEPS_TAC CURVE25519_LADDERSTEP_EXEC (91--115) THEN
  ...
  SIMP_TAC[MOD_LT; VAL_BOUND_64; ARITH_RULE
   `n < 2 EXP 64 ==> n MOD 2 EXP 32 * 38 < 2 EXP 64`] THEN
  STRIP_TAC THEN
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [120;122;124;128] (116--128) THEN
  SUBGOAL_THEN `word_ushr u7 31:int64 = word q` SUBST_ALL_TAC THENL
   [REWRITE_TAC[GSYM VAL_EQ; VAL_WORD; VAL_WORD_USHR] THEN
    ASM_SIMP_TAC[DIMINDEX_64; MOD_LT] THEN SUBST1_TAC(SYM(ASSUME
  ...
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC (132--135) (129--138) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  REWRITE_TAC[REAL_OF_NUM_CLAUSES] THEN CONV_TAC SYM_CONV THEN
  MATCH_MP_TAC EQUAL_FROM_CONGRUENT_MOD_MOD THEN
  MAP_EVERY EXISTS_TAC
...
let LOCAL_MUL_4_TAC =
  ARM_MACRO_SIM_ABBREV_TAC curve25519_ladderstep_mc 172 lvs
   `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
      !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  SIMP_TAC[MOD_LT; VAL_BOUND_64; ARITH_RULE
   `n < 2 EXP 64 ==> n MOD 2 EXP 32 * 38 < 2 EXP 64`] THEN
  STRIP_TAC THEN
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [142;144;146;150] (138--152) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let LOCAL_SQR_4_TAC =
  ARM_MACRO_SIM_ABBREV_TAC curve25519_ladderstep_mc 130 lvs
   `!(t:armstate) pcin pcout p3 n3 p1 n1.
      !n.
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  SIMP_TAC[MOD_LT; VAL_BOUND_64; ARITH_RULE
   `n < 2 EXP 64 ==> n MOD 2 EXP 32 * 38 < 2 EXP 64`] THEN
  STRIP_TAC THEN
  ARM_ACCSTEPS_TAC CURVE25519_LADDERSTEP_EXEC [120;122;124;128] (116--130) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV) THEN ASM_REWRITE_TAC[] THEN
  ...
  ARM_MACRO_SIM_ABBREV_TAC curve25519_ladderstep_mc 16 lvs
   `!(t:armstate) pcin pcout p3 n3 p4 n4 p1 n1 p2 n2.
     ...
     !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
      ==>
      aligned 16 (read SP t) /\
      nonoverlapping (word pc,0x192c) (rr:int64,8 * 16) /\
...
let CURVE25519_LADDERSTEP_CORRECT = time prove
 (`!rr point P pp Pm Pn b pc stackpointer.
    ...
    ALLPAIRS nonoverlapping
     ...
     [(word pc,0x192c); (point,64); (pp,128)] /\
