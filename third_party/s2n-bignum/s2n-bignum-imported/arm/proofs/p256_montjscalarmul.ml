...
[
  ...
  0x94000d17;       (* arm_BL (word 13404) *)
  0x910083e0;       (* arm_ADD X0 SP (rvalue (word 32)) *)
  0x910083e1;       (* arm_ADD X1 SP (rvalue (word 32)) *)
  0x94000d14;       (* arm_BL (word 13392) *)
  0x910083e0;       (* arm_ADD X0 SP (rvalue (word 32)) *)
  0x910083e1;       (* arm_ADD X1 SP (rvalue (word 32)) *)
  0x94000d11;       (* arm_BL (word 13380) *)
  0x910083e0;       (* arm_ADD X0 SP (rvalue (word 32)) *)
  0x910083e1;       (* arm_ADD X1 SP (rvalue (word 32)) *)
  0x94000d0e;       (* arm_BL (word 13368) *)
...
let LOCAL_JDOUBLE_TAC =
  ...
  [`read X0 s`; `read X1 s`;
   `read(memory :> bytes(read X1 s,8 * 4)) s,
    read(memory :> bytes(word_add (read X1 s) (word 32),8 * 4)) s,
    read(memory :> bytes(word_add (read X1 s) (word 64),8 * 4)) s`;
   `pc + 0x38bc`; `read SP s`; `read X30 s`];;
...
let P256_MONTJSCALARMUL_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer.
        ...
        ALL (nonoverlapping (stackpointer,1296))
            [(word pc,0x5050); (res,96); (scalar,32); (point,96)] /\
        nonoverlapping (res,96) (word pc,0x5050)
        ==> ensures arm
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    SUBGOAL_THEN
     `read(memory :> bytes(word_add stackpointer (word 528),8 * 4)) s68 = x /\
      read(memory :> bytes(word_add stackpointer (word 592),8 * 4)) s68 = z`
    ...
    ABBREV_TAC
     `y'' = read (memory :> bytes(word_add stackpointer (word 560),8 * 4))
                 s68` THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x2 = read (memory :> bytes(word_add stackpointer (word 624),8 * 4)) s72`;
      `y2 = read (memory :> bytes(word_add stackpointer (word 656),8 * 4)) s72`;
      `z2 = read (memory :> bytes(word_add stackpointer (word 688),8 * 4)) s72`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x3 = read (memory :> bytes(word_add stackpointer (word 720),8 * 4)) s77`;
      `y3 = read (memory :> bytes(word_add stackpointer (word 752),8 * 4)) s77`;
      `z3 = read (memory :> bytes(word_add stackpointer (word 784),8 * 4)) s77`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x4 = read (memory :> bytes(word_add stackpointer (word 816),8 * 4)) s81`;
      `y4 = read (memory :> bytes(word_add stackpointer (word 848),8 * 4)) s81`;
      `z4 = read (memory :> bytes(word_add stackpointer (word 880),8 * 4)) s81`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x5 = read (memory :> bytes(word_add stackpointer (word 912),8 * 4)) s86`;
      `y5 = read (memory :> bytes(word_add stackpointer (word 944),8 * 4)) s86`;
      `z5 = read (memory :> bytes(word_add stackpointer (word 976),8 * 4)) s86`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x6 = read (memory :> bytes(word_add stackpointer (word 1008),8 * 4)) s90`;
      `y6 = read (memory :> bytes(word_add stackpointer (word 1040),8 * 4)) s90`;
      `z6 = read (memory :> bytes(word_add stackpointer (word 1072),8 * 4)) s90`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x7 = read (memory :> bytes(word_add stackpointer (word 1104),8 * 4)) s95`;
      `y7 = read (memory :> bytes(word_add stackpointer (word 1136),8 * 4)) s95`;
      `z7 = read (memory :> bytes(word_add stackpointer (word 1168),8 * 4)) s95`
     ] THEN
    ...
    MAP_EVERY ABBREV_TAC
     [`x8 = read (memory :> bytes(word_add stackpointer (word 1200),8 * 4)) s99`;
      `y8 = read (memory :> bytes(word_add stackpointer (word 1232),8 * 4)) s99`;
      `z8 = read (memory :> bytes(word_add stackpointer (word 1264),8 * 4)) s99`
     ] THEN
    ...
    BIGNUM_LDIGITIZE_TAC "fab_"
     `read(memory :> bytes(word_add stackpointer (word 528),8 * 96)) s101` THEN
    ...
    BIGNUM_LDIGITIZE_TAC "y_"
     `read (memory :> bytes(word_add stackpointer (word 368),8 * 4)) s0` THEN
    BIGNUM_LDIGITIZE_TAC "z_"
     `read (memory :> bytes(word_add stackpointer (word 400),8 * 4)) s0` THEN
  ...
  MAP_EVERY ABBREV_TAC
   [`Xt = read (memory :> bytes(word_add stackpointer (word 432),8 * 4)) s219`;
    `Yt = read (memory :> bytes(word_add stackpointer (word 464),8 * 4)) s219`;
    `Zt = read (memory :> bytes(word_add stackpointer (word 496),8 * 4)) s219`
   ] THEN
  SUBGOAL_THEN
   `!P. P IN group_carrier p256_group /\ y < p_256 /\ represents_p256 P (x,y',z)
  ...
  MAP_EVERY ABBREV_TAC
   [`X' = read (memory :> bytes(word_add stackpointer (word 336),8 * 4)) s224`;
    `Y' = read (memory :> bytes(word_add stackpointer (word 368),8 * 4)) s224`;
    `Z' = read (memory :> bytes(word_add stackpointer (word 400),8 * 4)) s224`
   ] THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
