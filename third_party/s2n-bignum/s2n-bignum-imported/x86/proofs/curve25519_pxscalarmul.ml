...
[
  ...
  0xc4; 0x62; 0xb3; 0xf6; 0x94; 0x24; 0x28; 0x01; 0x00; 0x00;
                           (* MULX4 (% r10,% r9) (% rdx,Memop Quadword (%% (rsp,296))) *)
  0xc4; 0x62; 0xa3; 0xf6; 0xa4; 0x24; 0x38; 0x01; 0x00; 0x00;
                           (* MULX4 (% r12,% r11) (% rdx,Memop Quadword (%% (rsp,312))) *)
  0x48; 0x8b; 0x94; 0x24; 0x30; 0x01; 0x00; 0x00;
                           (* MOV (% rdx) (Memop Quadword (%% (rsp,304))) *)
  0xc4; 0x62; 0x93; 0xf6; 0xb4; 0x24; 0x38; 0x01; 0x00; 0x00;
                           (* MULX4 (% r14,% r13) (% rdx,Memop Quadword (%% (rsp,312))) *)
  ...
  0xf3; 0x4c; 0x0f; 0x38; 0xf6; 0xd9;
                           (* ADOX (% r11) (% rcx) *)
  0xc4; 0xe2; 0xfb; 0xf6; 0x8c; 0x24; 0x28; 0x01; 0x00; 0x00;
                           (* MULX4 (% rcx,% rax) (% rdx,Memop Quadword (%% (rsp,296))) *)
  0x66; 0x4c; 0x0f; 0x38; 0xf6; 0xd8;
                           (* ADCX (% r11) (% rax) *)
  ...
  0xc4; 0x62; 0xbb; 0xf6; 0xfa;
                           (* MULX4 (% r15,% r8) (% rdx,% rdx) *)
  0xc4; 0x62; 0xb3; 0xf6; 0x94; 0x24; 0xc8; 0x00; 0x00; 0x00;
                           (* MULX4 (% r10,% r9) (% rdx,Memop Quadword (%% (rsp,200))) *)
  0xc4; 0x62; 0xa3; 0xf6; 0xa4; 0x24; 0xd8; 0x00; 0x00; 0x00;
                           (* MULX4 (% r12,% r11) (% rdx,Memop Quadword (%% (rsp,216))) *)
  0x48; 0x8b; 0x94; 0x24; 0xd0; 0x00; 0x00; 0x00;
                           (* MOV (% rdx) (Memop Quadword (%% (rsp,208))) *)
  0xc4; 0x62; 0x93; 0xf6; 0xb4; 0x24; 0xd8; 0x00; 0x00; 0x00;
                           (* MULX4 (% r14,% r13) (% rdx,Memop Quadword (%% (rsp,216))) *)
  0x31; 0xdb;              (* XOR (% ebx) (% ebx) *)
  0xc4; 0xe2; 0xfb; 0xf6; 0x8c; 0x24; 0xc0; 0x00; 0x00; 0x00;
                           (* MULX4 (% rcx,% rax) (% rdx,Memop Quadword (%% (rsp,192))) *)
  0x66; 0x4c; 0x0f; 0x38; 0xf6; 0xd0;
                           (* ADCX (% r10) (% rax) *)
  0xf3; 0x4c; 0x0f; 0x38; 0xf6; 0xd9;
                           (* ADOX (% r11) (% rcx) *)
  ...
  0x48; 0x89; 0x84; 0x24; 0x58; 0x01; 0x00; 0x00;
                           (* MOV (Memop Quadword (%% (rsp,344))) (% rax) *)
  0x0f; 0x83; 0x9e; 0xeb; 0xff; 0xff;
                           (* JAE (Imm32 (word 4294962078)) *)
...
let curve25519_pxscalarmul_tmc = define_trimmed "curve25519_pxscalarmul_tmc" curve25519_pxscalarmul_mc;;

let CURVE25519_PXSCALARMUL_EXEC =
  X86_MK_CORE_EXEC_RULE curve25519_pxscalarmul_tmc;;
...
let LOCAL_MUL_P25519_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 91 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      ...
      ==>
      nonoverlapping (word pc,0x161c) (word_add (read p3 t) (word n3),8 * 4)
      ==> ensures x86
           (\s. bytes_loaded s (word pc) (BUTLAST curve25519_pxscalarmul_tmc) /\
                read RIP s = pcin /\
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (2--56) (2--56) THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (57--71) (57--71) THEN
  ABBREV_TAC
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (72--75) THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC
...
let LOCAL_SQR_P25519_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 75 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--41) (1--41) THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (42--56) (42--56) THEN
  ABBREV_TAC
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (57--61) THEN
  ABBREV_TAC `t = bignum_of_wordlist
...
let LOCAL_MUL_5_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 75 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      ...
      !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
      ==>
      nonoverlapping (word pc,0x161c) (word_add (read p3 t) (word n3),8 * 5)
      ==> ensures x86
           (\s. bytes_loaded s (word pc) (BUTLAST curve25519_pxscalarmul_tmc) /\
                read RIP s = pcin /\
                read RSP s = read RSP t /\
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--55) (1--55) THEN
  MAP_EVERY ABBREV_TAC
  ...
  SUBST1_TAC THENL
   [ONCE_REWRITE_TAC[GSYM MOD_ADD_MOD] THEN
    ...
    REWRITE_TAC[p_25519] THEN CONV_TAC NUM_REDUCE_CONV;
    ALL_TAC] THEN
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (56--70) (56--75) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let LOCAL_SQR_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 68 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1.
      !n.
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (57--60) THEN
  ABBREV_TAC `hw:int64 = word_subword
    ((word_join:int64->int64->int128) sum_s56 sum_s54) (63,64)` THEN
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (61--64) (61--68) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let LOCAL_ADD_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 12 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC [2;5;8;11] (1--12) THEN
...
let LOCAL_ADD5_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 23 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m + n < 2 EXP 58 * 2 EXP 256` THENL
   [ASM_REWRITE_TAC[]; X86_SIM_TAC CURVE25519_PXSCALARMUL_EXEC (1--23)] THEN
  REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN

  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC [2;4;6;8;10] (1--10) THEN
  ABBREV_TAC
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (11--15) THEN
  ABBREV_TAC `hw:int64 = word_subword
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (16--19) (16--23) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  REWRITE_TAC[GSYM CONG; num_congruent] THEN
  REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN
  MATCH_MP_TAC(MESON[]
...
let LOCAL_SUB_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 17 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
...
let LOCAL_SUB_TWICE4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 19 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--10) (1--10) THEN
  SUBGOAL_THEN `carry_s10 <=> m < n` SUBST_ALL_TAC THENL
   [MATCH_MP_TAC FLAG_FROM_CARRY_LT THEN EXISTS_TAC `256` THEN
    ...
    ALL_TAC] THEN
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (12--15) (11--19) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN DISCH_TAC THEN
  MATCH_MP_TAC(MESON[INT_OF_NUM_LT]
   `!x':int. (x' == a) (mod p) /\ x' < &e /\ &x = x'
             ==> x < e /\ (&x:int == a) (mod p)`) THEN
...
let LOCAL_SUB5_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 29 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
      !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 5)) t = m
      ==>
      !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 5)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m < 39 * 2 EXP 256 /\ n < 39 * 2 EXP 256` THENL
   [ASM_REWRITE_TAC[]; X86_SIM_TAC CURVE25519_PXSCALARMUL_EXEC (1--29)] THEN
  REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (18--21) THEN
  ABBREV_TAC `hw:int64 = word_subword
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (22--25) (22--29) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  REWRITE_TAC[GSYM CONG; num_congruent] THEN
  REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN
  MATCH_MP_TAC(MESON[]
...
let LOCAL_CMADD_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 31 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
     !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
     ==>
     !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--19) (1--19) THEN
  ABBREV_TAC
...
(*** Quotient estimate computation ***)
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (20--23) THEN
  ABBREV_TAC `hw:int64 = word_subword
  ...
  X86_ACCSTEPS_TAC CURVE25519_PXSCALARMUL_EXEC (24--27) (24--31) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  REWRITE_TAC[GSYM CONG; num_congruent] THEN
  REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN
  MATCH_MP_TAC(MESON[]
...
let LOCAL_MUX_4_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE curve25519_pxscalarmul_tmc) 16 lvs
   `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
     !b. read ZF t = b
     ==>
     !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "n_" o lhand o concl) THEN
  FIRST_ASSUM(BIGNUM_LDIGITIZE_TAC "m_" o lhand o concl) THEN
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--16) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let CURVE25519_PXSCALARMUL_CORRECT = time prove
 (`!res scalar n point X pc stackpointer.
    ALL (nonoverlapping (stackpointer,360))
        [(word pc,0x161c); (res,64); (scalar,32); (point,32)] /\
  ...
  ENSURES_WHILE_PDOWN_TAC `256` `pc + 0xbd` `pc + 0x1519`
   `\i s.
     (read RSP s = stackpointer /\
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--28) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    ...
    REPEAT STRIP_TAC THEN X86_SIM_TAC CURVE25519_PXSCALARMUL_EXEC [1];
    ...
    X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (1--11) THEN
    SUBGOAL_THEN
  ...
  ASSUME_TAC THENL
   [EXPAND_TAC "nn" THEN REWRITE_TAC[GSYM BIGNUM_FROM_MEMORY_BYTES] THEN
    ...
    ALL_TAC] THEN
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (6--14) THEN
  SUBGOAL_THEN
   `word_and
  ...
  X86_STEPS_TAC CURVE25519_PXSCALARMUL_EXEC (30--32) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let CURVE25519_PXSCALARMUL_NOIBT_SUBROUTINE_CORRECT = time prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 408),408))
        [(word pc,LENGTH curve25519_pxscalarmul_tmc); (scalar,32); (point,32)] /\
    nonoverlapping (res,64) (word pc,LENGTH curve25519_pxscalarmul_tmc) /\
    nonoverlapping (res,64) (word_sub stackpointer (word 408),416)
    ==> ensures x86
         (\s. bytes_loaded s (word pc) curve25519_pxscalarmul_tmc /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
  ...
  X86_PROMOTE_RETURN_STACK_TAC
    curve25519_pxscalarmul_tmc CURVE25519_PXSCALARMUL_CORRECT
    ...
    ==> ensures x86
         ...
         (\s. read RIP s = returnaddress /\
          ...
          (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE [memory :> bytes(res,64);
                      memory :> bytes(word_sub stackpointer (word 408),408)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE CURVE25519_PXSCALARMUL_NOIBT_SUBROUTINE_CORRECT));;

(* ------------------------------------------------------------------------- *)
(* Correctness of Windows ABI version.                                       *)
(* ------------------------------------------------------------------------- *)

let curve25519_pxscalarmul_windows_mc = define_from_elf
  "curve25519_pxscalarmul_windows_mc"
  "x86/curve25519/curve25519_pxscalarmul.obj";;

let curve25519_pxscalarmul_windows_tmc = define_trimmed "curve25519_pxscalarmul_windows_tmc" curve25519_pxscalarmul_windows_mc;;

let CURVE25519_PXSCALARMUL_NOIBT_WINDOWS_SUBROUTINE_CORRECT = time prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 424),424))
        [(word pc,LENGTH curve25519_pxscalarmul_windows_tmc); (scalar,32); (point,32)] /\
    nonoverlapping (res,64) (word pc,LENGTH curve25519_pxscalarmul_windows_tmc) /\
    nonoverlapping (res,64) (word_sub stackpointer (word 424),432)
    ==> ensures x86
         (\s. bytes_loaded s (word pc) curve25519_pxscalarmul_windows_tmc /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
              read (memory :> bytes64 stackpointer) s = returnaddress /\
  ...
  WINDOWS_X86_WRAP_STACK_TAC
   curve25519_pxscalarmul_windows_tmc curve25519_pxscalarmul_tmc
   CURVE25519_PXSCALARMUL_CORRECT
    `[RBX; RBP; R12; R13; R14; R15]` 408);;

let CURVE25519_PXSCALARMUL_WINDOWS_SUBROUTINE_CORRECT = time prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 424),424))
        [(word pc,LENGTH curve25519_pxscalarmul_windows_mc); (scalar,32); (point,32)] /\
    nonoverlapping (res,64) (word pc,LENGTH curve25519_pxscalarmul_windows_mc) /\
    nonoverlapping (res,64) (word_sub stackpointer (word 424),432)
    ==> ensures x86
         (\s. bytes_loaded s (word pc) curve25519_pxscalarmul_windows_mc /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
              read (memory :> bytes64 stackpointer) s = returnaddress /\
              WINDOWS_C_ARGUMENTS [res; scalar; point] s /\
         ...
         (\s. read RIP s = returnaddress /\
          ...
          (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE [memory :> bytes(res,64);
                      memory :> bytes(word_sub stackpointer (word 424),424)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE CURVE25519_PXSCALARMUL_NOIBT_WINDOWS_SUBROUTINE_CORRECT));;
