...
(**** print_literal_from_elf "x86/p521/p521_jdouble_alt.o";;
 ****)
...
let LOCAL_SQR_P521_TAC =
  ...
  `!(t:x86state) pcin pcout p3 n3 p1 n1.
    ...
    ==>
    nonoverlapping (word pc,0x4290) (stackpointer,576) /\
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `n < p_521` THENL
   [ASM_REWRITE_TAC[]; X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (1--353)] THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (1--308) (1--308) THEN
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC [309] THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [310] [310] THEN
  ...
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC (311--323) THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (324--333) (324--333) THEN
  SUBGOAL_THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (334--353) (334--353) THEN
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (2--466)] THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (2--421) (2--421) THEN
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC [422] THEN
  FIRST_X_ASSUM(ASSUME_TAC o GEN_REWRITE_RULE RAND_CONV
    [WORD_RULE `word_mul x y = word(0 + val x * val y)`]) THEN
  ACCUMULATE_ARITH_TAC "s422" THEN
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [423] [423] THEN
  ...
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC (424--436) THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (437--446) (437--446) THEN
  SUBGOAL_THEN
   `&(val(word_add (word_and h0 (word 511):int64) (word_ushr h8 9))):real =
    &(val(word_and h0 (word 511):int64)) + &(val(word_ushr h8 9:int64))`
  SUBST_ALL_TAC THENL
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (447--466) (447--466) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC SYM_CONV THEN CONV_TAC(RAND_CONV BIGNUM_LEXPAND_CONV) THEN
  ASM_REWRITE_TAC[] THEN MATCH_MP_TAC EQUAL_FROM_CONGRUENT_MOD_MOD THEN
  MAP_EVERY EXISTS_TAC
...
let LOCAL_ADD_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m < p_521 /\ n < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (1--40)] THEN
  REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [3;5;7;9;11;13;15;17;19] (1--19) THEN
  SUBGOAL_THEN
   `bignum_of_wordlist
  ...
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC (20--21) THEN
   ...
   [REWRITE_TAC[BIT_VAL_MOD] THEN
    ...
    SUBST1_TAC THENL
     [FIRST_X_ASSUM(fun th ->
      ...
      REWRITE_TAC[p_521] THEN ARITH_TAC];
    ALL_TAC] THEN
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC [22] THEN
  SUBGOAL_THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC
...
let LOCAL_SUB_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [2;4;6;8;10;12;14;16;18] (1--18) THEN
...
let LOCAL_WEAKMUL_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (2--454)] THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC (437--445) (437--454) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let LOCAL_CMSUBC9_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m < 2 * p_521 /\ n <= p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (1--138)] THEN
  ...
  X86_GEN_ACCSTEPS_TAC
   (fun _ -> RULE_ASSUM_TAC(REWRITE_RULE[WORD_RULE
    ...
    P521_JDOUBLE_ALT_EXEC (1--103) (1--103) THEN
  SUBGOAL_THEN
   `bignum_of_wordlist
  ...
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC (104--113) THEN
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [115;117;119] (114--119) THEN
...
let LOCAL_CMSUB41_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m < 2 * p_521 /\ n <= p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (1--80)] THEN
  ...
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC (46--55) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_AND_ASSOC; DIMINDEX_64]) THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [57;59;61] (56--61) THEN
...
let LOCAL_CMSUB38_P521_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_CASES_TAC `m < 2 * p_521 /\ n <= p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    X86_SIM_TAC P521_JDOUBLE_ALT_EXEC (1--112)] THEN
  ...
  X86_STEPS_TAC P521_JDOUBLE_ALT_EXEC (78--87) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_AND_ASSOC; DIMINDEX_64]) THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_ACCSTEPS_TAC P521_JDOUBLE_ALT_EXEC [89;91;93] (88--93) THEN
