...
let bignum_mul_p521_alt_mc =
  define_assert_from_elf "bignum_mul_p521_alt_mc" "arm/p521/bignum_mul_p521_alt.o"
[
...
let BIGNUM_MUL_P521_ALT_EXEC = ARM_MK_EXEC_RULE bignum_mul_p521_alt_mc;;
 ...
 (`!z x y a b pc stackpointer.
  ...
  ASM_CASES_TAC `a < p_521 /\ b < p_521` THENL
   [ASM_REWRITE_TAC[] THEN FIRST_X_ASSUM(CONJUNCTS_THEN ASSUME_TAC);
    ARM_SIM_TAC BIGNUM_MUL_P521_ALT_EXEC (1--373)] THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_MUL_P521_ALT_EXEC (1--334) (1--334) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_MUL_P521_ALT_EXEC
  ...
  ARM_ACCSTEPS_TAC BIGNUM_MUL_P521_ALT_EXEC (359--367) (359--373) THEN
