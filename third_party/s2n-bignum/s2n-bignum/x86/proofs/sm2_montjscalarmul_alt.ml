...
needs "x86/proofs/sm2_montjadd_alt.ml";;
needs "x86/proofs/sm2_montjdouble_alt.ml";;
...
[
  ...
  0x49; 0xbc; 0x23; 0x41; 0xd5; 0x39; 0x09; 0xf4; 0xbb; 0x53;
                           (* MOV (% r12) (Imm64 (word 6033684446255071523)) *)
  0x49; 0xbd; 0x2b; 0x05; 0xc6; 0x21; 0x6b; 0xdf; 0x03; 0x72;
                           (* MOV (% r13) (Imm64 (word 8215655796475036971)) *)
  0x49; 0xc7; 0xc6; 0xff; 0xff; 0xff; 0xff;
                           (* MOV (% r14) (Imm32 (word 4294967295)) *)
  0x49; 0xbf; 0xff; 0xff; 0xff; 0xff; 0xfe; 0xff; 0xff; 0xff;
                           (* MOV (% r15) (Imm64 (word 18446744069414584319)) *)
  ...
  0x49; 0x0f; 0xba; 0xf3; 0x20;
                           (* BTR (% r11) (Imm8 (word 32)) *)
  0x4d; 0x29; 0xe0;        (* SUB (% r8) (% r12) *)
  0x4d; 0x19; 0xe9;        (* SBB (% r9) (% r13) *)
  0x4d; 0x19; 0xf2;        (* SBB (% r10) (% r14) *)
  0x4d; 0x19; 0xfb;        (* SBB (% r11) (% r15) *)
  ...
  0x48; 0x8d; 0xb4; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,224)) *)
  0xe8; 0x27; 0x31; 0x00; 0x00;
                           (* CALL (Imm32 (word 12583)) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,224)) *)
  0xe8; 0xb6; 0x09; 0x00; 0x00;
                           (* CALL (Imm32 (word 2486)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,512)) *)
  0x48; 0x8d; 0xb4; 0x24; 0x40; 0x01; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,320)) *)
  0xe8; 0xf5; 0x30; 0x00; 0x00;
                           (* CALL (Imm32 (word 12533)) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,224)) *)
  0xe8; 0x84; 0x09; 0x00; 0x00;
                           (* CALL (Imm32 (word 2436)) *)
  0x48; 0x8d; 0xbc; 0x24; 0xc0; 0x02; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,704)) *)
  0x48; 0x8d; 0xb4; 0x24; 0xa0; 0x01; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,416)) *)
  0xe8; 0xc3; 0x30; 0x00; 0x00;
                           (* CALL (Imm32 (word 12483)) *)
  ...
  0x48; 0x8d; 0x94; 0x24; 0xe0; 0x00; 0x00; 0x00;
                           (* LEA (% rdx) (%% (rsp,224)) *)
  0xe8; 0x52; 0x09; 0x00; 0x00;
                           (* CALL (Imm32 (word 2386)) *)
  0x48; 0x8d; 0xbc; 0x24; 0x80; 0x03; 0x00; 0x00;
                           (* LEA (% rdi) (%% (rsp,896)) *)
  0x48; 0x8d; 0xb4; 0x24; 0x00; 0x02; 0x00; 0x00;
                           (* LEA (% rsi) (%% (rsp,512)) *)
  0xe8; 0x91; 0x30; 0x00; 0x00;
                           (* CALL (Imm32 (word 12433)) *)
  ...
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x94; 0x2c; 0x00; 0x00;
                           (* CALL (Imm32 (word 11412)) *)
  0x48; 0x8d; 0x74; 0x24; 0x20;
                           (* LEA (% rsi) (%% (rsp,32)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x85; 0x2c; 0x00; 0x00;
                           (* CALL (Imm32 (word 11397)) *)
  0x48; 0x8d; 0x74; 0x24; 0x20;
                           (* LEA (% rsi) (%% (rsp,32)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x76; 0x2c; 0x00; 0x00;
                           (* CALL (Imm32 (word 11382)) *)
  0x48; 0x8d; 0x74; 0x24; 0x20;
                           (* LEA (% rsi) (%% (rsp,32)) *)
  0x48; 0x8d; 0x7c; 0x24; 0x20;
                           (* LEA (% rdi) (%% (rsp,32)) *)
  0xe8; 0x67; 0x2c; 0x00; 0x00;
                           (* CALL (Imm32 (word 11367)) *)
  ...
  0x41; 0xbd; 0xff; 0xff; 0xff; 0xff;
                           (* MOV (% r13d) (Imm32 (word 4294967295)) *)
  ...
  0x4d; 0x31; 0xe5;        (* XOR (% r13) (% r12) *)
  0x49; 0x0f; 0xba; 0xf7; 0x20;
                           (* BTR (% r15) (Imm8 (word 32)) *)
  0x48; 0x09; 0xc8;        (* OR (% rax) (% rcx) *)
...
let sm2_montjscalarmul_alt_tmc = define_trimmed "sm2_montjscalarmul_alt_tmc" sm2_montjscalarmul_alt_mc;;

let SM2_MONTJSCALARMUL_ALT_EXEC = X86_MK_EXEC_RULE sm2_montjscalarmul_alt_tmc;;
...
let LOCAL_JADD_TAC =
  let baseth = X86_SIMD_SHARPEN_RULE SM2_MONTJADD_ALT_NOIBT_SUBROUTINE_CORRECT
  ...
  X86_SUBROUTINE_SIM_TAC
   (sm2_montjscalarmul_alt_tmc,SM2_MONTJSCALARMUL_ALT_EXEC,
    0xb83,sm2_montjadd_alt_tmc,th)
...
let LOCAL_JDOUBLE_TAC =
  let baseth = X86_SIMD_SHARPEN_RULE SM2_MONTJDOUBLE_ALT_NOIBT_SUBROUTINE_CORRECT
  ...
  X86_SUBROUTINE_SIM_TAC
   (sm2_montjscalarmul_alt_tmc,SM2_MONTJSCALARMUL_ALT_EXEC,
    0x32d7,sm2_montjdouble_alt_tmc,th)
  [`read RDI s`; `read RSI s`;
   `read(memory :> bytes(read RSI s,8 * 4)) s,
    read(memory :> bytes(word_add (read RSI s) (word 32),8 * 4)) s,
    read(memory :> bytes(word_add (read RSI s) (word 64),8 * 4)) s`;
   `pc + 0x32d7`; `read RSP s`; `read (memory :> bytes64(read RSP s)) s`];;
...
let SM2_MONTJSCALARMUL_ALT_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer.
        ALL (nonoverlapping (stackpointer,1320))
            [(word pc,0x4758); (res,96); (scalar,32); (point,96)] /\
        nonoverlapping (res,96) (word pc,0x4758)
        ==> ensures x86
             (\s. bytes_loaded s (word pc) sm2_montjscalarmul_alt_tmc /\
  ...
  ENSURES_WHILE_DOWN_TAC `63` `pc + 0x630` `pc + 0xaf5`
   `\i s.
      read RSP s = word_add stackpointer (word 296) /\
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    X86_ACCSTEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC [8;10;12;14] (1--18) THEN
    ...
    ASSUME_TAC THENL
     [SUBGOAL_THEN `carry_s14 <=> n_input < n_sm2` SUBST_ALL_TAC THENL
    ...
    X86_ACCSTEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (19--22) (19--28) THEN
    MAP_EVERY REABBREV_TAC
     [`nn_0 = read R8 s28`;
      `nn_1 = read R9 s28`;
      `nn_2 = read R10 s28`;
    ...
    X86_ACCSTEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (30--33) (29--38) THEN
    SUBGOAL_THEN
    ...
    ASSUME_TAC THENL
     [CONV_TAC(LAND_CONV BIGNUM_LEXPAND_CONV) THEN ASM_REWRITE_TAC[] THEN
      ...
      REWRITE_TAC[bignum_of_wordlist; n_sm2; GSYM REAL_OF_NUM_CLAUSES;
   ...
   (*** Copying and optional negation of the point as zeroth table entry ***)
    ...
    X86_ACCSTEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (64--67) (39--84) THEN
    SUBGOAL_THEN
     `read(memory :> bytes(word_add stackpointer (word 520),8 * 4)) s84 = x /\
      read(memory :> bytes(word_add stackpointer (word 584),8 * 4)) s84 = z`
    ...
    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (85--87) THEN
    LOCAL_JDOUBLE_TAC 88 THEN
    MAP_EVERY ABBREV_TAC
     [`x2 = read (memory :> bytes(word_add stackpointer (word 616),8 * 4)) s88`;
      `y2 = read (memory :> bytes(word_add stackpointer (word 648),8 * 4)) s88`;
      `z2 = read (memory :> bytes(word_add stackpointer (word 680),8 * 4)) s88`
     ] THEN

    (*** Computation of 3 * P ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (89--92) THEN
    LOCAL_JADD_TAC 93 THEN
    MAP_EVERY ABBREV_TAC
     [`x3 = read (memory :> bytes(word_add stackpointer (word 712),8 * 4)) s93`;
      `y3 = read (memory :> bytes(word_add stackpointer (word 744),8 * 4)) s93`;
      `z3 = read (memory :> bytes(word_add stackpointer (word 776),8 * 4)) s93`
     ] THEN

    (*** Computation of 4 * P ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (94--96) THEN
    LOCAL_JDOUBLE_TAC 97 THEN
    MAP_EVERY ABBREV_TAC
     [`x4 = read (memory :> bytes(word_add stackpointer (word 808),8 * 4)) s97`;
      `y4 = read (memory :> bytes(word_add stackpointer (word 840),8 * 4)) s97`;
      `z4 = read (memory :> bytes(word_add stackpointer (word 872),8 * 4)) s97`
     ] THEN

    (*** Computation of 5 * P ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (98--101) THEN
    LOCAL_JADD_TAC 102 THEN
    MAP_EVERY ABBREV_TAC
     [`x5 = read (memory :> bytes(word_add stackpointer (word 904),8 * 4)) s102`;
      `y5 = read (memory :> bytes(word_add stackpointer (word 936),8 * 4)) s102`;
      `z5 = read (memory :> bytes(word_add stackpointer (word 968),8 * 4)) s102`
     ] THEN

    (*** Computation of 6 * P ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (103--105) THEN
    LOCAL_JDOUBLE_TAC 106 THEN
    MAP_EVERY ABBREV_TAC
     [`x6 = read (memory :> bytes(word_add stackpointer (word 1000),8 * 4)) s106`;
      `y6 = read (memory :> bytes(word_add stackpointer (word 1032),8 * 4)) s106`;
      `z6 = read (memory :> bytes(word_add stackpointer (word 1064),8 * 4)) s106`
     ] THEN

    (*** Computation of 7 * P ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (107--110) THEN
    LOCAL_JADD_TAC 111 THEN
    MAP_EVERY ABBREV_TAC
     [`x7 = read (memory :> bytes(word_add stackpointer (word 1096),8 * 4)) s111`;
      `y7 = read (memory :> bytes(word_add stackpointer (word 1128),8 * 4)) s111`;
      `z7 = read (memory :> bytes(word_add stackpointer (word 1160),8 * 4)) s111`
     ] THEN

    (*** Computation of 8 * P ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (112--114) THEN
    LOCAL_JDOUBLE_TAC 115 THEN
    MAP_EVERY ABBREV_TAC
     [`x8 = read (memory :> bytes(word_add stackpointer (word 1192),8 * 4)) s115`;
      `y8 = read (memory :> bytes(word_add stackpointer (word 1224),8 * 4)) s115`;
      `z8 = read (memory :> bytes(word_add stackpointer (word 1256),8 * 4)) s115`
     ] THEN

    (*** Selection of the top bitfield ***)

    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (116--117) THEN
    SUBGOAL_THEN
    ...
    BIGNUM_LDIGITIZE_TAC "fab_"
     `read(memory :> bytes(word_add stackpointer (word 520),8 * 96)) s117` THEN
    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (118--246) THEN
    ...
    X86_SIM_TAC SM2_MONTJSCALARMUL_ALT_EXEC (1--2) THEN
    ...
    X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (1--27) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV) THEN ASM_REWRITE_TAC[] THEN
  ...
  REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN ENSURES_INIT_TAC "s0" THEN
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (1--4) THEN
  ...
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (6--8) THEN LOCAL_JDOUBLE_TAC 9 THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (10--12) THEN LOCAL_JDOUBLE_TAC 13 THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (14--16) THEN LOCAL_JDOUBLE_TAC 17 THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (18--27) THEN
  ...
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (28--143) THEN
  MAP_EVERY REABBREV_TAC
   [`tab0 = read RAX s143`;
    `tab1 = read RBX s143`;
    `tab2 = read RCX s143`;
  ...
  X86_ACCSTEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (165--168) (144--177) THEN
  MAP_EVERY ABBREV_TAC
   [`Xt = read (memory :> bytes(word_add stackpointer (word 424),8 * 4)) s177`;
    `Yt = read (memory :> bytes(word_add stackpointer (word 456),8 * 4)) s177`;
    `Zt = read (memory :> bytes(word_add stackpointer (word 488),8 * 4)) s177`
   ] THEN
  SUBGOAL_THEN
   `!P. P IN group_carrier sm2_group /\ y < p_sm2 /\ represents_sm2 P (x,y',z)
  ...
  X86_STEPS_TAC SM2_MONTJSCALARMUL_ALT_EXEC (178--181) THEN LOCAL_JADD_TAC 182 THEN
  MAP_EVERY ABBREV_TAC
   [`X' = read (memory :> bytes(word_add stackpointer (word 328),8 * 4)) s182`;
    `Y' = read (memory :> bytes(word_add stackpointer (word 360),8 * 4)) s182`;
    `Z' = read (memory :> bytes(word_add stackpointer (word 392),8 * 4)) s182`
   ] THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
...
let SM2_MONTJSCALARMUL_ALT_NOIBT_SUBROUTINE_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 1368),1368))
            [(word pc,LENGTH sm2_montjscalarmul_alt_tmc); (scalar,32); (point,96)] /\
        ALL (nonoverlapping (res,96))
            [(word pc,LENGTH sm2_montjscalarmul_alt_tmc); (word_sub stackpointer (word 1368),1376)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) sm2_montjscalarmul_alt_tmc /\
                  read RIP s = word pc /\
   ...
   X86_ADD_RETURN_STACK_TAC SM2_MONTJSCALARMUL_ALT_EXEC
     SM2_MONTJSCALARMUL_ALT_CORRECT `[RBX; RBP; R12; R13; R14; R15]` 1368);;
 ...
 (`!res scalar point n xyz pc stackpointer returnaddress.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE[memory :> bytes(res,96);
                     memory :> bytes(word_sub stackpointer (word 1368),1368)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE SM2_MONTJSCALARMUL_ALT_NOIBT_SUBROUTINE_CORRECT));;

(* ------------------------------------------------------------------------- *)
(* Correctness of Windows ABI version.                                       *)
(* ------------------------------------------------------------------------- *)

let sm2_montjscalarmul_alt_windows_mc = define_from_elf "sm2_montjscalarmul_alt_windows_mc"
      "x86/sm2/sm2_montjscalarmul_alt.obj";;

let sm2_montjscalarmul_alt_windows_tmc = define_trimmed "sm2_montjscalarmul_alt_windows_tmc" sm2_montjscalarmul_alt_windows_mc;;

let SM2_MONTJSCALARMUL_ALT_NOIBT_WINDOWS_SUBROUTINE_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 1392),1392))
            [(word pc,LENGTH sm2_montjscalarmul_alt_windows_tmc); (scalar,32); (point,96)] /\
        ALL (nonoverlapping (res,96))
            [(word pc,LENGTH sm2_montjscalarmul_alt_windows_tmc); (word_sub stackpointer (word 1392),1400)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) sm2_montjscalarmul_alt_windows_tmc /\
                  read RIP s = word pc /\
                  read RSP s = stackpointer /\
                  read (memory :> bytes64 stackpointer) s = returnaddress /\
  ...
  let WINDOWS_SM2_MONTJSCALARMUL_ALT_EXEC =
    X86_MK_EXEC_RULE sm2_montjscalarmul_alt_windows_tmc
  and baseth =
    X86_SIMD_SHARPEN_RULE SM2_MONTJSCALARMUL_ALT_NOIBT_SUBROUTINE_CORRECT
    (X86_ADD_RETURN_STACK_TAC SM2_MONTJSCALARMUL_ALT_EXEC
  ...
  X86_STEPS_TAC WINDOWS_SM2_MONTJSCALARMUL_ALT_EXEC (1--6) THEN
  X86_SUBROUTINE_SIM_TAC
   (sm2_montjscalarmul_alt_windows_tmc,
    WINDOWS_SM2_MONTJSCALARMUL_ALT_EXEC,
    0x13,sm2_montjscalarmul_alt_tmc,subth)
  ...
  X86_STEPS_TAC WINDOWS_SM2_MONTJSCALARMUL_ALT_EXEC (8--10) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[]);;

let SM2_MONTJSCALARMUL_ALT_WINDOWS_SUBROUTINE_CORRECT = time prove
 (`!res scalar point n xyz pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 1392),1392))
            [(word pc,LENGTH sm2_montjscalarmul_alt_windows_mc); (scalar,32); (point,96)] /\
        ALL (nonoverlapping (res,96))
            [(word pc,LENGTH sm2_montjscalarmul_alt_windows_mc); (word_sub stackpointer (word 1392),1400)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) sm2_montjscalarmul_alt_windows_mc /\
                  read RIP s = word pc /\
                  read RSP s = stackpointer /\
                  read (memory :> bytes64 stackpointer) s = returnaddress /\
                  WINDOWS_C_ARGUMENTS [res;scalar;point] s /\
          ...
          (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE[memory :> bytes(res,96);
                     memory :> bytes(word_sub stackpointer (word 1392),1392)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE SM2_MONTJSCALARMUL_ALT_NOIBT_WINDOWS_SUBROUTINE_CORRECT));;
